...
class classPIX {
	...
	public function __construct() {
            ...
            if($retorno->access_token == PIX_ERRO) {
                $erro_mensagem = isset($retorno->error_description) ? $retorno->error_description : 'Erro de autenticação';
                die("<br><br>ERRO na Comunicação com o Banco!<br>Por favor, entre em contado com o suporte da E-Prepag e informe o erro de código PIX790954.<br>Detalhes do erro: " . $erro_mensagem . "<br>Obrigado.");
            }
            else {
