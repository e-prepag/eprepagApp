...
if ($iforma==$GLOBALS['FORMAS_PAGAMENTO']['PAGAMENTO_PIX']) {
	...
	//echo $sql;
	//die("STOP");
	gravaLog_PIX("Inserindo o registro na tabela tb_pag_compras através do programa pag\\epp\\inc_config.php\n total_carrinho: ".(($total_carrinho==0) ? "É ZERO === " : "NÃO É ZERO +++ ")."\n$sql");
