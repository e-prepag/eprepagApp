...
/*if(checkIP() ) {
        ...
        //Dados de Acesso
        define("CLIENT_ID","eprepag");
        define("CLIENT_SECRET","63425c04-44f1-41d3-b284-aeeb1ea81cb6");
        //URL Transaction
        define("PIX_SERVICE_URL_AUTH","https://hml.auth.blupay-apps.com.br/auth/realms/payment-bus/protocol/openid-connect/token");
        define("PIX_SERVICE_URL_SERVICE","https://api.hml.pb.blupay-apps.com.br/api/v2/cob/");
        define("PIX_SERVICE_URL_SONDA","https://api.hml.pb.blupay-apps.com.br/api/v2/cob/"); ///api/v2/cob/{txId},  txId é ID do Pedido
        ...
        //Dados de Acesso
        define("CLIENT_ID","eprepag");
        define("CLIENT_SECRET","7cc30020-a79e-4b01-84de-03ad88db829e");
        //URL Transaction
        define("PIX_SERVICE_URL_AUTH","https://auth.blupay-apps.com.br/auth/realms/payment-bus/protocol/openid-connect/token");
        define("PIX_SERVICE_URL_SERVICE","https://api.pb.blupay-apps.com.br/api/v2/cob/");
        define("PIX_SERVICE_URL_SONDA","https://api.pb.blupay-apps.com.br/api/v2/cob/"); ///api/v2/cob/{txId},  txId é ID do Pedido
