...
class Itaucripto {
	...
	private function TiraAcento($str){
		return strtr(utf8_decode($str),utf8_decode('???????¥µÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝßàáâãäåæçèéêëìíîïðñòóôõöøùúûüýÿ'),'SOZsozYYuAAAAAAACEEEEIIIIDNOOOOOOUUUUYsaaaaaaaceeeeiiiionoooooouuuuyy');
	}
    ...
    //função para debug - verificar o que a função geraDados está retornando
