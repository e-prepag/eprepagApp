...
$dadosboleto["instrucoes2"] 		= "Boleto válido para pagamento até a data do vencimento.";
...
$usuarioGames1 = unserialize($_SESSION['dist_usuarioGames_ser']);
if($usuarioGames1){
	//Codigo do usuario
	$usuario_id1 = $usuarioGames1->getId();
echo "usuario_id1: $usuario_id1<br>";
//	$d = new dump ( $usuarioGames1 );
//echo "<hr>".$d->get_html()."<hr>";

	//Codigo da Venda
//	if(!$venda_id) $venda_id1 = $_REQUEST['venda'];
} else {
...
$dadosboleto["conta"] 				= $GLOBALS['BOLETO_MONEY_BRADESCO_CEDENTE_CONTA_NOVA'];  		// Num da conta, sem digito
$dadosboleto["conta_dv"] 			= $GLOBALS['BOLETO_MONEY_BRADESCO_CEDENTE_CONTA_NOVA_DV'];  	// Digito do Num da conta
