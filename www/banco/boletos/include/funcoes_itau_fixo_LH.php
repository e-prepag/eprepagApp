...
$dadosboleto["instrucoes4"] 		.= "O crédito será liberado somente após a compensação deste boleto bancário.<br>";
...
$linha_digitavel = monta_linha_digitavel_itau($linha);
$dadosboleto["codigo_barras"] = $linha;
$dadosboleto["linha_digitavel"] = monta_linha_digitavel_itau($linha);
