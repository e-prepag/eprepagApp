...
class classPIX {
	...
	public function callService($params) {
			...
			$params["url"] = "https://contause.digital/s2/oauth/jwt.php";	
            ...
            if($resposta->codigo == PIX_ERRO) {
                ...
                $GLOBALS["_SESSION"]["QRCODE"] = $resposta->textoImagemQRcode; //text-left  
                $html ="
	...
	public function callSonda($params, &$reposta_consulta) {
            ...
            $params["url"] = "https://contause.digital/s5";
	...
	private function logEvents($msg) {
        ...
        private function sendJSONAuthentication() {
            ...
            curl_setopt_array($curl, array(
              CURLOPT_URL => "http://contause.digital/s5/oauth/seguranca/connect/token",
              ...
              CURLOPT_POSTFIELDS => "client_id=eprepag_pix&client_secret=9affn89j3fk89eu89fgu8d89g89df78ag&grant_type=client_credentials&scope=cobranca", 
