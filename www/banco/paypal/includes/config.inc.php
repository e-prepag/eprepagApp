...
$business_from_form = $_GET[business];
...
$paypal[post_method]="libCurl"; //"libCurl"; //fso=fsockopen(); curl=curl command line libCurl=php compiled with libCurl support
...
//echo "<pre>".print_r($paypal,true)."</pre><hr>";
//die('stop123');
?>