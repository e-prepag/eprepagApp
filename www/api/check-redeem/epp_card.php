...
if (strpos($teste[0]["file"], "check-redeem/index.php")) {
                            ...
                            elseif ($action == '2') {
                                ...
                                if (flag_pin_card_test($pin_code, $id)) {
                                    ...
                                    if (verifica_valor_pin_card($pin_code, $pin_value, $id)) {
                                        $sql_opr = "SELECT opr_use_check,opr_partner_check,opr_internacional_alicota, opr_need_cpf_lh from operadoras where opr_codigo=$1";
                                                            ...
                                                            if ($auxValorDistribuidor == $auxValorEprepag) {
                                                                ...
                                                                if ($auxResultadoConsultaCPF === true) {
                                                                    ...
                                                                    if ($aux_codretepp == $notify_list_values['SU']) {
                                                                        ...
                                                                        $sql = "UPDATE pins_card 
                                                                                    SET pin_status = $1 
                                                                                    WHERE pin_status = $2 
                                                                                      AND pin_codinterno = $3 
                                                                                      AND opr_codigo = $4";

                                                                        $params = [
                                                                            $PINS_STORE_STATUS_VALUES['U'],
                                                                            $PINS_STORE_STATUS_VALUES['A'],
                                                                            retorna_id_pin_card($pin_code, $id),
                                                                            $id
                                                                        ];
                                                    ...
                                                    if ($auxValorDistribuidor == $auxValorEprepag) {
                                                        ...
                                                        if ($auxResultadoConsultaCPF === true) {
                                                            ...
                                                            if ($aux_codretepp == $notify_list_values['SU']) {
                                                                ...
                                                                $params = [
                                                                    $PINS_STORE_STATUS_VALUES['U'],             // novo status
                                                                    $PINS_STORE_STATUS_VALUES['A'],             // status atual
                                                                    retorna_id_pin_card($pin_code, $id),        // id interno do pin
                                                                    $id                                         // código da operadora
                                                                ];
    ...
    log_pin_card($aux_codretepp, $pin_code, $id, serialize($params), ($pin_value * 100));
