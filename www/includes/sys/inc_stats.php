		...
		case "P":	// POS ========================================================================================
			...
			switch($query_type) {
				...
				case "por_tipo_de_estabelecimento": 
					...
					// n�o colocado para rede P* como ex. Rede Ponto Certo
					break;
				case "por_estabelecimento": 
...
/*
	...
	Para encontrar primeira e ultima compras em todos os registros, mesmo para �ltimo m�s e �ltima semana
	Est� muito lento: 93s
...
// ==========================================================================
// os filtros de operadoras s�o definidos com $where_operadora, $where_operadora_pos, $where_operadora_cartoes
...
//"P"
	if(!$where_origem) {	// $where_origem � definido apenas para Stardoll em M/E
...
//"L" contendo PINs Publisher totalizados por utiliza��o
...
//echo $opr_nome." -> ".$comiss."<br>";
	...
	// Selecionando Utiliza��o de GiftCard
        $sql .= "
            union all 
	...
	// Selecionando Utiliza��o de GoCASH
        $sql .=" 
            union all 
...
// ==========================================================================
// Procura $estabelecimento no array bidimensional $a_vendas_ultimo_mes, hoje com posi��o $iorder_1, 
//		ordenado por valor desc, v�rias linhas pod�m ter o mesmo valor
// retorna a diferencia entre a posi��o fornecida e a encontrada em $a_vendas_ultimo_mes para o estabelecimento
...
function getSQLTotaisporJogos($opr_codigo=null,$jogo_nome=null,$data_inicial=null,$data_final=null,$pins_valor=null) {
	...
	//ATEN��O: para novos canais deve ser cadastrado no vetor de canais no inicio do programa financial_totais_por_jogos.php 
