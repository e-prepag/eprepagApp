...
function get_Campeonato_Pagto_Completo($ug_id, $prod_id, &$pagtos_valor)
{
	...
	$sql = "
    SELECT 
        SUM(vgm_qtde) AS n_vendas,
        SUM(vgm_valor) AS valor_total
...
?>
		<table border="0" cellspacing="0" width="100%" class="texto">
			<tr>
				<td>Nome</td>
				<td>&nbsp;</td>
				<td>&nbsp;<?php echo $rs_row['ug_nome_fantasia'] ?></td>
			</tr>
			<tr>
				<td>Responsável</td>
				<td>&nbsp;</td>
				<td>&nbsp;<?php echo $rs_row['ug_responsavel'] ?></td>
			</tr>
			<tr>
				<td>Endereço</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td>Telefone</td>
				<td>&nbsp;</td>
				<td>&nbsp;<?php echo "(" . $rs_row['ug_tel_ddd'] . ") " . $rs_row['ug_tel'] ?></td>
			</tr>
			<tr>
				<td>Cidade</td>
				<td>&nbsp;</td>
				<td>&nbsp;<?php echo $rs_row['ug_cidade'] ?></td>
			</tr>
			<tr>
				<td>Estado</td>
				<td>&nbsp;</td>
				<td>&nbsp;<?php echo $rs_row['ug_estado'] ?></td>
			</tr>
		</table>
		<br>&nbsp;
<?php
