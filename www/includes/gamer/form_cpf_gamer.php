    ...
    if (count($errors) > 0 && $_POST['consulta_automatica'] == '1') {
        ...
        foreach ($errors as $error) {
            $msg .= $error . "<br>";
             ...
             $res = SQLexecuteQuery($sql);
             if($testeCPF != 171) {
                 $msg = "N�o houve sucesso na atualiza��o do CPF do usu�rio de ID[".$usuarioId."]<br>Por�m foi permitido efetuar a compra e foi atualizado a data de consulta do seu CPF para ter sucesso.<br>Dados:<br>CPF: ".$_POST['cpf']."<br>Data de Nascimento: ".$_POST['data_nascimento']."<br>";
                 foreach($errors as $key => $error){ 
                     $msg .= str_replace("\n","<br>",  $error); 
                 }
                 enviaEmail("rc@e-prepag.com.br", "tamy@e-prepag.com.br", "wagner@e-prepag.com.br", "Erro na atualiza��o de CPF j� informado", $msg);
             }//end if($testeCPF != 171)
