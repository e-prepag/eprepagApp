					<table border="0" cellspacing="0" width="30%" align="center" <?php if ($GLOBALS['_SESSION']['is_integration'] == true) echo 'style="display: none"'; ?>>
						...
						<tr bgcolor="F0F0F0">
							<td class="texto" align="center" height="25">
								<font size="+1"><?php echo formata_codigo_venda($venda_id) ?></font>
							</td>
						</tr>
					</table>
...
";
							...
							$params = [
								'M',
								$GLOBALS['_SESSION']['venda'],
							];

							$rs_total = SQLexecuteQueryParams($sql_total, $params);
...
";
								...
								$params = [
									($total_geral + $rs_total_row['taxas']) * 100,
									'M',
									$GLOBALS['_SESSION']['venda'],
								];

								$rs_update_total = SQLexecuteQueryParams($sql_update_total, $params);
							}
						}
