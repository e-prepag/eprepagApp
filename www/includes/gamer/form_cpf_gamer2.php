            ...
            <form action="" id="cpfForm" method="POST">
                ...
                <div class="col-md-5 bottom20">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control w160" id="cpf" name="cpf" maxlength="14" value="<?php echo $form_cpf; ?>" placeholder="CPF">
                    </div>
                    <div class="form-group bottom0">
                        <!--<label for="cpf">Data de Nascimento (<i>(DD/MM/AAAA)</i>):</label>-->
                        <input type="text" class="form-control datepicker w160" value="<?php echo $form_data_nascimento; ?>" placeholder="Data de Nascimento" name="data_nascimento" id="data_nascimento">
                    </div>
