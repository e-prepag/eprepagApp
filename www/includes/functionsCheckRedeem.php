<?php
//Função que retorna o tamanho do GiftCard
...
//Função que Grava LOG de Integração de PIN
...
//Função desenvolvida exclusivamente para a RIOT
function publisherOrderId($pin_codinterno, $riot_order_id, $pin_channel)
{
	...
	if (!$rs_log) {
		echo "Erro ao Salvar o ID da Transação do Publisher (RIOT)." . PHP_EOL;
	}
