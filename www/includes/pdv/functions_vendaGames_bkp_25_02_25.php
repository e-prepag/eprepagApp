...
function buscarPinValido($vgm_opr_codigo, $vgm_pin_valor, $bDebug)
{
    ...
    do {
        ...
        if (
            $pin_test_duplic && pg_num_rows($pin_test_duplic) > 0 && $vgm_opr_codigo != 16
            && $pgpins["pin_codigo"] != '0000000000000000'&& $pgpins["pin_codigo"] != '1111111111111111' && $pgpins["pin_codigo"] != null && $pgpins["pin_codigo"] != ""
        ) {
            if ($bDebug) {
