...
<div class="wrapper int-box" style="border-top: 0px; border: 0px">
    <h3 class="c1">Por favor, complete o campo abaixo com o<br>CPF de seu cliente <a href="#" class="btn-question"
            data-msg="<h2>O que é isso?</h2>Agora as transações financeiras de alguns games estão condicionadas ao fornecimento de um CPF do cliente ou responsável. Esta solicitação é feita pelos orgão financeiros de regulamentação no Brasil. Qualquer dúvida entre em contato com o Suporte."
            style="position: relative; top: -4px;">?</a></h3>
    <p></p>
    ...
    <div class="int-form1" style="position: relative;">
        <form action="" id="cpfForm" method="POST">
            ...
            <input type="text" id="cpf" name="cpf" maxlength="14" value="<?php echo $form_cpf; ?>" placeholder="CPF"
                style="margin-bottom: 10px;" />
            <input type="text" class="datepicker" style="width:140px;" value="<?php echo $form_data_nascimento; ?>"
                placeholder="Data de Nascimento" name="data_nascimento" id="data_nascimento">
            <span
                style="font-style: italic; color: #444; float: left; font-size: 12px; margin-bottom: 10px;">(DD/MM/AAAA)</span><br>
