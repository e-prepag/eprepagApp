            ...
            <table border="0" cellspacing="0" width="90%" align="center">
                <tr bgcolor="E5E5EB">
                    <td class="texto" height="20" colspan="6" align="center">
                        &nbsp;<a href="/creditos/conta/cupom_impressao_selecao.php?venda=<?php echo $venda_id?>" class="link_azul" target="_top">Lotes disponíveis para impressão - Imprimir cupons</a>
                    </td>
                </tr>
                <?php
                            ...
                            <td class="texto" height="20" colspan="6">
                                <table border="0" cellspacing="01" width="90%" align="center">
                                    ...
                                    <?php   while ($rs_pins_row = pg_fetch_array($rs_pins)){?>
                                                <tr class="texto">
                                                    <td align="center">
                                                            <a href="/creditos/conta/cupom_impressao_selecao.php?venda=<?php echo $venda_id?>&btMostrar=1&cmb_produto_modelo=<?php echo $rs_pins_row['vgm_id']?>" class="link_azul" target="_top">
                                                    <?php echo $rs_pins_row['vgm_nome_produto']?> 
                                                    <?php if($rs_pins_row['vgm_nome_modelo']!=""){ ?> - <?php echo $rs_pins_row['vgm_nome_modelo']?><?php } ?>
                                                    </a>
                                                    </td>
                                                    <td align="center">
                                                            <a href="/creditos/conta/cupom_impressao_selecao.php?venda=<?php echo $venda_id?>&btMostrar=1&cmb_produto_modelo=<?php echo $rs_pins_row['vgm_id']?>&tf_pin_impressao_qtde=2" class="link_azul" target="_top">
                                                            <?php echo $rs_pins_row['nao_impresso']?>
                                                    </a>
                                                    </td>
                                                    <td align="center">
                                                            <a href="/creditos/conta/cupom_impressao_selecao.php?venda=<?php echo $venda_id?>&btMostrar=1&cmb_produto_modelo=<?php echo $rs_pins_row['vgm_id']?>&tf_pin_impressao_qtde=1" class="link_azul" target="_top">
