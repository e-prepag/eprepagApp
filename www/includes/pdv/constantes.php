...
$FORMAS_PAGAMENTO_DESCRICAO_NEW = array(
    '1' => 'Depósito',
    '2' => 'Cartão',
    '5' => 'Transferência entre contas Bradesco',
    '6' => 'Pagamento Fácil Bradesco - Débito',
...
$USUARIO_GAMES_OPERADOR_TIPOS_NOME = array(
    '0'    =>    'Funcionário 2',
    '1'    =>    'Funcionário 1'
);
...
$USUARIO_GAMES_OPERADOR_TIPOS = array(
    'FUNCIONARIO_2'         => 0,
    'FUNCIONARIO_1'         => 1
);
$USUARIO_GAMES_OPERADOR_TIPOS_DESCRICAO = array(
    '0' => 'Funcionário 2: Impressão de senhas',
    '1' => 'Funcionário 1: Compras e impressão de senhas'
);

//Dados de repasse do pagamento Prepag
//------------------------------------------------------------------------------------------------
$DADOS_PAGTO_REPASSE_PREPAG = array(
...
//------------------------------------------------------------------------------------------------
$RISCO_CLASSIFICACAO = array(
    'PÓS-PAGO' => '1',
    'PRÉ-PAGO' => '2'
);

$RISCO_CLASSIFICACAO_NOMES = array(
    '1' => 'PÓS-PAGO',
    '2' => 'PRÉ-PAGO'
);

$RISCO_CLASSIFICACAO_DESCRICAO = array(
    '1' => 'LH pós-paga, com crédito semanal',
...
$GLOBALS['RISCO_LANS_PRE_PLATINUM_TOTAL_DIARIO']        = 150000.00;
$GLOBALS['RISCO_LANS_PRE_PLATINUM_PAGAMENTOS_DIARIO']   = 60;
$GLOBALS['RISCO_LANS_PRE_PLATINUM_VALOR_MIN_PARA_TAXA'] = 100.00;
$GLOBALS['RISCO_LANS_PRE_PLATINUM_VALOR_MIN']           = 100.00;
$GLOBALS['RISCO_LANS_PRE_PLATINUM_VALOR_MAX']           = 150000.00;
$GLOBALS['RISCO_LANS_PRE_PLATINUM_QTDE_PRODUTO']        = 30;
$GLOBALS['RISCO_LANS_PRE_PLATINUM_QTDE_MODELO']         = 110;
