...
$ENTRE_CONTATO_CENTRAL = "Por favor, entre em contato com nossa Central de Atendimento atravйs do e-mail suporte@e-prepag.com.br. \nObrigado.";
...
$BOLETO_MONEY_ITAU_CEDENTE_CONTA_DV             = "0"; 
        ...
        $BOLETO_MONEY_ITAU_TAXA_CUSTO_BANCO_NOVA 	= 1.80;	// й a taxa cobrada pelo Itaъ da E-Prepag para boletos na nova conta
...
//Tipos de Logradouro
//------------------------------------------------------------------------------------------------
$TIPOS_END = array("Aeroporto", "Alameda", "Бrea", "Avenida", "Campo", "Chбcara", "Colфnia", "Condomнnio", "Conjunto", "Distrito", "Esplanada", "Estaзгo", "Estrada", "Favela", "Fazenda", "Feira", "Jardim", "Ladeira", "Lago", "Lagoa", "Largo", "Loteamento", "Morro", "Nъcleo", "Parque", "Passarela", "Pбteo", "Praзa", "Quadra", "Recanto", "Residencial", "Rodovia", "Rua", "Setor", "Sнtio", "Travessa", "Trecho", "Trevo", "Vale", "Vereda", "Via", "Viaduto");

//Formas de Pagamento
//------------------------------------------------------------------------------------------------
// 1: Transferкncia Bancбria, DOC Eletrфnico, Depуsito ou Outros
...
$PAGAMENTO_BANCO_ITAU_ONLINE_NUMERIC = 10;	// para tabelas tb_venda_games e tb_dist_venda_games o campo vg_tipo_pagamento й numerico
                                                                                        // nгo pode usar $FORMAS_PAGAMENTO['PAGAMENTO_BANCO_ITAU_ONLINE']

// Banco E-Prepag - Testes
$PAGAMENTO_BANCO_EPP_ONLINE = 'Z';			// Banco E-Prepag de TESTES
$PAGAMENTO_BANCO_EPP_ONLINE_NUMERIC = 999;	// para tabelas tb_venda_games e tb_dist_venda_games o campo vg_tipo_pagamento й numerico
                                                                                        // nгo pode usar $PAGAMENTO_BANCO_EPP_ONLINE
...
$FORMAS_PAGAMENTO_DESCRICAO = array( '1' => 'Depуsito'
                                                                        ,'2' => 'Boleto Bancбrio'
//										,'3' => 'MasterCard'
//										,'4' => 'Diners'
//										,'5' => 'Repasse'
                                                                        ,'5' => 'Transferкncia entre contas Bradesco'
                                                                        ,'6' => 'Pagamento Fбcil Bradesco - Dйbito'
                                                                        ,'7' => 'Pagamento Fбcil Bradesco - Crйdito'
                                                                        //,'8' => 'Pagamento BB - Dйbito sua Empresa'
                                                                        ,'9' => 'Pagamento BB - Dйbito sua Conta'
                                                                        ,'A' => 'Pagamento Itau - А vista (Transferкncia)'
                                                                        ,'R' => 'Pix'
                                                                        );

$FORMAS_PAGAMENTO_DESCRICAO_NEW = array( '1' => 'Depуsito'
                                                                        ,'2' => 'Cartгo'
                                                                        ,'5' => 'Transferкncia entre contas Bradesco'
                                                                        ,'6' => 'Pagamento Fбcil Bradesco - Dйbito'
                                                                        ,'7' => 'Pagamento Fбcil Bradesco - Crйdito'
...
$BRADESCO_TRANSFERENCIA_ENTRE_CONTAS_TAXA_ADICIONAL = 0;	// R$1.20/transaзгo
$BRADESCO_DEBITO_EM_CONTA_TAXA_ADICIONAL = 0;	// R$0.00/transaзгo

$BANCO_DO_BRASIL_TAXA_DE_SERVICO	= 2.99;	// R$1.00/transaзгo

$BANCO_ITAU_TAXA_DE_SERVICO			= 1.49;	// R$0.50/transaзгo 
...
//	4: Processamento realizado. Crйdito serб encaminhado para o usuбrio
//	5: Venda realizada. Crйdito encaminhado para o usuбrio
//	6: Venda cancelada.
...
$STATUS_VENDA_DESCRICAO = array('1' => 'Pedido efetuado.',
                                                                '2' => 'Pedido aguardando liberaзгo.',
                                                                '3' => 'Pedido aguardando processamento.',
                                                                '4' => 'Pedido processado. Crйdito serб encaminhado.',
                                                                '5' => 'Venda realizada. Pins disponнveis para impressгo.',
                                                                '6'	=> 'Venda cancelada.',
...
$PAGTO_BANCOS	= array('001' => 'Banco do Brasil', 
                                                ...
                                                '104' => 'Caixa Econфmica Federal / Casas Lotйricas');

//Pagamento Locais
$PAGTO_LOCAIS	= array('001' => array(	'01' => 'Caixa Automбtico / Auto-Atendimento', 
                                                                                '02' => 'Agкncia / Boca do Caixa',
                                                                                '03' => 'Transferкncia pela Internet / DOC',
                                                                                '04' => 'Depуsito em conta corrente em dinheiro',
                                                                                '05' => 'Auto-Atendimento Transferкncia entre contas correntes',
                                                                                '06' => 'Remessa do exterior'
                                                                                ),
                                                '237' => array(	'01' => 'Caixa Automбtico / Auto-Atendimento', 
                                                                                '02' => 'Agкncia / Boca do Caixa',
                                                                                '03' => 'Transferкncia pela Internet / DOC',
                                                                                '04' => 'Banco Postal',
                                                ...
                                                '104' => array(	'01' => 'Caixa Automбtico / Auto-Atendimento', 
                                                                                '02' => 'Agкncia / Boca do Caixa',
                                                                                '03' => 'Transferкncia pela Internet / DOC',
                                                                                '04' => 'Casas Lotйricas',
                                                                                '05' => 'Caixa Aqui',
...
$PAGTO_NOME_DOCTO = array(	'001' => array( '01' => 'Nro. do Envelope', 
                                                                                        '02' => 'Agкncia de Origem ou Dйbito',
                                                                                        '03' => 'Agкncia de Origem ou Dйbito;Conta de Origem ou Dйbito',
                                                                                        '04' => 'Nr. Documento',
                                                                                        '05' => 'Agкncia de dйbito;Conta de dйbito',
                                                                                        '06' => 'Remetente;Banco;Paнs;Moeda'
                                                                                        ),
                                                        '237' => array(	'01' => 'Nro. do Terminal;Nro. da Transaзгo;Agкncia Tomadora', 
                                                                                        '02' => 'Agкncia Tomadora;Nr. Terminal',
                                                                                        '03' => 'Nro. do Documento;Agencia de Dйbito',
                                                                                        '04' => 'Agкncia Relacionada e PACB',
                                                                                        '05' => 'Nro. do Terminal;Nro. da Transaзгo',
                                                                                        '06' => 'Remetente;Banco;Paнs;Moeda'
                                                                                        ),
                                                        '104' => array(	'01' => 'Nro. do Envelope', 
                                                                                        '02' => 'Nro. do Documento',
                                                                                        '03' => 'Cуdigo da Operaзгo',
                                                                                        '04' => 'Horбrio do Depуsito',
                                                                                        '05' => 'Cуdigo da Operaзгo;Horбrio do Depуsito',
                                                                                        '06' => 'Remetente;Banco;Paнs;Moeda'
                                                                                        )
                                                );
...
$USUARIO_GAMES_LOG_TIPOS_DESCRICAO = array(	'1' => 'Criaзгo de Cadastro',
                                                                                        '2' => 'Login',
                                                                                        '3' => 'Alteraзгo cadastral',
                                                                                        '4' => 'Troca de senha',
                                                                                        ...
                                                                                        '11' => 'Acessou um banner de promoзгo',
                                                                                        '12' => 'Trкs tentativas de login incorreto',
                                                                                        '13' => 'Ip da conexгo diferente do ip cadastrado',
                                                                                        '14' => 'Diferente do dia da semana ou horбrio cadastrado',
                                                                                        '15' => 'Tentativa de login simultaneo',
                                                                                        '16' => 'Alteraзгo na opзгo de login simultaneo',
                                                                                        '17' => 'Alteraзгo no cadastro de ip',
                                                                                        '18' => 'Alteraзгo no Horario de Inicio - Segunda',
                                                                                        '19' => 'Alteraзгo no Horario do Fim - Segunda',
                                                                                        '20' => 'Alteraзгo no Horario de Inicio - Terзa',
                                                                                        '21' => 'Alteraзгo no Horario do Fim - Terзa',
                                                                                        '22' => 'Alteraзгo no Horario de Inicio - Quarta',
                                                                                        '23' => 'Alteraзгo no Horario do Fim - Quarta',
                                                                                        '24' => 'Alteraзгo no Horario de Inicio - Quinta',
                                                                                        '25' => 'Alteraзгo no Horario do Fim - Quinta',
                                                                                        '26' => 'Alteraзгo no Horario de Inicio - Sexta',
                                                                                        '27' => 'Alteraзгo no Horario do Fim - Sexta',
                                                                                        '28' => 'Alteraзгo no Horario de Inicio - Sabado',
                                                                                        '29' => 'Alteraзгo no Horario do Fim - Sabado',
                                                                                        '30' => 'Alteraзгo no Horario de Inicio - Domingo',
                                                                                        '31' => 'Alteraзгo no Horario do Fim - Domingo',
                                                                                        '32' => 'Carrega Sessгo via NexCafe',
                                                                                        '33' => 'Login Automбtico via NexCafe',
                                                                                        '34' => 'Login via Formulбrio NexCafe',
                                                                                        '35' => 'Erro ao Tentar Carregar Sessгo via NexCafe',
                                                                                        '36' => 'Erro ao Tentar Login Automбtico via NexCafe',
                                                                                        '37' => 'Erro ao Tentar Login via Formulбrio NexCafe',
                                                                                        '38' => 'Atualiza Dados do NexCafй na Conta E-Prepag',
                                                                                        '39' => 'Cadastro de Lan House via NexCafй',
                                                                                        );

$USUARIO_GAMES_OPERADOR_TIPOS_NOME = array(	'0'	=>	'Funcionбrio 2', 
                                                                                        '1'	=>	'Funcionбrio 1');
$USUARIO_GAMES_OPERADOR_TIPOS = array(	'FUNCIONARIO_2' 		=> 0, 
                                                                                'FUNCIONARIO_1' 		=> 1);
$USUARIO_GAMES_OPERADOR_TIPOS_DESCRICAO = array(	'0' => 'Funcionбrio 2: Impressгo de senhas',
                                                                                                        '1' => 'Funcionбrio 1: Compras e impressгo de senhas');
...
$CADASTRO_FATURAMENTO 	= array('1' 		=> 'Atй R$5.000,00',
                                                                '2' 		=> 'R$  5.000,01 a R$ 10.000,00',
                                                                '3' 		=> 'R$ 10.000,01 a R$ 20.000,00',
                                                                '4' 		=> 'Mais de R$ 20.000,00');

$CADASTRO_COMPUTADORES 	= array('1' 		=> 'Atй 05',
                                                                '2' 		=> '06 a 10',
                                                                '3' 		=> '11 a 20',
                                                                '4' 		=> 'Mais de 20');

// Dados de Gestгo de Risco LH
//------------------------------------------------------------------------------------------------
$RISCO_CLASSIFICACAO = array(	'PУS-PAGO' => '1',	
                                                                'PRЙ-PAGO' => '2'	
                                                        );

$RISCO_CLASSIFICACAO_NOMES = array(	'1' => 'PУS-PAGO',	
                                                                        '2' => 'PRЙ-PAGO'	
                                                        );

$RISCO_CLASSIFICACAO_DESCRICAO = array( '1' => 'LH pуs-paga, com crйdito semanal',
                                                                                '2' => 'LH sу compra prй-pago'
                                                                                );
...
$SUBSTATUS_LH = array(
                                                "-1" => "Nгo definido",
                                                "1" => "Pendente de Contato e Anбlise",
                                                "2" => "Loja nгo Localizada",
                                                "3" => "Representante Divergente",
                                                "4" => "Cadastro nгo Aprovado",
                                                "5" => "Cnpj Baixado",
                                                "6" => "Nгo quer mais vender",
                                                "7" => "Bloqueado por fraude",
                                                "8" => "Prй-Cadastro/Prospecзгo", 
                                                "9" => "Ainda nгo fez 1є compra",
                                                "10" => "Inadimplentes",
                                                "11" => "PDV aprovado",
												"12" => "PDV inativo por falta de uso",
												"13" => "Bloqueio temporбrio e preventivo а fraudes"
                                                );

$SUBSTATUS_LH_PAG_ONLINE = array(
                                                "-1" => "Nгo definido",
                                                "1" => "Nгo possui conta nos bancos disponнveis",
                                                "2" => "Nгo consegue efetuar pagamento online",
                                                "3" => "Nгo quer mais vender",
                                                "4" => "Tem receio de efetuar transaзхes online",
                                                "5" => "Telefone incorreto",
                                                "6" => "Tentativa de contato sem sucesso",
                                                "7" => "Retornar mais tarde",
                                                "8" => "Nгo conhecia essa forma de pagamento",
                                                "9" => "Aceitou utilizar o pagamento online",
                                        );

/*
// Gestгo de Risco
// Usuбrios cartгo permitidos pela Cielo
...
//	Lans Pre - Pagamento Online = no max R$900,00 por dнa por usuбrio (ver getVendasLHTotalDiarioOnline())
...
// Para diferenciar usuбrios Frequente/Atrasados/Abandonados
...
//Constante que limita o nъmero de PINS permitidos por produto em uma venda
$LIMITE_QUANTIDADE_PINS = 100;

//Identificaзгo de empresas
...
//Identificador de modelo de produto que utiliza valor variбvel
$NO_HAVE = 'NO HAVE';
