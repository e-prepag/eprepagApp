        ...
        if (is_Integracao_valida()) {
            ...
            if (is_Integracao_params_valida($parceiro_params, $mensagem)) {
                ...
                if ($integracao_mod > 0) {
                    ...
                    $classUsuarioGames = new UsuarioGames();
                    // Fazer login para o usuário ou cadastrar um novo usuário
                    $idcliente = $classUsuarioGames->existeEmail_get_ID($integracao_client_email);
                    ...
                    if ($idcliente > 0) {
                        ...
                        if (strtoupper($integracao_client_email) == "WALTER@MAIL.COM") {
                            ...
                            $bret = $classUsuarioGames->adicionarLoginSession_ByID($idcliente);
                        }

                        if ($bret) {
                            grava_log_integracao("Integração +++ Passou UsuarioGames::adicionarLoginSession_ByID($idcliente): " . date("Y-m-d H:i:s") . "\n");
                            // Atualiza último acesso
                            $classUsuarioGames->atualiza_ultimo_acesso($integracao_client_email);
                ...
                <div id="mostraLista" class="">
                    <form name="form1" action="" method="post">
                        ...
                        <table border="0" cellspacing="0" bgcolor="#FFFFFF" width="100%" style="display: none;">
                            <tr>
                                <td><span id="img_logo_inategracao" name="img_logo_inategracao"></span>&nbsp;</td>
                            </tr>
                        ...
                        ?>
                                ...
                                <div class="row espacamento top20">
                                    ...
                                    <div class="<?php if ($only_eppcash) echo "col-xs-offset-1" ?> <?php if (isset($div_eppcash)) echo "col-xs-12 col-md-4 mt-sm-15";
                                        ...
                                        <?php
                                                ...
                                                if (
                                                    $usuarioGames->b_IsLogin_pagamento_pin_EPP_Cash() &&
                                ...
                                <div class="<?php if (isset($only_personalizado)) echo "col-xs-12 col-md-4 mt-sm-15"; ?>">
                                    <?php
                                                ...
                                                if (
                                                    $usuarioGames->b_IsLogin_pagamento_pin_Personalizado() &&
                                                    b_pin_forma_pagamento() &&
                                                    !in_array("S", $lispags)
                                                ) {
                            ...
                            ?>
                            <!--<div class="<?php // if(isset($div_cielo)) echo 'col-md-2'; else echo 'dnone';
                                            ?> col-lg-2 col-sm-2 col-xs-6 top20 text-center">-->
                            <?php
                                                //----Wagner
                                                // Linha CIELO - inicio
                        ...
                        <div clas="col-md-12 text-left">
                            ...
                            <b><?php echo $FORMAS_PAGAMENTO_DESCRICAO[$FORMAS_PAGAMENTO['DEP_DOC_TRANSF']] ?></b>
                        </div>
                        ...
                        <table width="53%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td colspan="4" class="style5"><strong>Raz&atilde;o Social:</strong> <span class="style8">E-PREPAG PAGAMENTOS ELETR&Ocirc;NICOS S/S LTDA</span><br />
                                    <strong>CNPJ/CPF:</strong><span class="style8"> 08.221.305/0001-35 </span>
                                </td>
                            </tr>
                        </table>
                         
            ...
            if ($b_nova_forma_pagamento) {
                ...
                ?>
                    ...
                    <?php
                        ...
                        $total_geral = isset($total_geral) ? $total_geral : 0;
                    ?>
