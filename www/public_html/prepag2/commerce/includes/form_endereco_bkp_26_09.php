    ...
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        ...
        <div class="int-form1" style="position: relative;">
            <form action="" id="enderecoForm" method="POST">
                ...
                <input type="hidden" name="btSubmit_EPP_8593" value="<?php echo $btSubmit_EPP_8593;?>" style="display: none;" />
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                                <input type="text" class="form-control w320" id="endereco" name="endereco" maxlength="500" readonly="" value="<?php echo $form_endereco; ?>" placeholder="Logradouro">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control w110" id="numero" name="numero" maxlength="10" value="<?php echo $form_numero; ?>" placeholder="Número">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control w320" id="complemento" name="complemento" maxlength="500" value="<?php $form_complemento; ?>" placeholder="Complemento">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control w320" id="bairro" readonly="" name="bairro" maxlength="500" value="<?php echo $form_bairro; ?>" placeholder="Bairro">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control w320" id="cidade" readonly="" name="cidade" maxlength="500" value="<?php echo $form_cidade; ?>" placeholder="Cidade">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control w110" id="uf" readonly="" name="uf" maxlength="2" value="<?php echo $form_uf; ?>" placeholder="UF">
                            </div>
                    <div class="form-group">
