...
<div class="wrapper txt-preto int-box">
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        <h4 class="c1 txt-azul">Por favor, complete o campo abaixo com o seu CPF <a href="#" class="btn-question glyphicon glyphicon-question-sign txt-vermelho c-pointer t0" data-msg="<h2>O que é isso?</h2>Agora todas as transações financeiras de jogos online no Brasil são condicionadas ao fornecimento de um CPF. Esta informação será solicitada em algumas compras, mas não sempre. Agradecemos a sua compreensão." style="position: relative;"></a></h4>
        ...
        <div class="int-form1" style="position: relative;">
            <form action="" id="cpfForm" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control w160" id="cpf" name="cpf" maxlength="14" value="<?php echo htmlspecialchars($form_cpf, ENT_QUOTES, 'UTF-8'); ?>" placeholder="CPF">
                </div>
                <div class="form-group bottom0">
                    <!--<label for="cpf">Data de Nascimento (<i>(DD/MM/AAAA)</i>):</label>-->
                    <input type="text" class="form-control datepicker w160" value="<?php echo htmlspecialchars($form_data_nascimento, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Data de Nascimento" name="data_nascimento" id="data_nascimento">
                </div>
                <span style="font-style: italic; color: #444; float: left; font-size: 12px; margin-top: 0px;">(DD/MM/AAAA)</span><br>
                <div class="form-group">
                    <input type="button" class="int-btn1 grad2 btn btn-sm btn-success pull-right" value="Agora não" style="display: inline-block; visibility: <?php echo $partner['partner_need_cpf'] == 2 ? "visible" : "hidden"; ?>;" id="skipform" />
                    <input type="button" class="int-btn1 grad1 btn btn-sm btn-success pull-left" id="btn_submit" value="Confirmar" />
                </div>
