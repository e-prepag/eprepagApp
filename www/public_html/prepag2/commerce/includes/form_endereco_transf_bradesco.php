...
<div class="wrapper txt-preto int-box">
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'); ?>" id="enderecoForm" method="POST">
            <input type="hidden" name="formsubmitEnd" value="OK" style="display: none;" />
            <input type="hidden" name="btSubmit" value="<?php echo htmlspecialchars($btSubmit, ENT_QUOTES, 'UTF-8'); ?>" style="display: none;" />
            <input type="hidden" name="tipo" value="<?php echo htmlspecialchars($tipo, ENT_QUOTES, 'UTF-8'); ?>" style="display: none;" />
            <input type="hidden" name="produtos_valor" value="<?php echo htmlspecialchars($produtos_valor, ENT_QUOTES, 'UTF-8'); ?>" style="display: none;" />
            ...
            <input type="hidden" name="prod_camp" value="<?php echo htmlspecialchars($prod_camp, ENT_QUOTES, 'UTF-8'); ?>" style="display: none;" />
            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    <input type="text" class="form-control w320" id="endereco" <?php echo htmlspecialchars($readonly_logradouro, ENT_QUOTES, 'UTF-8'); ?> name="endereco" maxlength="500" value="<?php echo htmlspecialchars($form_endereco, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Logradouro">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control w320" id="complemento" name="complemento" maxlength="500" value="<?php echo htmlspecialchars($form_complemento, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Complemento (opcional)">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control w320" id="bairro" <?php echo htmlspecialchars($readonly_bairro, ENT_QUOTES, 'UTF-8'); ?> name="bairro" maxlength="500" value="<?php echo htmlspecialchars($form_bairro, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Bairro">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control w320" id="cidade" <?php echo htmlspecialchars($readonly_cidade, ENT_QUOTES, 'UTF-8'); ?> name="cidade" maxlength="500" value="<?php echo htmlspecialchars($form_cidade, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Cidade">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control w110" id="uf" <?php echo htmlspecialchars($readonly_estado, ENT_QUOTES, 'UTF-8'); ?> name="uf" maxlength="2" value="<?php echo htmlspecialchars($form_uf, ENT_QUOTES, 'UTF-8'); ?>" placeholder="UF">
                </div>
                <div class="form-group">
