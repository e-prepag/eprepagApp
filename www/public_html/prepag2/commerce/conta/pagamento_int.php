    ...
    <tr valign="top" align="center">
      <td>
        ...
        <tr valign="middle" bgcolor="#FFFFFF">
            <td align="left" class="texto_vermelho"><?php echo nl2br(htmlspecialchars($msg, ENT_QUOTES, 'UTF-8')); ?></td>
        </tr>
		</table>
		<?php  } 
...
<?php
                        if(!$only_eppcash){
?>
                            <p class="txt-azul fontsize-pp bottom0">Não tem um PIN?</p>
                            <p class="txt-azul fontsize-pp"><b><u><a href="https://www.e-prepag.com.br/game/produto/detalhe.php?token=IlJQTB5TdFZVAj0XFwEHNwdDTRYafFtNGHlHQxg">Compre aqui</a></u></b></p>
<?php
                        }
?>
...
<?php
	...
	?>
            <div class="row">
                ...
                <div class="col-xs-8">
						<!-- volteaqui -->
                        <p class="fontsize-pp bottom0"><?php echo htmlspecialchars(strtoupper(verifica_nome_operadora($integracao_origem_id)["opr_nome_loja"]), ENT_QUOTES, 'UTF-8'); ?> </p>
                        <p class="txt-vermelho fontsize-pp bottom0">Sem taxa de serviço</p>
                        <p class="txt-verde fontsize-pp">Entrega Imediata</p>
				</div>
            </div>
