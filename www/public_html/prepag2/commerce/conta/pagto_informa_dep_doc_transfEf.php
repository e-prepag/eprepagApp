...
$params = [
	$STATUS_VENDA['DADOS_PAGTO_RECEBIDO'],               // $1
	$pagto_banco,                                        // $2
	$pagto_local,                                        // $3
	implode("|", $pagto_num_docto),                      // $4
	moeda2numeric($pagto_valor_pago),                    // $5
	monta_data_gravacao($pagto_data_data) . " " .
		$pagto_data_horas . ":" . $pagto_data_minutos,   // $6
	$venda_id                                            // $7
];
