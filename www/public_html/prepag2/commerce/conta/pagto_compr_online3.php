...
if ($ultimo_status == $GLOBALS['STATUS_VENDA']['VENDA_REALIZADA']) {
    ...
    SELECT *
    FROM tb_pag_compras
    WHERE idvenda = $1 AND idcliente = $2
";
												...
												<tr>
													<td align="center" class="texto" align="center" height="100">
														<div id="info_pagamento">
															<table>
																<tr>
																	<td valign='middle'><img src='/imagens/loading1.gif' width='42' height='42' border='0' title='Aguardando pagamento...' class="int-pagamento-compr-online-loading"></td>
																	<td>&nbsp;</td>
																	<td valign='middle'>
																		<font color='#FF0000' size='1' class="int-pagamento-compr-online-message1">Clique abaixo para efetuar o pagamento.<br>Após o pagamento o processamento leva alguns instantes.</font>
																	</td>
																</tr>
															</table>
														</div>
							...
							<div class='divToken'><span class='titulo'>Validação do cartão</span><br><br>
										...
										?>
											<td align='right'>
												<form action="/cielo/pages/novoPedidoAguarde.php" method="POST" target="_blank">
													...
													<!--font color='blue'> R$ <?php //echo number_format(($total_geral+$taxa),2,',','.'); 
																				?></font-->
													<?php
													$sql = "SELECT * FROM tb_pag_compras WHERE idvenda = $1 AND idcliente = $2";
													$rs_pagto = SQLexecuteQueryParams($sql, [$venda_id, $usuarioId]);
													...
													?>
														<!--br>pagto_tipo : <?php //echo $pagto_tipo; 
																			?><br>vg_id: <?php //echo $venda_id;
																							?><br>usuarioId: <?php //echo $usuarioId;
																												?><br>numcompra: <?php //echo $numcompra;
																																	?><br-->
								...
								<tr bgcolor="ffffff">
									<td align="center" class="texto">
										...
										?>
											<form action="<?php echo $location; // "../debug.php" 
															?>" method="post" target="_blank"><input type="submit" name="btnIrAoBanco" value="Clique aqui para pagar" class="int-btn1 grad1 int-pagamento-compr-online-btn1 btn btn-success btn btn-sm btn-success">
