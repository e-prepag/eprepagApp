				...
				<table border="0" cellspacing="0" width="90%" class="int-pagamento-compr-online-logo hide-pix-success">
					<tr>
					  <td class="texto" align="left" width="0%"><?php echo $simg_bank; ?></td>
                                          <td class="texto" align="center" width="100%" style="color: #1681b7;">&nbsp;<?php
                                          if($pagto_tipo == $PAGAMENTO_PIX_NUMERIC){ 
												...
												if(PAGAMENTO_PIX_CHAVEAMENTO == "a" || $_SERVER['REMOTE_ADDR'] == "187.18.199.57") {
													if(number_format(($total_carrinho+$taxas),2,'.','') > 1.00){
