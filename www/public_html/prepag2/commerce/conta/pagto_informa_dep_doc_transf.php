                ...
                if (!in_array($fileExtensao, ['JPG', 'GIF', 'PNG'])) {
                    ...
                    if ($BASE_UPLOAD_DIR === false) {
                        ...
                        if ($resolvedPath === false || strpos($resolvedPath, $BASE_UPLOAD_DIR) !== 0) {
                            ...
                            // 6. Realizar o upload apenas se todas as verificações passarem
...
<script>
    $(function() {
        ...
        $("#pagto_valor_pago").mask('000.000,00', {
            reverse: true
        });
    })
</script>
...
<form name="form1" action="" method="post" ENCTYPE="multipart/form-data">
    ...
    <div class="wrapper" style="border-top: 0px;">
        <table border="0" cellspacing="0" align="center" class="wrapper" style="<?php if ($GLOBALS['_SESSION']['is_integration'] == true) echo 'padding-right: 30px;"'; ?>">
            ...
            <tr>
                <td>
                    <table class="fontsize-pp" <?php if ($GLOBALS['_SESSION']['is_integration'] == true) {
                                ...
                                <table class="table fontsize-pp">
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <td colspan="2" align="center"><input type="submit" name="btSubmit" value="Continuar" class="btn btn-sm btn-success <?php if ($GLOBALS['_SESSION']['is_integration'] == true) {
                                                                                                                                                                        echo "int-btn1 grad1";
                                                                                                                                                                    } ?>"></td>
                                            </tr>
                                    <?php
