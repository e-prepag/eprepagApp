...
if($ip_address == "187.18.198.236") {
    ...
    // Função para criar o log formatado
    function createRequestLog() {
        ...
        $log .= "POST Data: " . print_r($postData, true) . "\n";
        $log .= "=====================\n";
    ...
    // Chamar a função para criar o log
    createRequestLog();
}
...
if(! ($btSubmit_EPP_8593 || $iforma) ){
        ...
        if($b_debug_trace) {
            echo "_SERVER['HTTP_REFERER']: " . htmlspecialchars($_SERVER['HTTP_REFERER'], ENT_QUOTES, 'UTF-8') . "<br>";
        }
        ...
        if(true) {	//		if(is_Integracao()) {
                ...
                if(is_Integracao_valida()) {
                        ...
                        if(is_Integracao_params_valida($parceiro_params,$mensagem)) {
                                ...
                                if($ip_address == "187.18.198.236") echo "Integracao id: $integracao_store_id";
                                ...
                                if($ip_address == "187.18.198.236") {
                                    echo "bloqueia: $b_bloqueia_por_order_existe";
                                }
...
//					echo (($b_bloqueia_por_order_existe) ?"S":"N");
                                ...
                                if(!$b_amount_free) $b_amount_free = 1;
                                if($ip_address == "187.18.198.236") {
                                    echo "Amount free: $b_amount_free";
                                }
...
//				Dummy 				$valor = 23;
                                ...
                                if($ip_address == "187.18.198.236") file_put_contents("teste_modelo.txt","integracao_mod: ". print_r($integracao_mod) ."\n", FILE_APPEND);
                                ...
                                //		$idcliente = 9093;	=> reinaldops@hotmail.com
                                                ...
                                                if($bret) {
                                                        ...
                                                        if($ip_address == "187.18.198.236") echo "Passou aqui";
                                                        ...
                                                        if($ip_address == "187.18.198.236") file_put_contents("teste_img.txt", "img: $integracao_logo_img. partner_name: $integracao_logo_img.", FILE_APPEND);
                                                ...
                                                if($ug_id_novo>0) {
                                                        ...
                                                        if($ip_address == "187.18.198.236") echo "Passou ug_id novo";
                                        ...
                                        if($integracao_is_parceiro=="OK" && $integracao_origem_id != "") {
                                                ...
                                                if($rs && pg_num_rows($rs) == 1){
                                                        ...
                                                        if($ip_address == "187.18.198.236") echo "Carrinho: " . print_r($carrinho);
                                                        ...
                                                        if($ip_address == "187.18.198.236") file_put_contents("produto_teste.txt", "Produto: $partner_produto_id", FILE_APPEND);
...
if($ip_address == "187.18.198.236") echo "int_id: $integracao_origem_id";
...
if($btSubmit_EPP_8593 || $iforma){
        ...
        if($ip_address == "187.18.198.236") echo "int_id btnsubmit: $integracao_origem_id";
        ...
        if($msg == ""){
                ...
                if($ip_address == "187.18.198.236") echo "int_id session: " . $_SESSION['integracao_origem_id'];
...
<div id="mostraLista" class="">
    ...
    <tr valign="top" align="center">
      <td>
        ...
        <td align="left" class="texto_vermelho">
            <?php echo nl2br(htmlspecialchars($msg, ENT_QUOTES, 'UTF-8')); ?>
        </td>
        </tr>
		</table>
		<?php  } 
...
//	$RISCO_GAMERS_VIP_PAGAMENTOS_DIARIO = 20;
        ...
        if($ip_address == "187.18.198.236") echo "bb online: $b_bloqueado_BBR9";
        ...
        if($ip_address == "187.18.198.236") echo "itau: $b_bloqueado_BITA";
        ...
        if($ip_address == "187.18.198.236") echo "bradesco: $b_bloqueado_BRD5";
        $b_bloqueado_BRD6 = b_is_forma_pagto_bloqueada($integracao_origem_id, $FORMAS_PAGAMENTO['PAGAMENTO_FACIL_BRADESCO_DEBITO']);
        if($ip_address == "187.18.198.236") echo "bradesco 2: $b_bloqueado_BRD6";
        ...
        if($ip_address == "187.18.198.236") echo "boleto: $b_bloqueado_BOL2";
        ...
        if($ip_address == "187.18.198.236") echo "tranf: $b_bloqueado_DEP1";
        ...
        if($ip_address == "187.18.198.236") echo "pix: $b_libera_Pix";
        ...
        if($ip_address == "187.18.198.236") echo "Lista pags: " . print_r($lispags);
...
//						"  RISCO_GAMERS_TOTAL_DIARIO: ".number_format($RISCO_GAMERS_TOTAL_DIARIO, 2, ',', '.')."\n".
        ...
        if($usuarioGames->b_IsLogin_pagamento_pin_EPP_Cash() && b_pin_forma_pagamento() && PAGAMENTO_EPREPAG_CASH && !b_is_forma_pagto_bloqueada($integracao_origem_id, $FORMAS_PAGAMENTO['PAGAMENTO_PIN_EPREPAG']) && $b_libera_EppCash) {
            ...
            $have_eppcash = true;
            $div_eppcash = true;
            if($ip_address == "187.18.198.236") echo "Chegou cont pags pin epp: $cont_pagamentos";
        }
		...
		if($usuarioGames->b_IsLogin_pagamento_pin_Personalizado() && b_pin_forma_pagamento() && !b_is_forma_pagto_bloqueada($integracao_origem_id, $FORMAS_PAGAMENTO['PAGAMENTO_PERSONALIZADO']) && $b_libera_Pagamento_personalizado) {
            ...
            if($ip_address == "187.18.198.236") echo "Chegou cont pags pag pers: $cont_pagamentos";
        }
						...
						<tr valign="middle" bgcolor="#FFFFFF">
							<td align="left" class="texto">
								...
								<tr bgcolor="#F0F0F0" height="25">
									...
									<td class="texto" width="60%">&nbsp;<?php echo htmlspecialchars($integracao_cliente_id) ?></td>
								</tr>
								</table>
							</td>
						</tr>
...
?>
    ...
    <input type="hidden" name="integracao_is_parceiro" value="<?php echo htmlspecialchars($integracao_is_parceiro, ENT_QUOTES, 'UTF-8'); ?>">
    <input type="hidden" name="integracao_origem_id" value="<?php echo htmlspecialchars($integracao_origem_id, ENT_QUOTES, 'UTF-8'); ?>">
    <input type="hidden" name="integracao_order_id" value="<?php echo htmlspecialchars($integracao_order_id, ENT_QUOTES, 'UTF-8'); ?>">
    <input type="hidden" name="integracao_client_email" value="<?php echo htmlspecialchars($integracao_client_email, ENT_QUOTES, 'UTF-8'); ?>">
    <div class="row espacamento top20">
<?php
        if($ip_address == "187.18.198.236") echo "Passou form";
...
<?php                   
                    ...
                    if(!$b_bloqueia_Ongame && (isset($div_pix))) {
                        ...
                        if($b_libera_Pix && PAGAMENTO_PIX){
                            if($ip_address == "187.18.198.236") echo "saveshipping pix";
...
?>           
                        <div class="col-xs-4">
                            ...
                            <?php
                                if ($ip_address == "187.18.198.236") {
                                    echo '<button onclick="'.$onclick.'">Clique aqui</button>';
                                }
                            ?>
                        </div>
                        <div class="col-xs-8">
...
<?php
        ...
        if($usuarioGames->b_IsLogin_pagamento_pin_EPP_Cash() && 
            ...
            !b_is_forma_pagto_bloqueada($integracao_origem_id, $FORMAS_PAGAMENTO['PAGAMENTO_PIN_EPREPAG']) && isset($div_eppcash)) {
                if($ip_address == "187.18.198.236") echo "Chegou pin epp: $cont_colunas";
            $cont_colunas++;
            ...
            if($b_libera_EppCash) {
                ...
                if($ip_address == "187.18.198.236") echo "Save shipping";
            }else{
                $onclick = '';
            }
...
<?php
		...
		//if ($_SERVER["REMOTE_ADDR"] == "201.93.162.169"){
			...
			if($ip_address == "187.18.198.236") echo "Part info: " . print_r($partner_info);
	?>	
	...
	?>
            <div class="row">
                <div class="col-xs-4">
					<div id="water-mark">
                    <img 
                            src="<?php echo htmlspecialchars($partner_info["logo"], ENT_QUOTES, 'UTF-8'); ?>" 
                            class="c-pointer btnPgto"
                            id="logo-inside"
                            style="width:100%; max-width: 100px;"
                            name="btn_13"
                            title="<?php echo htmlspecialchars($FORMAS_PAGAMENTO_DESCRICAO[$FORMAS_PAGAMENTO['PAGAMENTO_PIN_EPREPAG']], ENT_QUOTES, 'UTF-8'); ?>"
                ...
                <div class="col-xs-8">
						<!-- volteaqui -->
                        <p class="fontsize-pp bottom0">
                            <?php echo htmlspecialchars(strtoupper(verifica_nome_operadora($integracao_origem_id)["opr_nome_loja"]), ENT_QUOTES, 'UTF-8'); ?>
                            <?php if($ip_address == "187.18.198.236") echo "Nome da loja"; ?>
                        </p>
                        <p class="txt-vermelho fontsize-pp bottom0">Sem taxa de serviço</p>
                        <p class="txt-verde fontsize-pp">Entrega Imediata</p>
				</div>
...
<?php
        ...
        ) 
        {
            ...
            if($libera_pagamento['Cielo_Visa_DEB'] && !b_is_forma_pagto_bloqueada($integracao_origem_id, $FORMAS_PAGAMENTO['PAGAMENTO_VISA_DEBITO'])){
                if($ip_address == "187.18.198.236") echo "Pag visa deb";
                $cont_colunas++;
                if($liberado){
...
<?php
            ...
            if($libera_pagamento['Cielo_Visa_CRED']  && !b_is_forma_pagto_bloqueada($integracao_origem_id, $FORMAS_PAGAMENTO['PAGAMENTO_VISA_CREDITO'])){
                if($ip_address == "187.18.198.236") echo "cielo";
                $cont_colunas++;
                if($liberado){
...
<?php
            ...
            if($libera_pagamento['Cielo_Master_CRED'] && !b_is_forma_pagto_bloqueada($integracao_origem_id, $FORMAS_PAGAMENTO['PAGAMENTO_MASTER_CREDITO'])){
                if($ip_address == "187.18.198.236") echo "master";
                $cont_colunas++;
                if($liberado){
...
<?php
            ...
            if($libera_pagamento['Cielo_Elo_CRED'] && !b_is_forma_pagto_bloqueada($integracao_origem_id, $FORMAS_PAGAMENTO['PAGAMENTO_ELO_CREDITO'])){
                if($ip_address == "187.18.198.236") echo "cielo cred";
                $cont_colunas++;
                if($liberado){
...
<?php
            ...
            if($libera_pagamento['Cielo_Diners_CRED'] && !b_is_forma_pagto_bloqueada($integracao_origem_id, $FORMAS_PAGAMENTO['PAGAMENTO_DINERS_CREDITO'])){
                if($ip_address == "187.18.198.236") echo "Part dinnaer";
                $cont_colunas++;
                if($liberado){
...
<?php
            ...
            if($libera_pagamento['Cielo_Discover_CRED'] && !b_is_forma_pagto_bloqueada($integracao_origem_id, $FORMAS_PAGAMENTO['PAGAMENTO_DISCOVER_CREDITO'])){
                if($ip_address == "187.18.198.236") echo "discover";
                $cont_colunas++;
                if($liberado){
...
?>
	...
	// Aqui terminam as formas de pagamento
        ...
        if($ip_address == "187.18.198.236") file_put_contents("teste.txt", "url: $partner_url. name: $partner_name.", FILE_APPEND);
	?>
        <div class="alert alert-danger" role="alert"> 
            <p>
                Desculpe, o pedido <b><?php echo htmlspecialchars($integracao_order_id, ENT_QUOTES, 'UTF-8'); ?></b> do parceiro 
                <span title="<?php echo htmlspecialchars($integracao_store_id, ENT_QUOTES, 'UTF-8'); ?>">
                    <b><?php echo htmlspecialchars($partner_name, ENT_QUOTES, 'UTF-8'); ?></b>
                </span> já existe no nosso sistema. <br><br>
...
?>
    <form name="form1" action="" method="post">
        <input type="hidden" name="iforma" value="<?php echo htmlspecialchars($FORMAS_PAGAMENTO['PAGAMENTO_PIN_EPREPAG'], ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="idu" value="<?php echo htmlspecialchars(($usuarioGames->getId() > 0) ? $usuarioGames->getId() : "0", ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="sno" value="<?php echo htmlspecialchars($usuarioGames->getNome(), ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="integracao_is_parceiro" value="<?php echo htmlspecialchars($integracao_is_parceiro, ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="integracao_origem_id" value="<?php echo htmlspecialchars($integracao_origem_id, ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="integracao_order_id" value="<?php echo htmlspecialchars($integracao_order_id, ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="integracao_client_email" value="<?php echo htmlspecialchars($integracao_client_email, ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="pagto" value="<?php echo htmlspecialchars($FORMAS_PAGAMENTO['PAGAMENTO_PIN_EPREPAG'], ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="btSubmit_EPP_8593" value="Continuar">
    </form>
    <script type="text/javascript">
        document.form1.submit();
...
<?php
    ob_end_flush(); 
    if($ip_address == "187.18.198.236") echo "Form1";
    }//end if($usuarioGames->b_IsLogin_pagamento_pin_EPP_Cash() && b_pin_forma_pagamento())
    else {
        if($ip_address == "187.18.198.236") echo "mostra lista";
?>
    <script type="text/javascript">
     $('#mostraLista').show();
    </script>
...
if (!$b_libera_Bradesco5 && !$b_libera_Bradesco6 && !$b_libera_Deposito && !$b_libera_BancodoBrasil && !$b_libera_BancoItau && b_is_forma_pagto_bloqueada($integracao_origem_id, $FORMAS_PAGAMENTO['PAGAMENTO_PIN_EPREPAG']) && !$b_libera_Cielo) {
    if($b_libera_Boleto) {
        if($ip_address == "187.18.198.236") file_put_contents("abc", "");
        
?>
    <form name="form1" action="" method="post">
        <input type="hidden" name="iforma" value="<?php echo htmlspecialchars($FORMAS_PAGAMENTO['BOLETO_BANCARIO'], ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="idu" value="<?php echo htmlspecialchars(($usuarioGames->getId() > 0) ? $usuarioGames->getId() : "0", ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="sno" value="<?php echo htmlspecialchars($usuarioGames->getNome(), ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="integracao_is_parceiro" value="<?php echo htmlspecialchars($integracao_is_parceiro, ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="integracao_origem_id" value="<?php echo htmlspecialchars($integracao_origem_id, ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="integracao_order_id" value="<?php echo htmlspecialchars($integracao_order_id, ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="integracao_client_email" value="<?php echo htmlspecialchars($integracao_client_email, ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="pagto" value="<?php echo htmlspecialchars($FORMAS_PAGAMENTO['BOLETO_BANCARIO'], ENT_QUOTES, 'UTF-8'); ?>">
        <input type="hidden" name="btSubmit_EPP_8593" value="Continuar">
 </form>
    <script type="text/javascript">
        document.form1.submit();
...
ob_end_flush(); 
        ...
        if($ip_address == "187.18.198.236") echo "nao libera epp";
?>W
    <script type="text/javascript">
     $('#mostraLista').show();
    </script>
...
<?php
if($ip_address == "187.18.198.236") echo "final";
ob_end_flush();
