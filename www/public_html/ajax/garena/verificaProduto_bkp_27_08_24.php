<?php
	...
	$parametros = fopen('/www/log/parametros_GARENA.txt', 'a+');
	fwrite($parametros, "DATA: ".date("d-m-Y H:i:s")."\r");
	fwrite($parametros, "IP REQUISICAO: ".$_SERVER["REMOTE_ADDR"]."\r");
	//fwrite($parametros, "HOST ORIGEM: ".$_SERVER["REMOTE_HOST"]."\r");
	fwrite($parametros, "ORIGEM: ".$_SERVER["HTTP_REFERER"]."\r");
	fwrite($parametros, json_encode($_POST)."\r");
