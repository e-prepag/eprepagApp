        ...
        <div class="row txt-cinza">
            <div class="col-md-12 espacamento">
                <strong>Número do depósito: <span class="txt-verde"><?php echo $venda_id; ?></span><br>
                    Valor selecionado: <span class="txt-verde">R$
                        <?php echo number_format($_SESSION['dist_pagamento.total'], 2, ',', '.'); ?></span></strong>
            </div>
        </div>
    </div>
                    ...
                    <table border="0" cellspacing="0" bgcolor="#FFFFFF" width="100%">
                        <tr>
                            <td class="texto" align="center" height="25">
                                ...
                                Por favor tente um novo pedido de depósito ou então entre em contato com nosso suporte.
                            </td>
                        </tr>
                    </table>
            <?php
                                        ...
                                        <table border="0" cellspacing="0" width="90%">
                                            ...
                                            <tr>
                                                <td class="texto" height="25" align="center">
                                                    <table border="0" cellspacing="0" width="90%">
                                                        <tr>
                                                            <td class="texto" align="left" width="30%"><?php echo $simg_bank; ?>
                                                            </td>
                                                        ...
                                                        if (($pagto_tipo == $FORMAS_PAGAMENTO['TRANSFERENCIA_ENTRE_CONTAS_BRADESCO']) || ($pagto_tipo == $FORMAS_PAGAMENTO['PAGAMENTO_FACIL_BRADESCO_DEBITO']) || ($pagto_tipo == $FORMAS_PAGAMENTO['PAGAMENTO_FACIL_BRADESCO_CREDITO'])) {
                                                            ...
                                                            if (isset($msg_problem)) {
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <link href="/includes/bootstrap/css/bootstrap.min_new.css"
                                                            ...
                                                            ?>
                                                                    <form action="<?php echo $location; // "../debug.php" ?>" method="post"
                                                                        ...
                                                                        <input type="hidden" name="endereco"
                                                                            value="<?php echo $bbr_endereco; ?>">
                                                                        <input type="hidden" name="cidade"
                                                                            value="<?php echo $bbr_cidade; ?>">
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------
                                                    ...
                                                    <tr>
                                                        <td colspan="3" align="center" width="33%">&nbsp;</td>
                                                    </tr>
                                                    <tr bgcolor="ffffff">
                                                        <td align="center" colspan="3" class="texto">
                                                    <?php echo ($pagto_tipo == $PAGAMENTO_PIX_NUMERIC) ? "<b>ATENÇÃO: Não efetue o Pix fora do nosso site. Para cada pagamento será necessário gerar um novo pedido.</b>" : "Os seus dados serão fornecidos com toda segurança apenas ao seu banco."; ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </tr>
                                    ...
                                    <div id="pagamento_cancela" class="col-md-12 h-footer">
                                <?php // bloco pagamento cancelado inicio ?>
                                        <center>
                                            Seu pedido de depósito foi cancelado pelo sistema.<br>
                                            Por favor tente um novo pedido de depósito ou então entre em contato com nosso
                                            suporte.<br>
                                            <br>
                                            <!--//voltar-->
                                        </center>
