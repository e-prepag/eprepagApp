                                        ...
                                        if($pagto_tipo == $PAGAMENTO_PIX_NUMERIC){ 
												...
												*/
												...
												if(PAGAMENTO_PIX_CHAVEAMENTO == "a") {
												   if(number_format(($total_carrinho+$taxas),2,'.','') > 50.00){
										                require_once RAIZ_DO_PROJETO.'banco/pix/blupay/config.inc.pix.php'; 
														...
														require_once RAIZ_DO_PROJETO.'banco/pix/cielo/config.inc.pix.php'; 
														$pix = new Pix(
															"CNPJ", 
															str_replace('-', '', str_replace('.', '', $usuarioGames->ug_sCNPJ)),
															tirarAcentos($usuarioGames->ug_sRazaoSocial),
															$ARRAY_CONCATENA_ID_VENDA['pdv'].$_SESSION['pagamento.numorder'],
