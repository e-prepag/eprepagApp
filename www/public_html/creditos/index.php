...
$sql = 'select ug_ativo from dist_usuarios_games where ug_id = $1';
$rs_vip = SQLexecuteQueryParams($sql, array($filtro['id_user']));
        ...
        ?>
            ...
            <div class="row align-left">
                ...
                <a target="_blank" href="<?php // echo $feeds[$i]->link;
                                            ?>">
                    <img alt="<?php // echo $feeds[$i]->title; 
                                ?>" width="100%" src="<?php // echo $feeds[$i]->src[0]; 
                                                                                        ?>">
                    <h4><strong><?php // echo $feeds[$i]->title; 
                                ?></strong></h4>
                </a>
            </div>-->
    ...
    $(document).ready(function() {
        ...
        $("#rolagem-produtos-direita").click(function() {
            ...
            var data = {
                ...
                ate: ate,
                categoria: "Lan House",
                id: <?php echo $controller->usuarios->getId(); ?>
            };
            $.ajax({
                type: "POST",
                data: data,
