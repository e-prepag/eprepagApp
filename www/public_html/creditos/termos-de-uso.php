...
//require_once "game/includes/header.php";
?>
<div class="container txt-azul-claro bg-branco p-bottom40">
    <div class="col-md-12 col-lg-12 hidden-xs hidden-sm txt-azul-claro top10">
        <span class="glyphicon glyphicon-triangle-right graphycon-big pull-left" aria-hidden="true"></span><strong class="pull-left"><h4 class="top20">Termos de Uso - Ponto de Venda</h4></strong>
    </div>
    <div class="hidden-lg hidden-md col-xs-2 col-sm-2 txt-azul-claro top10">
        <span class="glyphicon glyphicon-triangle-right graphycon-big pull-left" aria-hidden="true"></span>
    </div>
    <div class="hidden-lg hidden-md col-xs-10 col-sm-10 txt-azul-claro top10">
        <strong class="pull-left"><h4 class="top20">Termos de Uso - Ponto de Venda</h4></strong>
    </div>
    <div class="col-md-12 top50 txt-cinza">
        <div class="field-item even" property="content:encoded"><div>
            <div>
                            <strong>CONTRATO DE ADESÃO</strong></div>
            <div>
                            &nbsp;</div>
            <div>
                            <strong>SERVIÇO DE &nbsp; DISPONIBILIZAÇÃODE &nbsp;CRÉDITOS DIGITAIS E CARTÕES PRÉ-PAGOS</strong></div>
            <div>
                            &nbsp;</div>
            <div>
			...
			<div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA PRIMEIRA - DO OBJETO</strong></div>
            <div>
                            &nbsp;</div>
			<div>
            ...
            <div>
                            &nbsp;</div>
			<div>
			                1.1.1 Considera-se credenciado todo Ponto de Vendas que tem sua Ficha de Cadastro aprovada e ativada, utiliza o PAC para efetuar o pagamento do saldo inicial, ou realiza pelo menos um pedido de Créditos à E-Prepag através do PAC. Os critérios mínimos estabelecidos para aprovação de Ficha de Cadastro estão disponíveis em <a href="https://e-prepagpdv.com.br/">https://e-prepagpdv.com.br/</a>. &nbsp;
			</div>
            <div>
                            &nbsp;</div>
			<div>
							1.1.2 A E-Prepag se reserva o direito de não aprovar relacionamento com Ponto de Vendas que atue exclusivamente no setor de criptomoedas. &nbsp;</li>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA SEGUNDA - DOS SERVIÇOS</strong></div>
            <div>
                            &nbsp;</div>
            <div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA TERCEIRA - DA OPERAÇÃO&nbsp;</strong></div>
            <div>
                            &nbsp;</div>
            <div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA QUARTA - DA FORMA DE RECEBIMENTO DO VALOR DAS TRANSAÇÕES</strong></div>
            <div>
                            &nbsp;</div>
            <div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA QUINTA - DA COMISSÃO E MODALIDADE DE OPERAÇÃO</strong></div>
            <div>
                            &nbsp;</div>
            <div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            5.4 Para a realização de vendas o Ponto de Vendas necessita manter saldo positivo. </div>
            <div>
                            &nbsp;</div>
            <div>
                            5.5 O Ponto de Vendas poderá consultar o seu saldo e acompanhar as suas vendas através de informações contidas na PAC, que poderá ser consultado a qualquer instante.</div>
            <div>
                            &nbsp;</div>
			<div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA SEXTA - DAS OBRIGAÇÕES DAS PARTES</strong></div>
            <div>
                            &nbsp;</div>
            <div>
                            6.1 Além daquelas implícitas e explicitamente citadas neste Contrato, são obrigações do Ponto de venda:</div>
            <div>
                            &nbsp;</div>
            <div>
                            6.1.1 Quitar as vendas realizadas com o limite eventualmente concedido pela E-prepag, e modificado a critério da mesma, nos prazos e condições estabelecidas pela PAC.</div>
            <div>
                            &nbsp;</div>
            <div>
                            6.1.2 Comunicar, imediatamente, a E-Prepag no caso de surgimento de defeitos ou falhas na operação da PAC.</div>
            <div>
                            &nbsp;</div>
            <div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            6.1.6 O Ponto de Vendas é o único responsável pelas operações realizadas através da PAC, devendo zelar pelo seu correto uso tanto por parte dos seus funcionários e colaboradores quanto por qualquer outra pessoa autorizada a utilizá-lo.</div>
            <div>
                            &nbsp;</div>
			<div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            6.2 Além daquelas implícitas e explicitamente citadas neste Contrato, são obrigações da E-Prepag:</div>
            <div>
                            &nbsp;</div>
            <div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA SÉTIMA - DA VIGÊNCIA</strong></div>
            <div>
                            &nbsp;</div>
            <div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA OITAVA - DA RECISÃO</strong></div>
            <div>
                            &nbsp;</div>
            <div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            8.2.1 Não pagamento de qualquer quantia devida pelo Ponto de Vendas à E-Prepag, após respectivo vencimento, podendo a E-prepag neste caso, cobrar encargos financeiros tais como multas, juros, custos de cobrança e outros, sem prejuízo de outras penalidades previstas em lei.&nbsp;</div>
            <div>
                            &nbsp;</div>
            <div>
                            8.2.2 Violação, pelo Ponto de Vendas, de quaisquer normas e/ou regras aplicáveis ao serviço objeto deste Contrato;</div>
            <div>
                            &nbsp;</div>
            <div>
                            8.2.3 Uso inadequado dos serviços e recursos colocados à disposição do Ponto de Vendas, incluindo, mas não se limitando a PAC;</div>
            <div>
                            &nbsp;</div>
            <div>
                            8.2.4 Descumprimento, pelas partes, de quaisquer das cláusulas e/ou condições do presente Contrato;</div>
            <div>
                            &nbsp;</div>
			<div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA NONA - NÃO CONCORRÊNCIA&nbsp;</strong></div>
            <div>
                            &nbsp;</div>
            <div>
			...
			<div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA DÉCIMA - DAS DISPOSIÇÕES COMPLEMENTARES</strong></div>
            <div>
                            &nbsp;</div>
            <div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            10.9 O Ponto de Vendas não poderá, em hipótese nenhuma, ceder ou transferir, total ou parcialmente, os direitos e obrigações decorrentes do contrato, bem como qualquer das obrigações constituídas neste instrumento, sem o prévio e expresso consentimento da E-Prepag.</div>
            <div>
                            &nbsp;</div>
            <div>
                            10.10 O presente Contrato substitui e revoga todos os entendimentos verbais ou escritos havidos anteriormente entre as partes.</div>
            <div>
                            &nbsp;</div>
            <div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA DÉCIMA PRIMEIRA - DA EMISSÃO DE DOCUMENTO FISCAL HÁBIL</strong></div>
            <div>
                            &nbsp;</div>
            <div>
                            11.1. O Ponto de Vendas compromete-se a emitir documento fiscal hábil relativo à comissão que lhe for paga contra à E-Prepag.</div>
            <div>
                            &nbsp;</div>
            <div>
                            11.2. Para fins específicos de emissão de documento fiscal hábil relativo às comissões pagas de acordo com o presente Contrato, o Ponto de Vendas nomeia como sua procuradora a E-Prepag, que poderá emitir recibos em seu nome para a comprovação do pagamento das comissões.</div>
            <div>
                            &nbsp;</div>
            <div>
                            11.3. Em que pese a cláusula mandato prevista acima, o Ponto de Vendas ficará integralmente responsável por quaisquer tributos e taxas, bem como pelo correto cumprimento de obrigações acessórias, decorrentes dos pagamentos que lhe forem efetuados, devendo ressarcir a E-Prepag caso quaisquer sanções lhe sejam indevidamente impostas.&nbsp;</div>
            <div>
                            &nbsp;</div>
            <div>
                            <strong>CLÁUSULA DÉCIMA SEGUNDA - DA AUTORIZAÇÃO PARA OPERAÇÕES DE CÂMBIO</strong></div>
            <div>
                            &nbsp;</div>
            <div>
                            12.1. O Ponto de Vendas autoriza a E-prepag ou empresa de seu grupo econômico, de acordo com o previso na Circular 3691 de 16 de dezembro de 2013, a realizar operações de câmbio em seu nome relacionadas às operações realizadas em seu Ponto de Vendas, quando não houver identificação do Usuário.&nbsp;</div>
            <div>
                            &nbsp;</div>
			<div>
                            <strong>CLÁUSULA DÉCIMA TERCEIRA – DOS DADOS</strong></div>
            <div>
                            &nbsp;</div>
			<div>
			...
			<div>
			    <ol style="list-style-type:lower-alpha">
				  <li>empresas do grupo econômico da E-prepag;</li>
				  <li>parceiros prestadoras de serviços e fornecedores, localizadas no Brasil ou no exterior;</li>
				  <li>órgãos reguladores e entidades públicas, inclusive administrativas e judiciais;</li>
            ...
            <div>
                            &nbsp;</div>
            <div>
			                13.4 Caso o titular dos dados deseje revogar o consentimento para o tratamento de dados, deverá ser feito para o e-mail <a href="mailto:suporte@e-prepag.com.br">suporte@e-prepag.com.br</a> e os acessos para utilização da plataforma E-Prepag serão interrompidos em até 15 dias, contados a partir do recebimento da solicitação. 
			</div>
            <div>
                            &nbsp;</div>
			<div>
            ...
            <div>
                            &nbsp;</div>
			<div>
                            <strong>CLÁUSULA DÉCIMA QUARTA - DO FORO</strong></div>
            <div>
                            &nbsp;</div>
			<div>
            ...
            <div>
                            &nbsp;</div>
            <div>
                            São Paulo, 19 de novembro de 2021.</div>
            <div>
                            &nbsp;</div>
            <div>
                            E-PREPAG ADMINISTRADORA DE CARTÕES LTDA.</div>
            <div>
                            &nbsp;</div>
            </div>
            <p>&nbsp;</p>
