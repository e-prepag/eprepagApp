...
?>                
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-9 "><?php echo $controller->usuarios->getLogin(); ?></div>
                </div>
                <div class="row top5">
                    <div class="col-md-3 col-lg-3 col-sm-3 col-xs-3 text-right">E-mail: </div>
                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-9"><?php echo $controller->usuarios->getEmail(); ?></div>
                </div>
                <div class="row top5">
                ...
                <div class="row top5">
                    ...
                    <div class="col-md-3 col-lg-9 col-sm-9 col-xs-9"><?php echo $possuiAuth ? "Possui" : "Não possui" ?> <a class="txt-azul-claro <?php echo $possuiAuth ? "" : "d-none" ?>" href="/creditos/alterar_token_auth.php">alterar</a></div>
                </div>
                <div class="row top5">
