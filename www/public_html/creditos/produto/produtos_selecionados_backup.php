...
if(!isset($_SESSION['dist_usuarioGamesOperador_ser']) && isset($_SESSION['dist_usuarioGamesOperador_ser'])){
	...
	$usuario = $pdvInfo->ugo_id; //    ugo_ug_id
}
...
$urlDirect = ($usuario != 17371)? "/creditos/pagamento/": "/creditos/chave.php"; //$ipSeguro === true && 
...
?>
                                <input class="w30 iptQtd" mod="<?php echo $modelo['modelo']->getId(); ?>" qtde="<?php echo $modelo['qtd'];?>" type="text" maxlength="3" value="<?php echo $modelo['qtd'];?>">
...
?>
        ...
        ?>                                      
                                                <input class="w30 iptQtd" value="<?php echo $prod['qtd'];?>" maxlength="3" qtde="<?php echo $prod['qtd'];?>" mod="<?php echo $prod["modelo"]; ?>" codeProd="<?php echo $prod["codeProd"]; ?>" valor="<?php echo $prod["valor"];?>">
...
?>
                                    ...
                                    <input class="w30 form-control input-sm iptQtd" maxlength="3" mod="<?php echo $modelo['modelo']->getId(); ?>" qtde="<?php echo $modelo['qtd'];?>" type="text" value="<?php echo $modelo['qtd'];?>"> 
...
?>
                                                ...
                                                <input type="text" class="w30 form-control input-sm iptQtd" value="<?php echo $prod['qtd'];?>" maxlength="3" qtde="<?php echo $prod['qtd'];?>" mod="<?php echo $prod["modelo"]; ?>" codeProd="<?php echo $prod["codeProd"]; ?>" valor="<?php echo $prod["valor"];?>"> 
                                                <span class="input-group-btn" id="sizing-addon3">
    ...
    <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body alert alert-danger txt-vermelho">
                <p>Quantidade de produtos permitida é de 1 até <?php echo $LIMITE_QUANTIDADE_PINS; ?> unidades.</p>
            </div>
...
<script>
    var limite = <?php echo $LIMITE_QUANTIDADE_PINS; ?>;
