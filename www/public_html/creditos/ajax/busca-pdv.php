        ...
        <div class=" row box-verde-home-inf">
                <form id="form_lanHouses_filtros" name="form_lanHouses_filtros" method="post" action="busca-pdv.php">
                        ...
                        <div class="col-md-12 txt-cinza top5">
                                ...
                                <a href="javascript:void(0);" onClick="procuraLan()"
                                        class="pull-left btn btn-success btn-sm left5">Buscar</a>
                        </div>
                </form>
        </div>
        <div class="row">
                <a href="http://blog.e-prepag.com/pdvs-online-oficiais-e-prepag/" target="_blank"
                        class="c-pointer botao-parceiros-online-home" style="z-index: 999; text-align: left !important;">
                        <div class="col-md-2">
                                <span class="glyphicon glyphicon-search"
                                        style="top: 5px !important; left: -5px !important; font-size: 30px;"
                        ...
                        script.onload = () => {
                                grecaptcha.ready(function () {
                                        grecaptcha.execute(site_key, { action: 'formulario' }).then(function (token) {
                                                if (!token) {
                                                        token = localStorage['_grecaptcha'];
                                                        if (!token) {
                                                                alert('Erro ao obter o token do reCAPTCHA. Por favor, tente novamente.');
                                                        }
                                                }
