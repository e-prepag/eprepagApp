...
<?php
	     ...
	     $sqlGarena = "select count(*) as tot from tb_dist_venda_games_modelo where (vgm_ogp_id = 355 or vgm_ogp_id = 374 or vgm_ogp_id = 493) and vgm_vg_id =" . $GLOBALS['_SESSION']['venda'];
