...
<?php
	     ...
	     $sqlGarena = "select count(*) as tot from tb_dist_venda_games_modelo where vgm_opr_codigo = 124 and vgm_vg_id =" . $GLOBALS['_SESSION']['venda'];
...
?>
				...
				<td class="d-none" id="td3id<?php echo $contador;?>"><?php echo $rs_row["vgm_opr_codigo"];?></td> <!-- G -->
                <td>
