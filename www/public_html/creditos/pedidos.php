    ...
    <div class="row">
        <div class="col-md-10">
            ...
            <div class="row txt-cinza espacamento">
                <form method="POST" id="listaPedido" action="/creditos/pedido/detalhe.php">
                    <?php
                            ...
                            <tbody>
                                ...
                                if (is_array($pedidos['vendas'])) {
                                    foreach ($pedidos['vendas'] as $ind => $pedido) {
                                        ...
                                        $sql = "SELECT ugo_nome FROM dist_usuarios_games_operador ugo INNER JOIN tb_dist_venda_games_operador vgo on ugo.ugo_id = vgo.ugo_id WHERE vgo.vg_id = $1";
                                        $ret_operador = SQLexecuteQueryParams($sql, array($pedido->getIdVenda()));
