...
if (!isset($controller->usuarios) || !($controller->usuarios instanceof UsuarioGames)) {
    ...
    die("Erro no sistema: O carregamento do usuário falhou.");
}

$valor_minimo_0 = $GLOBALS['RISCO_LANS_PRE_VALOR_MIN'];

if ($controller->usuarios->b_IsLogin_pagamento_minimo_1_real() || $controller->usuarios->getId() == 17371) {
    $valor_minimo_0 = 1;
}

$nivel_usuario = $controller->usuarios->getNivelPagamento();

switch ($nivel_usuario) {
    case 5:
        $valor_maximo_0 = $GLOBALS['RISCO_LANS_PRE_PLATINUM_VALOR_MAX'];
        break;
    case 4:
        $valor_maximo_0 = $GLOBALS['RISCO_LANS_PRE_GOLD_VALOR_MAX'];
        break;
    case 3:
        $valor_maximo_0 = $GLOBALS['RISCO_LANS_PRE_BLACK_VALOR_MAX'];
        break;
    case 2:
        $valor_maximo_0 = $GLOBALS['RISCO_LANS_PRE_MASTER_VALOR_MAX'];
        break;
    case 1:
        $valor_maximo_0 = $GLOBALS['RISCO_LANS_PRE_VIP_VALOR_MAX'];
        break;
    case 0:
    default:
        $valor_maximo_0 = $GLOBALS['RISCO_LANS_PRE_VALOR_MAX'];
        break;
}
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body txt-verde">
                <p class="txt-cinza">O limite mínimo para adição de saldo é R$ <?php echo number_format($valor_minimo_0, 2, ',', '.'); ?>.</p>
            </div>
