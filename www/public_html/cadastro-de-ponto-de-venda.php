...
<noscript>
    <img height="1" width="1" src="https://www.facebook.com/tr?id=564270170805767&ev=PageView
&noscript=1" />
</noscript>
...
<div class="container p0 bg-branco p-bottom40 txt-cinza box-principal">
    <div style="background-color: #276e8d;" class="col-lg-9 col-md-9 col-sm-12 col-xs-12 lista_preenchimento">
        ...
        <p class="new-texto">
            O PDV E-Prepag tem acesso aos produtos mais exclusivos do mercado digital. Venda na sua loja os créditos dos
            games e plataforma digitais mais populares e aumente a renda do seu negócio,
        ...
        <ul class="top10 new-lista" style="list-style-type: disc;padding-left: 70px;color: white;">
            ...
            <li>Games como League of Legends*, Valorant*, Point Blank*, Garena Free Fire e CrossFire<br> *Produtos
                sujeitos a análise.</li>
        ...
        <form id="profileForm" method="post" class="form-horizontal top20">
            ...
            <section data-step="0" style="padding: 15px 15px !important;">
                ...
                <div class="form-group">
                    <label class="col-lg-4 col-md-4 col-sm-12 col-xs-12 control-label left10" for="name">Nome:<span
                ...
                <div class="form-group">
                    <label class="col-lg-4 col-md-4 col-sm-12 col-xs-12 control-label left10" for="username">Login<span
                            class="required txt-vermelho">*</span></label>
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 right10">
                        <input type="text" class="form-control" name="username" maxlength="100" id="username"
                            autocomplete="off" />
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-lg-4 col-md-4 col-sm-12 col-xs-12 control-label" for="telefone_contato">WhatsApp
                        <span class="required txt-vermelho">*</span></label>
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 p-left15i">
                        <div class="input-group">
                            ...
                            <input type="text" name="telefone_contato" id="telefone_contato"
                                class="form-control telefone p-right0i" placeholder="(99) 99999-9999" maxlength="15"
                                size="15" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-lg-4 col-md-4 col-sm-12 col-xs-12 control-label" for="email">E-mail<span
                            class="required txt-vermelho">*</span></label>
                ...
                <div class="form-group">
                    <label class="col-lg-4 col-md-4 col-sm-12 col-xs-12 control-label"
                        for="email_confirmacao">Confirmação de E-mail<span
                            class="required txt-vermelho">*</span></label>

                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <input type="text" class="form-control" maxlength="100" name="email_confirmacao"
                            id="email_confirmacao" autocomplete="off" onpaste="return false" />
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-lg-4 col-md-4 col-sm-12 col-xs-12 control-label" for="password">Senha <span
                            class="required txt-vermelho">*</span></label>
                ...
                <div class="form-group">
                    <label class="col-lg-4 col-md-4 col-sm-12 col-xs-12 control-label"
                        for="password_confirmacao">Confirmação de senha<span
                            class="required txt-vermelho">*</span></label>
                ...
                <div class="form-group">
                    <label class="col-lg-4 col-md-4 col-sm-12 col-xs-12 control-label" for="cnpj">CNPJ <span
                            class="required txt-vermelho">*</span></label>
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <input type="text" id="cnpj" name="cnpj_empresa" size="20" class="form-control cnpj"
                            required /><br />
                    </div>
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 col-md-offset-4 col-lg-offset-4">
                        <span class="form_obs">
                ...
                <div class="form-group">
                    <label class="col-lg-4 col-md-4 col-sm-12 col-xs-12 control-label" for="como_conheceu_eprepag">Como
                        conheceu a E-Prepag? <span class="required txt-vermelho">*</span></label>
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        ...
                        <div id="campo_outro" style="display: none;">
                            <input type="text" id="campo_outro_input" name="campo_outro_input" class="form-control"
                ...
                <div style="display: block; padding: 15px 15px; margin-top: 10px">
                    ...
                    <div class="titulo_cinza form-group" style="font-size: 17px">
                        ...
                        <span class="texto_cinza">
                            ...
                            <label for="termos" style="font-size: 14px">Eu concordo com os Termos de Uso do sistema
                                E-Prepag</label>
                        </span>
                    </div>
                </div>
            ...
            <div class="hidden ajax-load"
                style="position: absolute; left: 50%; bottom: 5px; transform: translate(-50%, 0px);">
        ...
        <section class="confirmacao hidden" id="confirmation">
            <div class="titulo">
                <div class="col-md-3">
                    <img src="<?php echo IMG_LAN_URL; ?>confirmation.png" title="confirmação" alt="confirmação"
                        style="width: 125px;margin-top: 5px;">
                </div>
    ...
    <div class="col-md-3 col-xs-12 col-sm-12 col-lg-3 txt-cinza bottom20">
        ...
        <p class="top10">Após ser aprovado como parceiro, você efetuará login com o seu CNPJ e senha cadastrada e já
            estará habilitado para iniciar as vendas de forma simples,
            fácil e rápida e 100% Online.<br> Além disso disponibilizamos nossa API de Integração onde você pode
            automatizar as vendas do seu site.</p>

        <p class="txt-azul-claro top10"><strong>Validação cadastral:</strong></p>
        <ul class="top10" style="list-style-type: disc;padding-left: 20px;">
            <li>Após o preenchimento do cadastro você receberá via e-mail e WhatsApp o link para realizar o nosso
                onboarding, nesse será necessário enviar o seu Documento oficial com foto;</li>
            <li>selfie para validarmos sua identidade;</li>
            <li>comprovante de endereço de no máximo 90 dias (conforme registrado na Receita Federal) e a identificação
                da loja
