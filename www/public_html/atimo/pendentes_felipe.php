...
//	trace_sql($sql, "Arial", 2, "#666666", 'b');			
  ...
  if(isset($_POST['BtnExport'])) {
    ...
    echo "<Cell></Cell>\n";
    echo "<Cell></Cell>\n";
    echo "<Cell><Data ss:Type=\"Number\">".str_replace(",", ".", $bol_valor_total_i)."</Data></Cell>\n";
    echo "<Cell></Cell>\n";
    echo "</Row>\n";
...
<?php  //                <option value="1" <_? if($dd_tipodoc == 1) echo "selected" ?_>>Corte (1)</option> ?>
          ...
          <tr bgcolor="#F5F5FB"> 
            <td width="0" height="0"><font color="#666666" size="2" face="Arial, Helvetica, sans-serif">Usuï¿½rio:</font></td>
            <td width="0" height="0"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"> 
				<select name="dd_usuario" id="dd_usuario" class="combo_normal">
					<option value="0">Escolha o usuï¿½rio</option>
                      <?php  
            ...
            <td width="0" height="0"><div align="center"><font color="#666666" size="2" face="Arial, Helvetica, sans-serif"> 
                ...
                <input type="submit" name="BtnExport" value="Exportar Excel" class="btn btn-sm btn-success">
