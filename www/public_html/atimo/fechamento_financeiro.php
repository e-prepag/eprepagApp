...
FROM (
    (SELECT 
     ...
     AND (pih_data BETWEEN '2025-02-01 00:00:00' AND '2025-02-28 23:59:59')
    ...
    (SELECT 
     ...
     AND (CASE WHEN t1.opr_contabiliza_utilizacao <> 0 THEN vg_data_inclusao >= t1.opr_data_inicio_contabilizacao_utilizacao ELSE TRUE END) 
     AND (vg_data_concilia BETWEEN '2025-02-01 00:00:00' AND '2025-02-28 23:59:59'))
    ...
    (SELECT 
     ...
     AND (pgc_pin_response_date BETWEEN '2025-02-01 00:00:00' AND '2025-02-28 23:59:59'))
