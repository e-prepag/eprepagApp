...
//echo "sqlEsgotados: $sql<br>";
    ...
    if(!empty($estoqueBaixo))
    {
		...
		if(function_exists('check_ip')) {
			if(!checkIP()) //producao
        {
            $to = "daniela@e-prepag.com.br";
			$cc = "suporte@e-prepag.com.br,maysa.tonon@e-prepag.com.br,glaucia@e-prepag.com.br";
            $subject = "[PRODUÇÃO] - ESTOQUE BAIXO";
			}else{
				$to = "estagiario1@e-prepag.com, daniela.oliveira@e-prepag.com.br, tamy@e-prepag.com.br";
				$subject = "[DEV - HOMOLOGAÇÃO] - ".$_SERVER['SERVER_NAME']." - ESTOQUE BAIXO";
				$cc = "";
			}
		} 
		else {	        
			$to = "daniela@e-prepag.com.br, lucas.alexandre@gokeitecnologia.com.br";
			$cc = "suporte@e-prepag.com.br,maysa.tonon@e-prepag.com.br,glaucia@e-prepag.com.br";
			$subject = "[PRODUÇÃO] - ESTOQUE BAIXO";
		}	
