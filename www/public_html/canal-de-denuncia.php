...
<script>
    $(function() {
        ...
        $('#motivo').change(function() {
            atualizaDescricaoMotivo();
        });

        atualizaDescricaoMotivo();
    });

    function atualizaDescricaoMotivo() {
        var descricao = $('#motivo option:selected').data('descricao') || '';
        $('#motivo-descricao').text(descricao);
    }
...
<div class="container txt-azul-claro bg-branco p-bottom40">
    <div class="col-md-12 txt-azul-claro top10">
        <span class="glyphicon glyphicon-triangle-right graphycon-big pull-left" aria-hidden="true"></span><strong class="pull-left">
            <h4 class="top20">Canal de Denúncias</h4>
        </strong>
    </div>
    <?php
    ...
    ?>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 top20 txt-cinza">
            <form name="denuncia" id="denuncia" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'); ?>" method="post">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-11 col-xs-11 selectContainer">
                            <select name="motivo" id="motivo" class="form-control select_input" required>
                                ...
                                <option value="1" data-descricao="Relatos de comportamento abusivo, ofensivo, discriminatório ou desrespeitoso, cyberbulling." title="Relatos de comportamento abusivo, ofensivo, discriminatório ou desrespeitoso, cyberbulling."> Assédio, discriminação e conduta inadequada </option>
                                <option value="2" data-descricao="Relatos de descumprimento de normas, controles, aprovações, processos ou confidencialidade." title="Relatos de descumprimento de normas, controles, aprovações, processos ou confidencialidade."> Violação de políticas e procedimentos internos </option>
                                <option value="3" data-descricao="Relatos de fraude, desvio, falsificação, manipulação ou vantagem indevida." title="Relatos de fraude, desvio, falsificação, manipulação ou vantagem indevida."> Fraude, má-fé e atos ilícitos </option>
                                <option value="4" data-descricao="Relatos de favorecimento indevido, manipulação de informações ou condutas contrárias aos valores da empresa." title="Relatos de favorecimento indevido, manipulação de informações ou condutas contrárias aos valores da empresa."> Ética e integridade </option>
                                <option value="5" data-descricao="Relatos de condutas que possam violar leis, normas regulatórias ou obrigações de compliance." title="Relatos de condutas que possam violar leis, normas regulatórias ou obrigações de compliance."> Conformidade regulatória e legal </option>
                                <option value="7" data-descricao="Relatos de vazamento de dados, acesso indevido, uso irregular de credenciais ou incidentes de segurança." title="Relatos de vazamento de dados, acesso indevido, uso irregular de credenciais ou incidentes de segurança."> Segurança da informação e proteção de dados </option>
                                <option value="8" data-descricao="Relatos de adolescentes, pais ou responsáveis sobre segurança, privacidade, atendimento ou uso inadequado da plataforma." title="Relatos de adolescentes, pais ou responsáveis sobre segurança, privacidade, atendimento ou uso inadequado da plataforma."> Proteção de adolescentes e Suporte a Pais </option>
                                <option value="6" data-descricao="Situações que não se enquadrem nas categorias acima." title="Situações que não se enquadrem nas categorias acima."> Outros </option>
                            </select>
                            <small id="motivo-descricao" class="help-block txt-cinza" style="margin-top: 8px;"></small>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12 text-center canal-denuncia-banners">
                    <img src="/imagens/banner-canal-denuncia-1.png" alt="" class="img-responsive center-block" style="margin-bottom: 16px;">
                    <img src="/imagens/banner-canal-denuncia-2.png" alt="" class="img-responsive center-block" style="margin-bottom: 16px;">
                    <img src="/imagens/banner-canal-denuncia-3.png" alt="" class="img-responsive center-block">
                </div>
                </div>
            </form>
