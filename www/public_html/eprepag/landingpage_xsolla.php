...
<link href="/eprepag/incs/landingpage.css" rel="stylesheet" type="text/css" />
<body>
<div class="principal">
    <div class="faixa">
    </div>
    ...
    <div class="dadosparceiro">
        <img src="/imagens/logo_xsolla_mapa_landingpage.gif" class="goodgames"/>
    ...
    <center>
    <div>
        <iframe src="/eprepag/moedavirtual/lan_houses_cartao.php" width="790" style="margin:0 auto; overflow: hidden;" height="730" frameborder="0" scrolling="no">
        </iframe>
    </div>
    </center>
    <div class="seja">
