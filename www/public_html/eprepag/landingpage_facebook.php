...
<div class="principal">
    ...
    <div class="dadosparceiro">
        <img src="https://<?php echo $server_url; ?>/imagens/logo_facebook.jpg" class="goodgames" width="150"/>
    ...
    <center>
    <div>
        <iframe src="https://<?php echo $server_url; ?>/eprepag/moedavirtual/lan_houses.php" width="790" style="margin:0 auto; overflow: hidden;" height="730" frameborder="0" scrolling="no">
        </iframe>
    </div>
    </center>
    <div class="seja">
