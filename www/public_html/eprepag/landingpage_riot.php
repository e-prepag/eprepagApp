...
<div class="principal">
    ...
    <div class="links">
            <a href="<?= EPREPAG_URL_HTTPS_COM ?>/" target="_blank" class="corlink">E-Prepag</a> | <a href="<?= EPREPAG_URL_HTTPS_COM ?>/support" target="_blank" class="corlink">Suporte</a> | <a href="https://e-prepagpdv.com.br/" target="_blank" class="corlink">Seja um ponto autorizado</a>
    </div>
