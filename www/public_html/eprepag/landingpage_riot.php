...
<div class="principal">
    ...
    <div class="links">
            <a href="https://www.e-prepag.com/" target="_blank" class="corlink">E-Prepag</a> | <a href="https://www.e-prepag.com/support" target="_blank" class="corlink">Suporte</a> | <a href="https://e-prepagpdv.com.br/" target="_blank" class="corlink">Seja um ponto autorizado</a>
    </div>
    <div class="dadosparceiro">
        <img src="http<?php echo (($_SERVER['HTTPS']=="on")?"s":""); ?>://<?php echo $server_url; ?>/imagens/logo_riot.png" class="goodgames" width="150"/>
    ...
    <center>
    <div>
        <iframe src="http<?php echo (($_SERVER['HTTPS']=="on")?"s":""); ?>://<?php echo $server_url; ?>/eprepag/moedavirtual/lan_houses_riot.php" width="785" style="margin:0 auto; overflow: hidden;" height="730" frameborder="0" scrolling="no">
        </iframe>
    </div>
    </center>
    <div class="seja">
