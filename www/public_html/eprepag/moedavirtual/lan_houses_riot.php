...
$pdo = $con->getLink();
$Cidade = isset($_POST['cidade']) ? filter_var(trim(str_replace("'", "",$_POST['cidade'])),FILTER_SANITIZE_STRING) : '';
...
if ((isset($_REQUEST['cidade'])) and ( isset($_REQUEST['bairro']))) {
    ...
    $stmt->bindParam(':opr_codigo', $opr_codigo, PDO::PARAM_INT);
    $stmt->execute();
...
<script type="text/javascript">
    ...
    function MostraLANs() {
        if ($("#cidade").val() != ""){
            ...
            if(verificationCode.length < <?php echo CHARSLEN; ?>){
                waitingDialog.hide();
                alert("Por favor, informe todos os caracteres do captcha.")
            }else{
...
<body>
<!-- inicio :: centro //-->
<div id="" style="background-color: #DEDEDE; background-image:url('imgs/bg_mapa_teemo.jpg'); height:700px">
	<!-- inicio :: conteudo principal //-->
	<div id="img_help" class="styledWGB">
		<table border="0" width="510px">
		<tr>
            <td class="font-10px" width="180"><nobr>&nbsp;</nobr></td>
            ...
            <td align="center" style='cursor:pointer;cursor:hand;'><img src="/imagens/icone_eppcard_riot.png" width="50" height="55" border="0" title="Cards League of Legends" alt="Cards League of Legends" onClick="$(function(){ showMessage('Cards League of Legends: Você encontra os cards do League of Legends em livrarias, lojas de games, supermercados, lojas de departamento, etc.'); });"></td>
		</tr>
		</table>
	</div>
			...
			<tr>
				<td class="font-10px">
					<div id="pontos_buscaWGB">
						<div id="ajuste">
                            <div class="txt-preto" id="SelEstado" name="SelEstado">
							 Estado:&nbsp;
							...
							<div class="txt-preto" id="SelCidade" name="SelCidade">
							 Cidade:&nbsp;
								<?php
                                    if ($ResultadoCidade){
							...
							<div class="espaco">&nbsp;</div>
							<div class="txt-preto" name="SelBairro" id="SelBairro">
							 Bairro:&nbsp;&nbsp;
								<?php
								if ($ResultadoBairro){
	...
	<tr>
        ...
        <table class="bgcolor-table" width="785px" border="0" cellpadding="0" cellspacing="0">
			<tr height="75px">
				...
				<td width="70%">
					<a id="bt_procurar" onClick="ValidaForm()" style="padding-top: 21px; position: absolute;"><img src="/imagens/botao-procurar.png" width="131" height="33" border="0" /></a>
                                        <span style="font-size: 12px; margin-left: 350px; position: absolute;"><a href="/cadastro-de-ponto-de-venda.php" target="_blank">Quero vender games e +</a></span>
