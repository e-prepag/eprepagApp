...
if(isset($_POST["email"]) && $_POST["email"] != ""){
    ...
    $subject = "PDV N�o Encontrado no Mapa";
    ...
    echo (enviaEmail($to, null, null, $subject, $body_html, null)) ? 
            ...
            . " <p>Vamos verificar a ocorr�ncia.</p>"
...
<script type="text/javascript">
    ...
    function validaForm() {
        ...
        if ( document.form_lanHouses_filtros.estado.value == "" ){
            ...
            $("#msg_validacao").append('<br><font color="#FF1F00"><b>O nome do ponto de venda n�o foi preenchido corretamente.</b></font>');
        
        }else if (document.form_lanHouses_filtros.email.value == "" || !validaEmail(document.form_lanHouses_filtros.email.value)){
            $("#msg_validacao").append('<br><font color="#FF1F00"><b>O e-mail n�o foi preenchido corretamente.</b></font>');
    ...
    function MostraCidade() {
            if ( document.form_lanHouses_filtros.estado.value != "" ){
                    ...
                    $.ajax({
                            type: "POST",
                            url: "lan_house_select_cidade_cartao.php",
                            data: "estado=" + estado,
                            beforeSend: function(){
    ...
    function MostraBairro() {
            if ( document.form_lanHouses_filtros.cidade.value != "" ){
                    ...
                    $.ajax({
                            type: "POST",
                            url: "lan_house_select_bairro_cartao.php",
...
<form id="form_lanHouses_filtros" name="form_lanHouses_filtros" style="width: 250px;" method="post">
    ...
    <p> 
        <select name="motivo" id="motivo">
            <option value="<?php echo "O Ponto de venda n�o existe"; ?>"><?php echo "O Ponto de venda n�o existe"; ?></option>
            <option value="<?php echo "O endere�o est� errado"; ?>"><?php echo "O endere�o est� errado"; ?></option>
            <option value="<?php echo "O Ponto de venda n�o tem saldo"; ?>"><?php echo "O Ponto de venda n�o tem saldo"; ?></option>
            <option value="<?php echo "N�o souberam como vender o cr�dito"; ?>"><?php echo "N�o souberam como vender o cr�dito"; ?></option>
