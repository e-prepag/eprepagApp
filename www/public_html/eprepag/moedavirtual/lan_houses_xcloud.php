...
<!--                        <td class="font-10px" width="30"><nobr>&nbsp;</nobr></td>
                        <td align="center" style='cursor:pointer;cursor:hand;'><img src="../imgs/icone_eppcard.png" width="50" height="55" border="0" title="Ponto de venda de Cartões" alt="Ponto de venda de Cartões" onClick="$(function(){ showMessage('Gift Cards: Você encontra os gift cards em livrarias, lojas de departamento, lojas de games, supermercados, e outras redes de varejo.'); });"><br><nobr class="font-10px">Gift Card</nobr></td>
                        <td class="font-10px" width="30"><nobr>&nbsp;</nobr></td>-->
                    </tr>
                </table>
                <div id="inline1" style="width:432px;display: none; text-align: justify;font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: small;">
                    <p>Tótens: São centenas de tótens eletrônicos de auto-serviço, onde você pode comprar o E-Prepag Cash diretamente da máquina, e também alguns estabelecimentos comerciais da rede credenciada. <a href='<?php echo $https; ?>://www.e-prepag.com/ativar' target='_blank'>Veja aqui como fazer a compra e ativar o PIN.</a></p>
                </div>
            </div>
