...
<!--                        <td class="font-10px" width="30"><nobr>&nbsp;</nobr></td>
                ...
                <div id="inline1" style="width:432px;display: none; text-align: justify;font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: small;">
                    <p>Tótens: São centenas de tótens eletrônicos de auto-serviço, onde você pode comprar o E-Prepag Cash diretamente da máquina, e também alguns estabelecimentos comerciais da rede credenciada. <a href='<?php echo $https; ?>://<?= EPREPAG_URL_COM ?>/ativar' target='_blank'>Veja aqui como fazer a compra e ativar o PIN.</a></p>
                </div>
            </div>
