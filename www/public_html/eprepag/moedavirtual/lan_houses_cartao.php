...
$_POST['cidade'] = isset($_POST['cidade']) ? filter_var(trim(str_replace("'", "",$_POST['cidade'])),FILTER_SANITIZE_STRING) : '';
...
if ((isset($_REQUEST['estado'])) and ( isset($_REQUEST['cidade']))) {
    ...
    $stmt->bindParam(':ug_estado', trim($_POST['estado']), PDO::PARAM_STR);
    $stmt->bindParam(':us_estado', trim($_POST['estado']), PDO::PARAM_STR);
    $stmt->bindParam(':idGoCash', $id_gocash, PDO::PARAM_INT);
    $stmt->execute();
...
// include com as funçoes do banner
        ...
        <script type="text/javascript">
            ...
            $(".fancybox").fancybox({
                href : '/eprepag/moedavirtual/iframe_problemas_lan_houses_cartao.php',
                type: 'iframe',
                width: 300,
                autoScale:false,
                scrolling : 'no'
