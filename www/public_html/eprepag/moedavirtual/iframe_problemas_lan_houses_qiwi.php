...
<script type="text/javascript">
    ...
    function MostraCidade() {
            if ( document.form_lanHouses_filtros.estado.value != "" ){
                    ...
                    $.ajax({
                            type: "POST",
                            url: "lan_house_select_cidade_qiwi.php",
                            data: "estado=" + estado,
                            beforeSend: function(){
    ...
    function MostraBairro() {
            if ( document.form_lanHouses_filtros.cidade.value != "" ){
                    ...
                    $.ajax({
                            type: "POST",
                            url: "lan_house_select_bairro_qiwi.php",
...
<form id="form_lanHouses_filtros" name="form_lanHouses_filtros" style="width: 250px;" method="post">
    ...
    <p> 
        <select name="motivo" id="motivo">
            <option value="O Ponto de venda n�o existe">O Ponto de venda n�o existe</option>
            <option value="O endere�o est� errado">O endere�o est� errado</option>
            <option value="O Ponto de venda n�o tem saldo">O Ponto de venda n�o tem saldo</option>
            <option value="N�o souberam como vender o cr�dito">N�o souberam como vender o cr�dito</option>
