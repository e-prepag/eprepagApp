            ...
            if ($("#cidade").val() != "") {
                ...
                $.ajax({
                    ...
                    success: function (txt) {
                        waitingDialog.hide();
                        $("#resultado").html(txt);
                        $("#resultado").css("background-image", "none");
                        monta_captcha();
                    },
                    error: function () {
                        waitingDialog.hide();
    ...
    <div id="" style="height:700px;">
        ...
        <div id="img_help" class="styledWGB">
            <table border="0">
                <tr>
                    ...
                    <td class="font-10px" width="200">
                        <nobr>&nbsp;</nobr>
                    </td>
                    <td align="center" style='cursor:pointer;cursor:hand;'><img src="/imagens/icone_eppLH.png"
                            width="50" height="55" border="0" title="PINs E-Prepag" alt="PINs E-Prepag"
                            onClick="$(function(){ showMessage('PINs E-Prepag: São milhares de Lan Houses, lojas de games, de informáticas e vários outros tipos de comércio em todo o Brasil.'); });">
                    </td>
                    ...
                    <td class="font-10px" width="30">
                        <nobr>&nbsp;</nobr>
                    </td>
                    <td align="center" style='cursor:pointer;cursor:hand;'><img src="/imagens/icone_cardsongame_i_.png"
                            width="50" height="55" border="0" title="Cards Ongame" alt="Cards Ongame"
                            onClick="$(function(){ showMessage('Você encontra os pins da Zepetto em diversos valores nos pontos de venda E-Prepag.'); });">
                    </td>
                </tr>
            </table>
        </div>
        <form name="form_lanHouses_filtros" id="form_lanHouses_filtros" action="<?php echo $_SERVER['PHP_SELF']; ?>"
            method="post">
                        ...
                        <table class="bgcolor-table" width="785px" border="0" cellpadding="0" cellspacing="0">
                            <tr height="75px">
                                <td align="center" width="15%" id="td_captcha">
                                    ...
                                    ?>
                                    <img src="/includes/captcha/CaptchaImage.php?uid=<?php echo $randomcode_translated; ?>"
                                        title="Verify Code" vspace="2" />
                                </td>
                                <td width="15%">
                                    <input name="verificationCode" type="text" id="verificationCode" size="5" /><br>
                                    <nobr><a class="estiloSpan font-10px" href="javascript:monta_captcha();">Gerar outro
                                            código</a></nobr>
                                </td>
                                <td width="70%">
                                    <a onClick="ValidaForm()" id="bt_procurar" href="#"
                                        style="padding-top: 21px; position: absolute;"><img
                                            src="<?php echo $server_url; ?>/imagens/botao-procurar.png" width="131"
                                            height="33" border="0" /></a>
                                    <span style="float: right;font-size: 10px;padding-top: 60px; margin-right: 10px;"><a
                                            class="fancybox" style="">Avise-nos</a> sobre problemas no Ponto de
                                        Venda.</span>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td>
                        <table class="bgcolor-table" width="785px" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <!-- inicio :: resultado //-->
                                    <div name="resultado" id="resultado" style="background-color: #DEDEDE; background-image:url('imgs/Onde_encontrar_PIN_Codes_final-png-em-alta.png'); height: 550px;" ></div>
                                    <!-- fim :: resultado //-->
                                </td>
                            </tr>
                        </table>
        ...
        <?php if ($withLogo) { ?>
            <div id="background_banner">
                <a href="http://br.leagueoflegends.com/pt/pagamentos#map" target="__blank"><img
                        src="/eprepag/moedavirtual/imgs/banner_lol_ekko.jpg" /></a>
                <a href="https://www.e-prepag.com/Cartao-Xbox-Live-Gold-na-Eprepag" target="__blank"><img
                        src="/eprepag/moedavirtual/imgs/banner_xbox_card.jpg" /></a>
                <a href="http://blog.e-prepag.com/seja-um-ponto-de-venda/" target="__blank"><img
                        src="/eprepag/moedavirtual/imgs/banner_faca_parte.jpg" /></a>
            </div>
