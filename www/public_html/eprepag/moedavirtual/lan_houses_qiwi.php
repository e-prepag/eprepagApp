...
// include com as funçoes do banner
        ...
        <script type="text/javascript">
            $(".fancybox").fancybox({
                href : 'iframe_problemas_lan_houses_qiwi.php',
                type: 'iframe',
                width: 300,
                autoScale:false,
                scrolling : 'no'
...
<!--                        <td class="font-10px" width="30"><nobr>&nbsp;</nobr></td>
                        ...
                        <td class="font-10px" width="30"><nobr>&nbsp;</nobr></td>
                        <td align="center" style='cursor:pointer;cursor:hand;'><a class="fancybox_link_target" href="#inline1" title=""><img src="/imagens/icone_qiwi.png" width="50" height="55" border="0" title="Rede Qiwi" alt="Rede Qiwi"></a></td>
                    </tr>
                </table>
...
<?php 
        if ($withLogo) { 
            ...
            require_once DIR_CLASS."business/BannerBO.class.php";
...
<?php 
            if($banner){
                foreach($banner as $b){
?>
                    <a href="<?php echo $b->link; ?>" class="banner" id="<?php echo $b->id; ?>" target="_blank"><img src="<?php echo $objBanner->urlLink.$b->imagem; ?>" title="<?php echo $b->titulo; ?>"></a>
<?php 
                }
?>
                <script>
