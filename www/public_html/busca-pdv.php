...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if(!empty($erros)){
    ...
    // Prosseguir com o restante do formul�rio...
}
...
?>
                ...
                <!-- <span class="col-md-5 top10">
                    <a class="estiloSpan font-10px" href="javascript:monta_captcha();">Gerar outro c�digo</a>
                </span> -->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="alert alert-info" role="alert"> 
                                  <h5><span id="msg-modal">Cards E-Prepag/Go Cash: Voc� encontra os gift cards em livrarias, lojas de departamento, lojas de games, supermercados, e outras redes de varejo.</span></h5>
                              </div>
                            </div>
                ...
                <div id="pimepp" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="alert alert-info" role="alert"> 
                                  <h5><span id="msg-modal">PINs E-Prepag: S�o milhares de Lan Houses, lojas de games, de inform�ticas e v�rios outros tipos de com�rcio em todo o Brasil.</span></h5>
                              </div>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                ...
                <div id="pinqiwi" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="alert alert-info" role="alert"> 
                                  <h5><span id="msg-modal">T�tens com PINs E-Prepag: S�o centenas de t�tens eletr�nicos de auto-servi�o, onde voc� pode comprar o E-Prepag Cash diretamente da m�quina, e tamb�m alguns estabelecimentos comerciais da rede credenciada.</span></h5>
                              </div>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
