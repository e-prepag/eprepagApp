...
// Se originalValue nï¿½o for nulo, faz a verificaï¿½ï¿½o
if (!is_null($originalValue)) {
	// Soma interestValue ao originalValue caso interestValue nï¿½o seja nulo
	$calculatedValue = $originalValue + $interestValue;

	// Comparaï¿½ï¿½o
	if (bccomp($calculatedValue, $value, 2) !== 0) {
		echo "Valores nï¿½o batem";
		exit;
	}
}
if (!$value) {
	echo "Nï¿½o foi possivel obter o valor do boleto";
	exit;
}
