    ...
    <div class="container espacamento top50">
        ...
        <div class="row top20 txt-cinza-claro2">
            <div class="col-md-3 col-sm-6">
                <p><a target="_blank" href="https:<?= SOLUCOES_URL ?>" class="txt-cinza-claro2  decoration-none">Soluções
                        em Pagamentos</a></p>
                <p><a target="_blank" class="txt-cinza-claro2 " href="<?= QUEMSOMOS_URL ?>">Quem somos</a></p>
                <p><a target="_blank" href="<?= CARTAO_URL ?>" class="txt-cinza-claro2  decoration-none">Cartão
                        E-Prepag</a></p>
                <p><a target="_blank" href="/canal-de-denuncia.php/" class="txt-cinza-claro2  decoration-none">Canal de
                        Denúncia</a></p>
            </div>
            <div class="col-md-3 col-sm-6">
                ...
                <p><a href="/creditos/termos-de-uso.php" class="txt-cinza-claro2 decoration-none" target="_blank">Termos
                        de uso - PDV</a></p>
                <p><a target="_blank" href="<?= COMPRASEG_URL ?>" class="txt-cinza-claro2  decoration-none">Compra
                        segura</a></p>
