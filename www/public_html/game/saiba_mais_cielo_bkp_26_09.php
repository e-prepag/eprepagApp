...
<br>
A E-Prepag está aumentando os clientes atendidos por Cartão de Crédito e você, cliente especial E-Prepag, agora poderá fazer suas compras desta forma. Você pode efetuar 2 compras no valor de até R$ <?php echo $_GET['valor']; ?>,00 cada, por semana (em um intervalo de 7 dias).<br><br>
