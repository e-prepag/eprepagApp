...
if(isset($_POST['envio']) && $_POST['envio'] == 1){
    ...
    if(isset($_POST['cpf']) && isset($_POST['dataNascimento'])){
        $controller->usuario->setCpf($_POST['cpf']);
        $controller->usuario->setDataNascimento($_POST['dataNascimento']);
        $controller->usuario->setNomeCPF(fix_name($_POST['nome_cpf']));
    }
