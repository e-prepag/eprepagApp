<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'GET') {
		...
		if ($_GET['redirected'] === 'true' && $_GET['origemUsuario'] === 'gamer') {
				...
				<div class="top20 p-bottom40">
					<form id="form" method="post" action="registra-solicitacao.php">		
						...
						<div class="row form-group">
							...
							<input type="hidden" name="redirected" id="redirected" value="<?php echo $_GET['redirected']; ?>">
							<input type="hidden" name="origemUsuario" id="origemUsuario" value="<?php echo $_GET['origemUsuario']; ?>">
