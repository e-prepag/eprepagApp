            ...
            <div class="row txt-cinza">
                <div class="col-md-12 top20">
					...
					<?php
					     ...
					     $sqlGarena = "select count(*) as tot from tb_venda_games_modelo where (vgm_ogp_id = 454 or vgm_ogp_id = 433) and vgm_vg_id =" . $venda_id;
                        ...
                        foreach($rs_venda_modelos as $ind => $rs_venda_modelos_row){
                            ...
                            if(count($vgm_pin_codinternoAr) > 0){
                                ...
                                for($i=0; $i < count($vgm_pin_codinternoAr); $i++){
									...
									if($rs_venda_modelos_row["vgm_ogp_id"] == 454 || $rs_venda_modelos_row["vgm_ogp_id"] == 433){
										$garena = true;
									}
