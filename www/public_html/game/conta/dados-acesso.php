                        ...
                        <form role="form" id="formSenha" name="formSenha" method="POST">
                            <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <input type="password" class="form-control novaSenha" onpaste="return false;" autocomplete="new-password" maxlength="12" char="6" id="novaSenha" name="novaSenha" placeholder="Nova senha">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="confirmaSenha">Confirme a nova senha:</label>
                                    <input type="password" class="form-control confirmacaoSenha" onpaste="return false;" autocomplete="new-password" maxlength="12" id="confirmaSenha" char="6" name="confirmaSenha" placeholder="Confirme sua nova senha">
                    ...
                    <div class="modal-body espacamento">
                        <form role="form" id="formEmail" name="formEmail" method="POST">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="novoEmail" name="novoEmail" onpaste="return false;" autocomplete="new-password" placeholder="Novo e-mail">
                            </div>
                            <div class="form-group">
                                <label for="confirmaEmail">Confirme o novo e-mail:</label>
                                <input type="text" class="form-control" id="confirmaEmail" name="confirmaEmail" onpaste="return false;" autocomplete="new-password" placeholder="Confirme seu novo e-mail">
                            </div>
                    ...
                    <div class="modal-body espacamento">
                        <form role="form" id="formLogin" name="formLogin" method="POST">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="novoLogin" autocomplete="new-password" onpaste="return false;" name="novoLogin" placeholder="Novo login">
                            </div>
                            <div class="form-group">
                                <label for="confirmaLogin">Confirme o novo login:</label>
                                <input type="text" class="form-control" id="confirmaLogin" autocomplete="new-password" onpaste="return false;" name="confirmaLogin" placeholder="Confirme seu novo login">
                            </div>
                            <div class="form-group">
                                <label for="l-senha">Senha:</label>
                                <input type="password" class="form-control" id="l-senha" name="l-senha" autocomplete="new-password" placeholder="Digite sua senha">
                            </div>
