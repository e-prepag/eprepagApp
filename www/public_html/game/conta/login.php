        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 borda-colunas-formas-pagamento box-servico text-right">
            ...
            <form id="formLogin" class="top20" method="post">
                <div class="row top10 form-group">
                    ...
                    <div class="col-md-6">
                        <input class="form-control" id="login" onpaste="return false;" name="login" autocomplete="off" type="text" value="">
                    </div>
                </div>
                <div class="row top10  form-group">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-10 top10 fontsize-p">
						...
						<a class="decoration-none txt-cinza" href="https://www.e-prepag.com.br/game/conta/esqueci-minha-senha/index.php?redirected=true&origemUsuario=gamer"><em>Esqueci minha senha</em></a>
		
                    </div>
                    <!-- Modal -->
                    <div id="modal-esqueci-senha" class="modal fade text-left" role="dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group top10">
                                        ...
                                        <input type="text" class="form-control" id="emailEsqueciSenha" autocomplete="new-password" value="" name="emailEsqueciSenha" placeholder="Digite seu e-mail de cadastro">
					...
					<div id="myModal2FA" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content text-left">
                                ...
                                <div class="modal-body">
                                  <div class="alert"> 
                                      <h5><span>Foi enviada uma mensagem em seu endereço de e-mail para confirmar sua identidade.</span></h5> 
                                  </div>
                                </div>
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                ...
                <div class="row top10 form-group">
                    <div class="col-md-5  dislineblock">
                        <a href="/game/conta/nova.php" class="btn btn-info btn-block"><strong>Não tem cadastro?</strong></a>
                    </div>
                    <div class="col-md-5 dislineblock">
        ...
        <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 align-center" style="margin-top: 50px">
            ...
            <div class="row top40">
                <div class="col-md-offset-3 col-md-6">
                    <a href="/creditos/login.php" class="btn btn-success btn-block"><strong>Acesso - Ponto de Venda</strong></a>
                </div>
            </div>
            <div class="row top20">
                <div class="col-md-offset-3 col-md-6">
                    <a href="/cadastro-de-ponto-de-venda.php" class="btn btn-info btn-block"><strong>Cadastro - Ponto de Venda</strong></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row" style="margin-top: 29px">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-info align-center borda-direita-basica p-bottom10">
        <h3>
            ...
            ou 
            <a href="#" link="e-prepagpdv.com.br/" class="txt-branco redirecionamento"><b><span class="link-destaque">saiba mais</span></b></a>.            
        </h3>
    </div>
</div>
</div>
               ...
               $.ajax({
                    ...
                    success: function(obj){
                        ...
                        if(obj.erro.length > 0){
                            ...
                            $("#modal-esqueci-senha").modal('hide');
                            manipulaModal(2,"Um e-mail foi enviado para "+$("#emailEsqueciSenha").val()+" com a sua senha.","Senha enviada");
                            return false;
                        }else{
                            manipulaModal(1,"Erro desconhecido, por favor, entre em contato com nosso suporte.","Erro");
                        }
                    },
                    error: function(){
                        waitingDialog.hide();
                ...
                waitingDialog.hide();
                erro = "E-mail inválido. Verifique os dados inseridos.";
