                            ...
                            ?>
                                    ...
                                    ?>
                                        <div class="row top10">
                                            ...
                                            <div class="col-md-7 bg-comprar p-top10 nome-produto <?php echo ($estoque) ? "c-pointer" : ""; ?> modelo-produto" estoque="<?php echo ($estoque) ? "1" : "0"; ?>" id="<?php echo $produtoModelo->getId(); ?>"
                                                data-valor="<?= ($produtoModelo->getValor() ?: 0) ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/game/" class="btn btn-primary">Explorar catálogo</a>
            </div>
...
<script>
    $(function() {
        ...
        $(".bg-comprar").click(function() {
            ...
            let produtoSelecionado = $(this).attr("id");
        ...
        $("#btn-adicionar-carrinho").click(function() {
            ...
            $.ajax({
                url: "/game/ajax/adiciona-carrinho.php",
                type: "POST",
                data: data,
                success: function(response) {
                    if (response.trim() === "sucesso") {
                        ...
                        let spanSelecionado = $("div#" + modeloId);
                        if (spanSelecionado.length > 0) {
                            nomeModelo = spanSelecionado.closest(".row").find("strong").first().text().trim();
                            valorModelo = (spanSelecionado.data("valor") ? spanSelecionado.data("valor").toLocaleString('pt-BR', {
                                style: 'currency',
                                currency: 'BRL'
                            }) : "");
                        } else {
                            ...
                            valorModelo = ($("#valor").val() ? Number($("#valor").val()).toLocaleString('pt-BR', {
                                style: 'currency',
                                currency: 'BRL'
                            }) : "");
                        }
