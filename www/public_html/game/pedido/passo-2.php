...
//Marcando que n�o � compra de integra��o
...
if ($controller->usuario->getId() == 1286357) {
   ...
   foreach($carrinho as $modelo => $val){
    ...
    $auth = $classGarena->chamaGarena("GET"); // Para produ��o passar o segundo parametro 'producao'
	if($auth !== true){
...
if (!empty($controller->usuario->ug_sCPF)) {
...
if ($btSubmit || $iforma) {
    ...
    if ($msg == "") {
        if (!in_array($pagto, $FORMAS_PAGAMENTO)) $msg = "Forma de pagamento inv�lida.";
    }
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12 txt-azul-claro top10">
                                <span class="glyphicon glyphicon-triangle-right graphycon-big" aria-hidden="true"></span><strong>Atualiza��o Dados de Endere�o</strong>
                            </div>
                        </div>
                    </div>
...
require_once DIR_WEB . 'game/includes/cabecalho.php';
            ...
            <script language="Javascript">
                ...
                if ($bloqueioPercentual == true) {
                    echo ' manipulaModal(1,"Seu <b>limite de compras</b> neste CPF consta em 80% para prosseguir com a compra de PINS, por gentileza efetue contato com o suporte@e-prepag.com.br para aumento do limite de vendas.","Aten��o");';
                ...
                ?>
                        ...
                        function save_shipping(iforma, id, sno) {
                            ...
                            document.form1.prod_camp.value = <?php echo htmlspecialchars((isset($prod_camp)) ? $prod_camp : 0); ?>;
                    ...
                    ?>
                        manipulaModal(1, "O <b>limite m�ximo</b> de compras por m�s foi <b>excedido</b>", "Erro");
                        $('#modal-load').on('hidden.bs.modal', function() {
        ...
        ?>
            ...
            manipulaModal(1,"<div style='background-color: #fff; padding: 30px; display: flex; flex-direction: column'><label for='data_nascimento'>Data de Nascimento</label><input type='date' name='data_nascimento' placeholder='00/00/0000' value='' /><br /><label for='data_nascimento'>CPF</label><input style='padding: 10px' type='text' name='cpf' placeholder='000.000.000-00' /><br /><button id='teste' style='width: 200px; margin: 0px auto; padding: 10px;'>Salvar</button></div>","Preencha as informa��es restantes abaixo");
        ...
        ?>
            manipulaModal(1,"Seu cadastro est� incompleto ou apresenta algum problema. Por favor, acesse ?Meu Cadastro? para revisar e corrigir seus dados. Caso o erro persista, entre em contato com o suporte.","Erro");
            ...
            <div class="col-md-12">
                ...
                ?>
                    ...
                    <form id="form1" name="form1" method="post">
                        <input type="hidden" name="prod_camp" id="prod_camp" value="<?php echo htmlspecialchars((isset($prod_camp)) ? $prod_camp : 0); ?>">
                        <input type="hidden" name="tipo" value="venda_gamer">
                        <input type="hidden" name="btSubmit" value="">
                        <?php
                        // REGRAS DE DISPONIBILIZA��O DE MEIOS DE PAGAMENTOS
                        ...
                        if ($controller->usuario->b_IsLogin_pagamento()) {
                            ...
                            //Variavel utilizada para isen��o de taxas
                            ...
                            // Calcula o total nas �ltimas 24 horas para pagamentos Online 
                            ...
                            // Libera Bradesco apenas se limite diario n�o ultrapassado //produtos (Habbo e GPotato) e tem at� 5 compras nas �ltimas 24 horas
                            ...
                            $msg_bloqueia_Bradesco = (!$b_libera_Bradesco) ? ((!$b_LimiteDiarioOK) ? "<p class='txt-azul fontsize-pp'>Sua compra de " . number_format($total_carrinho, 2, ',', '.') . " ultrapassa o limite di�rio de compras on-line.</p>" : ((!$b_TentativasDiariasOK) ? "<p class='txt-azul fontsize-pp'>N�mero de pagamentos online (" . $qtde_last_dayOK . ") ultrapassa o limite di�rio.</p>" : "")) : "";
                            ...
                            $msg_bloqueia_Hipay = (!$b_libera_Hipay) ? ((!$b_LimiteDiarioOK) ? "<p class='txt-azul fontsize-pp'>Sua compra de " . number_format($total_carrinho, 2, ',', '.') . " ultrapassa o limite di�rio de compras on-line.</p>" : ((!$b_TentativasDiariasOK) ? "<p class='txt-azul fontsize-pp'>N�mero de pagamentos online (" . $qtde_last_dayOK . ") ultrapassa o limite di�rio.</p>" : "")) : "";

                            $msg_bloqueia_Paypal = (!$b_libera_Paypal) ? ((!$b_LimiteDiarioOK) ? "<p class='txt-azul fontsize-pp'>Sua compra de " . number_format($total_carrinho, 2, ',', '.') . " ultrapassa o limite di�rio de compras on-line.</p>" : ((!$b_TentativasDiariasOK) ? "<p class='txt-azul fontsize-pp'>N�mero de pagamentos online (" . $qtde_last_dayOK . ") ultrapassa o limite di�rio.</p>" : "")) : "";

                            $msg_bloqueia_Boleto = (!$b_libera_Boleto) ? ((!$b_LimiteDiarioOK) ? "<p class='txt-azul fontsize-pp'>Sua compra de " . number_format($total_carrinho, 2, ',', '.') . " ultrapassa o limite de compras por boleto.</p>" : ((!$b_TentativasDiariasOK) ? "<p class='txt-azul fontsize-pp'>N�mero de pagamentos (" . $qtde_last_dayOK . ") ultrapassa o limite di�rio.</p>" : "")) : "";

                            $msg_bloqueia_Deposito = (!$b_libera_Deposito) ? "<p class='txt-azul fontsize-pp'>Sua compra de " . number_format($total_carrinho, 2, ',', '.') . " ultrapassa o limite de compras por dep�sito.</p>" : "";
                            ...
                            $params = array();
                            // $pagto = 'G' (Visa Cr�dito), quando passa aqi aonda n�o foi escolhido o $pagto -> uma forma para todos 
                            ...
                            $msg_bloqueia_Cielo = (!$b_libera_Cielo) ? "<p class='txt-azul fontsize-pp'>Pagamento indispon�vel</p>" : "";
                            ...
                            if (!$b_TentativasDiariasOK || !$b_LimiteDiarioOK) {
                                ...
                                $smsg_bloqueio =
                                    "	Usu�rio: ID: " . $controller->usuario->getId() . ",\n" .
                                    "	Regras bloqueio: b_TentativasDiariasOK: " . (($b_TentativasDiariasOK) ? "SIM" : "n�o") . " (n: $qtde_last_dayOK), " .
                                    "b_LimiteDiarioOK: " . (($b_LimiteDiarioOK) ? "SIM" : "n�o") . ", " .
                                    "b_libera_Cielo: " . (($b_libera_Cielo) ? "SIM" : "n�o") . " \n" .
                            ...
                            //Verifica se o pagamento com EPP CASH est� habilitado
                            $have_eppcash = false;

                            //Verifica se apenas o pagamento EPP CASH est� habilitado
                            $only_eppcash = false;
                            ...
                            if ($b_libera_Pix && PAGAMENTO_PIX || in_array($id_user, $pix_permit)) {
                                $cont_pagamentos++;
                                $div_pix = true;
                            }
                        ...
                        ?>
                            ...
                            <?php
                            //Vari�vel para identificar quando � necess�rio pular linha
                            $cont_colunas = 0;
                            ?>
                            <div class="row espacamento">

                                <div class="<?php if (isset($div_pix)) echo 'col-xs-12 col-md-4 mt-sm-15';
                                            else echo "dnone"; ?>">
                                    <div class="row">
                                        <?php
                                            ...
                                            <div class="col-xs-8">
                                                ...
                                                ?>
                                                    ...
                                                    if ($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $PAGAMENTO_PIX_TAXA != 0) {
                                                        echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ " . number_format($PAGAMENTO_PIX_TAXA, 2, ',', '.') . "</p>";
                                                    } //end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                    else {
                                                        echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                                                        //echo "<p class='txt-vermelho fontsize-pp bottom0'>ATEN�AO pix ita� indispon�vel<br> <strong>fa�a o pagamento pix por outro banco</strong></p>";
                                ...
                                ?>
                                <div class="<?php if (isset($div_bradesco)) echo 'col-xs-12 col-md-4 mt-sm-15';
                                            else echo "dnone"; ?>">
                                    <div class="row">
                                    ...
                                    <img class="c-pointer btnPgto" 
                                         ...
                                         title="Bradesco pagamento (D�bito em conta)" 
                                         onClick="save_shipping(<?php // echo $FORMAS_PAGAMENTO['PAGAMENTO_FACIL_BRADESCO_DEBITO'] 
                                                ...
                                                <!--                                <p class="txt-vermelho fontsize-pp bottom0">Sem taxa de servi�o</p>
                                <p class="txt-verde fontsize-pp">Entrega em at� 90 minutos</p>
                                <span style='display:none'><input type="radio" name="pagto" value="<?php echo $FORMAS_PAGAMENTO['PAGAMENTO_FACIL_BRADESCO_DEBITO'] ?>" <?php if ($pagto == $FORMAS_PAGAMENTO['PAGAMENTO_FACIL_BRADESCO_DEBITO']) echo " checked"; ?>></span>-->
                                            ...
                                            <div class="col-xs-4">
                                                <img
                                                    ...
                                                    style="width:100%; max-width: 100px;"
                                                    name="btn_5"
                                                    title="Bradesco pagamento (Transfer�ncia entre contas)"
                                                    onClick="<?php echo $onclick; ?>">
                                            </div>
                                            <div class="col-xs-8">
                                                <?php
                                                if ($b_libera_Bradesco && PAGAMENTO_BRADESCO) {
                                                ?>
                                                    <p class="fontsize-pp bottom0 top20">TRANSFER�NCIA ENTRE CONTAS</p>
                                                    <?php
                                                    if ($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $BRADESCO_TRANSFERENCIA_ENTRE_CONTAS_TAXA_ADICIONAL != 0) {
                                                        echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ " . number_format($BRADESCO_TRANSFERENCIA_ENTRE_CONTAS_TAXA_ADICIONAL, 2, ',', '.') . "</p>";
                                                    } //end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                    else {
                                                        echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                                                    } //end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                    ...
                                    <img class="c-pointer" 
                                        ...
                                        width="110" height="35" border="0" title="Bradesco pagamento dep�sito"
                                ...
                                <p class="txt-vermelho fontsize-pp bottom0">Sem taxa de servi�o</p>
                                <p class="txt-verde fontsize-pp">Entrega em at� 1 dia �til</p>
                                <p class="fontsize-pp txt-preto"><strong>Dep�sito, DOC
                                    Transfer�ncia offline
                                    Ag.2062-1<br>
                                    Cc.0030265-1</strong>
                                </p>
                                <p class="txt-preto fontsize-pp"><input type="checkbox" name="pagto_ja_fiz" id="pagto_ja_fiz" value="1" class="" <?php if ($pagto_ja_fiz == "1") echo "checked"; ?>>  Fiz o dep�sito e quero informar os dados.</p>
                                ...
                                ?>
                                <div class="<?php if (isset($div_itau)) echo 'col-xs-12 col-md-4 mt-sm-15';
                                            else echo "dnone"; ?>" style="float: left;">
                                    <div class="row">
                                        <?php
                                        // Bloqueio Pagamento Ongame - inicio
                                                ...
                                                <div class="col-xs-8">
                                                    ...
                                                    ?>
                                                        ...
                                                        if ($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $BANCO_ITAU_TAXA_DE_SERVICO != 0) {
                                                            echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ " . number_format($BANCO_ITAU_TAXA_DE_SERVICO, 2, ',', '.') . "</p>";
                                                        } //end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                        else {
                                                            echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                                                        } //end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                        ?>
                                                        <p class="txt-verde fontsize-pp">Entrega em at� 30 minutos</p>
                                        ...
                                        <?php
                                                ...
                                                echo "<p class='txt-azul fontsize-pp'>Servi�o indispon�vel no momento</p>";
                                            }
                                ...
                                ?>
                                <div class="<?php if (isset($div_brasil)) echo 'col-xs-12 col-md-4 mt-sm-15';
                                            else echo "dnone"; ?>">
                                    <div class="row">
                                        <?php
                                ...
                                onClick="save_shipping(<?php // echo $FORMAS_PAGAMENTO['PAGAMENTO_BB_DEBITO_SUA_CONTA'] 
                                                ...
                                                <div class="col-xs-8">
                                                    ...
                                                    if ($b_libera_BancodoBrasil) {
                                                    ?>
                                                        <p class="fontsize-pp bottom0 top20">D�BITO EM CONTA</p>
                                                        <?php
                                                        if ($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $BANCO_DO_BRASIL_TAXA_DE_SERVICO != 0) {
                                                            echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ " . number_format($BANCO_DO_BRASIL_TAXA_DE_SERVICO, 2, ',', '.') . "</p>";
                                                        } //end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                        else {
                                                            echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                                                        } //end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
...
*/
                                ...
                                ?>
                                    <div class="col-xs-12 col-md-4 mt-sm-15">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8">
                                                <p class="fontsize-pp bottom0">Dep�sito / DOC / TED</p>
                                                <p class="txt-vermelho fontsize-pp bottom0">Sem taxa de servi�o</p>
                                                <p class="txt-verde fontsize-pp">Entrega em at� 1 dia �til</p>
                                                <!--                                <p class="fontsize-pp txt-preto"><strong>Dep�sito, DOC
                                    Transfer�ncia offline
                                    ...
                                    Cc.0030265-1</strong>
                                                ...
                                                <p class="txt-preto fontsize-pp"><input type="checkbox" name="pagto_ja_fiz" id="pagto_ja_fiz" value="1" onchange='check_deposito(this);' class="" <?php if ($pagto_ja_fiz == "1") echo "checked"; ?>> Ap�s efetuar o pagamento, clique aqui para informar os dados.</p>
                                                <span style='display:none'><input type="radio" name="pagto" value="<?php echo $FORMAS_PAGAMENTO['DEP_DOC_TRANSF'] ?>" <?php if ($pagto == $FORMAS_PAGAMENTO['DEP_DOC_TRANSF']) echo " checked"; ?>></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                ?>
                                <div class="<?php if (isset($div_boleto)) echo 'col-xs-12 col-md-4 mt-sm-15';
                                            else echo "dnone"; ?>" style="float: left;">
                                    <div class="row">
                                        <?php
                                        // Bloqueio Pagamento Ongame - inicio
                                        ...
                                        ?>
                                                ...
                                                <div class="col-xs-8">
                                                    ...
                                                    if ($b_libera_Boleto) {
                                                    ?>
                                                        <p class="fontsize-pp bottom0 top20">BOLETO BANC�RIO</p>
                                                        <?php
                                                        if ($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $BOLETO_TAXA_ADICIONAL != 0) {
                                                            echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ " . number_format($BOLETO_TAXA_ADICIONAL, 2, ',', '.') . "</p>";
                                                        } //end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                        else {
                                                            echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                                                        } //end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                        ?>
                                                        <p class="txt-verde fontsize-pp">Entrega em at� 2 dias �teis.</p>
                                ...
                                ?>
                                <div class="<?php if ($only_eppcash) echo "col-xs-offset-1" ?> <?php if (isset($div_eppcash)) echo "col-xs-12 col-md-4 mt-sm-15";
                                                                                                else echo "dnone"; ?>">
                                    <div class="row">
                                        <?php
                                        // Bloqueio Pagamento Ongame - inicio
                                        ...
                                        ?>
                                            ...
                                            ?>
                                                ...
                                                <div class="col-xs-8">
                                                    ...
                                                    if (!$only_eppcash) {
                                                    ?>
                                                        <p class="txt-azul fontsize-pp bottom0"><a href="<?= EPREPAG_URL_HTTPS ?>/game/produto/detalhe.php?token=IlJQTB5TdFZVAj0XFwEHNwdDTRYafVtNFXtVWl4P">N�o tem um PIN?</a></p>
                                                    <?php
                                                    }
                                                    ?>
                                ...
                                ?>
                                    <div class="col-xs-12 col-md-6 mt-sm-20">
                                        <span class="txt-cinza">
                                            Para finalizar esta compra, voc� precisa de um <b><a href="<?= EPREPAG_URL_HTTPS ?>/game/produto/detalhe.php?token=IlJQTB5TdFZVAj0XFwEHNwdDTRYafFtNGHlHQxg">Cart�o E-Prepag Cash</a></b> ou <b><a href="<?= EPREPAG_URL_HTTPS ?>/game/conta/add-saldo.php">saldo</a></b> em seu cart�o E-Prepag.<br>
                                            Caso j� possua um <b>cart�o</b> ou <b>saldo</b>, clique no bot�o <b>"E-PREPAG Cash"</b> e finalize a compra.<br><br>
                                            Caso queira adquirir um Cart�o E-Prepag Cash, <b><a href="<?= EPREPAG_URL_HTTPS ?>/game/produto/detalhe.php?token=IlJQTB5TdFZVAj0XFwEHNwdDTRYafFtNGHlHQxg">clique aqui</a></b><br>
                                            <i>(Voc� pode pagar por boleto banc�rio, transfer�ncia, d�bito em conta, dep�sito banc�rio, DOC ou TED)</i>
                                        </span>
                                    </div>
                                <?php
                                }
                                            ...
                                            <div class="col-xs-12 col-md-4 mt-sm-15">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-8 top20">
                                                        ...
                                                        if ($liberado) {
                                                        ?>
                                                            <p class="fontsize-pp bottom0">VISA - D�BITO</p>
                                                            <?php
                                                            if ($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $PAGAMENTO_VISA_DEBITO_TAXA != 0) {
                                                                echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ " . number_format($PAGAMENTO_VISA_DEBITO_TAXA, 2, ',', '.') . "</p>";
                                                            } //end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                            else {
                                                                echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                                                            } //end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                            ...
                                            <div class="col-xs-12 col-md-4 mt-sm-15">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-8 top20">
                                                        ...
                                                        if ($liberado) {
                                                        ?>
                                                            <p class="fontsize-pp bottom0">VISA - CR�DITO</p>
                                                            <?php
                                                            if ($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $PAGAMENTO_VISA_CREDITO_TAXA != 0) {
                                                                echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ " . number_format($PAGAMENTO_VISA_CREDITO_TAXA, 2, ',', '.') . "</p>";
                                                            } //end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                            else {
                                                                echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                                                            } //end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
...
*/
 ...
 ?>
                        ...
                        if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $PAGAMENTO_MASTER_DEBITO_TAXA != 0) {
                            echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ ".number_format($PAGAMENTO_MASTER_DEBITO_TAXA, 2, ',', '.')."</p>";
                        }//end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                        else {
                            echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                        }//end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                            ...
                                            <div class="col-xs-12 col-md-4 mt-sm-15">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-8 top20">
                                                        ...
                                                        if ($liberado) {
                                                        ?>
                                                            <p class="fontsize-pp bottom0">MASTERCARD - CR�DITO</p>
                                                            <?php
                                                            if ($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $PAGAMENTO_MASTER_CREDITO_TAXA != 0) {
                                                                echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ " . number_format($PAGAMENTO_MASTER_CREDITO_TAXA, 2, ',', '.') . "</p>";
                                                            } //end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                            else {
                                                                echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                                                            } //end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
...
?>
                        ...
                        if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $PAGAMENTO_ELO_DEBITO_TAXA != 0) {
                            echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ ".number_format($PAGAMENTO_ELO_DEBITO_TAXA, 2, ',', '.')."</p>";
                        }//end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                        else {
                            echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                        }//end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                            ...
                                            <div class="col-xs-12 col-md-4 mt-sm-15">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-8 top20">
                                                        ...
                                                        if ($liberado) {
                                                        ?>
                                                            <p class="fontsize-pp bottom0">ELO - CR�DITO</p>
                                                            <?php
                                                            if ($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $PAGAMENTO_ELO_CREDITO_TAXA != 0) {
                                                                echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ " . number_format($PAGAMENTO_ELO_CREDITO_TAXA, 2, ',', '.') . "</p>";
                                                            } //end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                            else {
                                                                echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                                                            } //end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                            ...
                                            <div class="col-xs-12 col-md-4 mt-sm-15">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-8 top20">
                                                        ...
                                                        if ($liberado) {
                                                        ?>
                                                            <p class="fontsize-pp bottom0">DINERS - CR�DITO</p>
                                                            <?php
                                                            if ($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $PAGAMENTO_DINERS_CREDITO_TAXA != 0) {
                                                                echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ " . number_format($PAGAMENTO_DINERS_CREDITO_TAXA, 2, ',', '.') . "</p>";
                                                            } //end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                            else {
                                                                echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                                                            } //end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
...
*/
                                            ...
                                            <div class="col-xs-12 col-md-4 mt-sm-15">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-8 top20">
                                                        ...
                                                        if ($liberado) {
                                                        ?>
                                                            <p class="fontsize-pp bottom0">DISCOVER - CR�DITO</p>
                                                            <?php
                                                            if ($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA && $PAGAMENTO_DISCOVER_CREDITO_TAXA != 0) {
                                                                echo "<p class='txt-cinza fontsize-pp bottom0'>Taxa de servi�o: R$ " . number_format($PAGAMENTO_DISCOVER_CREDITO_TAXA, 2, ',', '.') . "</p>";
                                                            } //end if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                            else {
                                                                //echo "<p class='txt-vermelho fontsize-pp bottom0'>ATEN�AO pix no itau est� fora do ar</p>";
                                                                echo "<p class='txt-vermelho fontsize-pp bottom0'>Sem taxa de servi�o</p>";
                                                            } //end else do if($valor_tmp < $RISCO_GAMERS_VALOR_MIN_PARA_TAXA)
                                                            ?>
                                                            <p class="txt-verde fontsize-pp">Entrega em at� 30 minutos</p>
                ...
                /*
		O c�digo abaixo foi feito por Livrodjx, ele basicamente verifica se h� um CPF e se esse CPF cruza com a tabela
		de pessoas politicamente expostas, se caso houver um registro ele envia um e-mail que houve uma tentativa de compra.
		
		Algumas vari�veis tem a extens�o _djx apenas para n�o haver conflito com o resto do c�digo
	*/
		...
		$cabecalho_adicional_caso_pdv = " ATRAV�S DE PDV (ID ".$dados_pdv_djx['ug_id']." )";
		...
		<table style='padding:20px;background-color:#ddd;margin: 0 auto;width: 90%; color: #222' class='table table-bordered top20'><thead class=''>
			...
			<tr>
				...
				<th style='padding:5px;'>Valor unit�rio</th>
		...
		";
                        // Dados do Email
                        $email  = "rc@e-prepag.com.br,rc1@e-prepag.com.br"; //andresilva@gokeitecnologia.com.br,rc@e-prepag.com.br,rc1@e-prepag.com.br,
