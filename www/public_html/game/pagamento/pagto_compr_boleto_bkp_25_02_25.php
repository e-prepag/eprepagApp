            ...
            if ($pagtoInvalido) {
                ...
                if ($ultimo_status == $GLOBALS['STATUS_VENDA']['DADOS_PAGTO_RECEBIDO'] || $ultimo_status == $GLOBALS['STATUS_VENDA']['PEDIDO_EFETUADO']) {
                    ...
                    <div class="col-md-9 texto espacamento bottom20">
                        ...
                        <div class="top10">
                            <strong><i>Atenção: Após o pagamento aguarde até 2 dias úteis para confirmação
                                    bancária.</i></strong>
                        </div>
                    </div>
                    <div class="col-md-3 espacamento">
                        <div class="top10 pull-right">
                            <a href="javascript:void(0);" class="btn btn-success" onclick="fcnJanelaBoleto();">Clique aqui para
                                emitir o boleto</a>
                        </div>
