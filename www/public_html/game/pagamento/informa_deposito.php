        ...
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 txt-azul-claro top10">
                <span class="glyphicon glyphicon-triangle-right graphycon-big pull-left"
                    ...
                    <h4 class="top20">informações de depósito</h4>
                </strong>
            </div>
            <?php
            ...
            if ($pagtoInvalido) {
                ...
                <form name="form1" id="form1" action="" method="post" ENCTYPE="multipart/form-data">
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    Para sua segurança, uma vez informados os dados não será possível fazer alteração. Se as
                                    informações forem fornecidas incorretamente o seu pedido ficará pendente.
                                    <div class="clearfix"></div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Voltar</button>
                                    <input type="submit" name="btSubmit" id="btSubmit" value="Confirmar"
                    ...
                    <input type='hidden' name='ug_show' id='ug_show'
                        value='<?php echo htmlspecialchars($_POST['ug_show']); ?>'>
                    <div class="" style="border-top: 0px;">
                        <?php echo str_replace("\n", "<br>", $msg); ?>
                        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                            <p class="txt-preto top20">
                                Digite os dados corretamente para que o seu pagamento seja identificado e o seu produto
                                liberado
                            </p>
                        </div>
                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 txt-preto teste">
                            ...
                            <div class="col-md-4 top20">
                                <select name="pagto_banco" class="form-control"
                                    OnChange="if(document.form1.pagto_local)document.form1.pagto_local.value='';document.form1.submit();">
                                    <option value="" <?php if ($pagto_banco == "")
                                        echo "selected" ?>>Selecione o Banco
                                        </option>
                                        <?php
                                    foreach ($PAGTO_BANCOS as $bancoId => $bancoNome) {
                                        if ($bancoId != '104' && $bancoId != '341' && $bancoId != '033') {
                                            ?>
                                            <option value="<?php echo $bancoId; ?>" <?php if ($pagto_banco == $bancoId)
                                                   echo "selected"; ?>><?php echo $bancoNome; ?></option>
                                            <?php
                                        } //end if
                                    } //end foreach
                                    ?>
                        ...
                        if ($pagto_banco && !is_null($pagto_banco) && $pagto_banco != "" && is_numeric($pagto_banco)) {
                            ...
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 txt-preto teste">
                                ...
                                <div class="col-md-4 top10">
                                    <select name="pagto_local" class="form-control" OnChange="document.form1.submit();">
                                        <option value="" <?php if ($pagto_local == "")
                                            echo "selected" ?>>Selecione o Local
                                            </option>
                                            <?php
                                        foreach ($PAGTO_LOCAIS[$pagto_banco] as $localId => $localNome) {
                                            ?>
                                            <option value="<?php echo $localId; ?>" <?php if ($pagto_local == $localId)
                                                   echo "selected"; ?>><?php echo $localNome; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            if ($pagto_local && !is_null($pagto_local) && $pagto_local != "" && is_numeric($pagto_local)) {
                                ...
                                <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 txt-preto teste">
                                    ...
                                    <div class="col-md-4 top10">
                                        <input name="pagto_data_data" type="text" class="form-control" id="pagto_data_data"
                                            value="<?php echo $pagto_data_data ?>" size="10" maxlength="10" readonly="readonly">
                                    </div>
                                </div>
                                <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 txt-preto teste">
                                    ...
                                    <div class="col-md-5 top10">
                                        <select name="pagto_data_horas" class="form-control pull-left w70p">
                                            <option value="" <?php if ($pagto_data_horas == "")
                                                echo "selected" ?>>HH</option>
                                                <?php
                                            for ($i = 0; $i <= 23; $i++) {
                                                ?>
                                                <option value="<?php echo substr("0" . $i, -2); ?>" <?php if ($pagto_data_horas == substr("0" . $i, -2))
                                                          echo "selected"; ?>>
                                                    <?php echo substr("0" . $i, -2); ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select><span class="p-3 pull-left"><strong> : </strong></span>
                                        <select name="pagto_data_minutos" class="form-control pull-left w70p">
                                            <option value="" <?php if ($pagto_data_minutos == "")
                                                echo "selected" ?>>MM</option>
                                                <?php
                                            for ($i = 0; $i <= 59; $i++) {
                                                ?>
                                                <option value="<?php echo substr("0" . $i, -2); ?>" <?php if ($pagto_data_minutos == substr("0" . $i, -2))
                                                          echo "selected"; ?>>
                                                    <?php echo substr("0" . $i, -2); ?></option>
                                                <?php
                                            }
                                ...
                                for ($i = 0; $i < count($pagto_nome_docto_Ar); $i++) {
                                    ...
                                    <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 txt-preto teste">
                                        ...
                                        <div class="col-md-3 top10">
                                            <input name="pagto_num_docto[]"
                                                value="<?php echo htmlspecialchars($pagto_num_docto[$i], ENT_QUOTES) ?>" type="text"
...
<?php 
                                ...
                                <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 txt-preto">
                                    ...
                                    <div class="col-md-3 top10">
                                        <input name="pagto_valor_pago"
                                            value="<?php echo htmlspecialchars($pagto_valor_pago, ENT_QUOTES); ?>" type="text"
                                            size="20" maxlength="20" class="form-control money" placeholder="0,00">
                                    </div>
                                </div>
                                <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 txt-preto">
