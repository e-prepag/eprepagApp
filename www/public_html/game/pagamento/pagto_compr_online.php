                ...
                <?php
                    ...
                    ?>
                        <div class="col-md-12 text-center">
                            ...
                            <a class="btn btn-success bottom10" href="https://www.e-prepag.com.br/game/conta/pedidos.php">Meus
                                pedidos</a>
                        </div>
                    <?php
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------            
                        ...
                        if (PAGAMENTO_PIX_CHAVEAMENTO == "a") {
                            ...
                            if ($ativoNome["nome"] == "asaas") {
                                ...
                                $itens = [];
                                foreach ($arr_venda_modelos as $venda_modelo) {
                                    $itens[] = [
