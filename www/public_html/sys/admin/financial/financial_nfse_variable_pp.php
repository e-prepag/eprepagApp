...
?><html>
    ...
    <body onLoad="window.location='<?php echo $strRedirect ?>'"><?php
                                                                exit;
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12 ">
                                    <strong>
                                        <font color="#66CC00"><?php echo LANG_COMMISSIONS_FINANCIAL_PAGE_TITLE; ?> <?php echo "<font color='#3300FF'></font>" ?> <?php echo LANG_STATISTICS_FOR_MONTH;
                                                                                                                                                                    ?> </font><?php if (strlen($_SESSION["opr_nome"]) > 0) echo "<font color='#66CC33'>" . $_SESSION["opr_nome"] . "</font> "; ?>- <?php echo LANG_COMMISSIONS_PAGE_TITLE_1; ?> (<?php echo get_current_date() ?>)
                                    </strong>
                                </div>
                            </div>
                            ...
                            <form name="form1" id="form1" method="post" action="">
                                ...
                                <div class="row txt-cinza top10">
                                    <div class="col-md-2">
                                        <span class="pull-right"><?php echo "M&ecirc;s/Ano"; ?></span>
                                    </div>
                                    <div class="col-md-3">
                                        <input name="nfes_mes_ano" type="month" class="form-control" id="nfes_mes_ano" value="<?php echo htmlspecialchars($nfes_mes_ano, ENT_QUOTES, 'ISO-8859-1'); ?>">
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <table border='1' cellpadding='0' cellspacing='1' bordercolor='#cccccc' class="table fontsize-13">
                                    ...
                                    foreach ($dd_operadora_multi as $line => $dd_operadora) {
                                        ...
                                        $inicio = date('Y-m-01', $nfes_mes_ano_timestamp);
                                        $fim = date('Y-m-t', $nfes_mes_ano_timestamp);
                        ...
                        where  fp_publisher = $1
                               and fp_freeze=0";
                                        ...
                                        if ($min_date) {
                                            ...
                                            echo "<font color='#BD3C2D'>A menor data do Publisher <font color='#282B79'>" . $dd_operadora_nome[$dd_operadora] . "</font> que ainda não possui fechamento " . $min_date_row['menor_data'] . ".</font><br>";
                                        } //end if($min_date)
                                ...
                                <table border='0' cellpadding='0' cellspacing='1' width='80%' bordercolor='#cccccc' style='border-collapse:collapse;'>
                                    <tr align="center">
                                        ...
                                        <td bgcolor="#FFFFFF" class="texto"><?php echo LANG_STATISTICS_SEARCH_MSG . " " . number_format(getmicrotime() - $time_start_stats, 2, '.', '.') . " " . LANG_STATISTICS_SEARCH_MSG_UNIT; ?></font>
                                        </td>
                                        <td bgcolor="#FFFFFF" class="texto" width="10%">&nbsp;</td>
                                    </tr>
                                </table>
                                <input type="hidden" name="nfes_periodo" id="nfes_periodo" value="<?php echo mes_do_ano2($nfes_mes_ano_timestamp); ?>">
                            </form>
                        </div>
                    </div>
                </div>
