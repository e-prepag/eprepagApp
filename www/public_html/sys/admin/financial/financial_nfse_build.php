...
<table width="903" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td height="22,5" valign="center" bgcolor="#00008C" width="903"><p><font face="Arial, Helvetica, sans-serif" size="2" color="#FFFFFF"><b>Gera&ccedil;&atilde;o de Arquivo RPS - Período considerado [<?php echo $nfes_periodo; ?>]<br></b></font></p></td>
  </tr>
  <tr>
	<td>
		&nbsp;
...
if($cont_nota > 0) {
	...
	echo "<tr><td><font color='#000000' class='texto' align='center'>EPP - Pagamentos => N&atilde;o foi gerado nenhuma RPS para o Arquivo. </font></td></tr>";
}
echo "<tr><td>&nbsp;</td></tr>";
if($cont_nota_adm > 0) {
	...
	echo "<tr><td><font color='#000000' class='texto' align='center'>EPP - Administradora => N&atilde;o foi gerado nenhuma RPS para o Arquivo. </font></td></tr>";
}
?>
  <tr>
	<td>
