...
//	$range_qtde   = $qtde_range_tela;
	...
	$sql  = "select extract (day from vc_data) as dia, extract (month from vc_data) as mes, extract (year from vc_data) as ano, sum(n) as quantidade, sum (vendas1) as total 
				from (
    ...
    <div class="container txt-azul-claro bg-branco">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12 ">
                        <strong><?php echo LANG_REPORTS_PAGE_TITLE_6; ?></strong>
                    </div>
                </div>
...
<?php
					...
					?>
                        ...
                        <div class="col-md-3">
                            <select name="dd_mes" id="dd_mes" class="form-control" onChange="document.form1.submit()">
...
<?php
                        ...
                        $cabecalho = "'".LANG_DAY_2."','".LANG_WEEKDAY_2."','".LANG_REPORTS_QUANTITY."','".LANG_REPORTS_TOTAL_VALUE."'";
                        ...
                        while ($pgdia = pg_fetch_array($resdia))
                        {
                            ...
                            if($dia_sem==1) {
                                echo "<tr><td height='2' colspan='4'><img src='/sys/imagens/quad_azul.gif' width='100%' height='2' border='0'></td></tr>\n";
                            }
?>
                            <tr class="trListagem"> 
...
?>
                            <tr class="bg-cinza-claro"> 
                                ...
                                <td><strong><?php echo number_format($pin_total_qtde, 0, ',', '.') ?></strong></td>
                                <td><strong><?php echo number_format($pin_total_valor, 2, ',', '.') ?></strong></td>
                            </tr>
<?php 
...
?>
                            <tr class="bg-cinza-claro"> 
                                <td colspan="4" class="fontsize-pp"><strong><?php echo LANG_REPORTS_LAST_MSG; ?>. </strong></td>
                            </tr>
                            <tr class="bg-cinza-claro"> 
                                <td colspan="4" class="fontsize-pp"><?php echo LANG_SITE_SEARCH_MSG_1.' '.number_format($time, 2, '.', '.').' '.LANG_SITE_SEARCH_MSG_2; ?></td>
                            </tr>
                            <tr class="bg-cinza-claro"> 
