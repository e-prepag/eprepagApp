                            ...
                            <table id="table" class="table bg-branco txt-preto fontsize-p">
                                <thead>
                                    <tr class="bg-cinza-claro">
                                        ...
                                        <!--<th class="text-center"><?php //echo "Date"; 
                                                                    ?></th>-->
                                        <?php
                                        /*
?>                            
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="trListagem">
                                            ...
                                            <td align="center">
                                                <nobr><?php if ($pgrow['pin_datavenda']) { ?><?php echo monta_data($pgrow['pin_datavenda']); ?> - <?php echo $pgrow['pin_horavenda'];
                                                                                                                                                } else echo "--"; ?></nobr>
                                            </td>
                                            <td align="right" style="white-space:nowrap;"><?php echo "R$ " . number_format($pin_valor, 2, ',', '.'); ?></td>
                                            <!--<td align="right" style="white-space:nowrap;"><?php  //echo monta_data($pgrow['vg_data_inclusao']); 
                                                                                                ?></td>-->
                                            <?php
                                            /*
?>                                
