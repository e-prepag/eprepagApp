    ...
    if ($dd_tipo == 'CPF') {
        $sql = "
                SELECT DISTINCT ON (ug.ug_id) 
                    ug.ug_id, 
                    ug.ug_cpf,
                    ug.ug_nome_cpf as ug_nome,
                    ug.ug_data_cpf_informado 
                FROM usuarios_games ug
                JOIN tb_venda_games vg ON vg.vg_ug_id = ug.ug_id 
                JOIN tb_venda_games_modelo vm ON vm.vgm_vg_id = vg.vg_id 
...
<script language="JavaScript">
    ...
    function changeSelect() {
        ...
        } else if ($('#dd_tipo').val() == "TELE" || $('#dd_tipo').val() == "") {
            $('.simbo').attr("hidden", "hidden");
            $('.tele').removeAttr("hidden");
        } else if ($('#dd_tipo').val() == "CPF") {
            $('.simbo').attr("hidden", "hidden");
            $('.tele').attr("hidden", "hidden");
        }
    }
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <select name="dd_tipo" id="dd_tipo" class="form-control" onchange="changeSelect();">
                                ...
                                <option value="CPF" <?php if ("CPF" == $dd_tipo) echo "selected" ?>>RELATÓRIO CPF</option>
                            </select>
                        </div>
                    </div>
                    <div class="row txt-cinza espacamento">
                                ...
                                <thead>
                                    <tr class="bg-cinza-claro nobr">
                                        <?php if ($dd_tipo == 'CPF') { ?>
                                            ...
                                            <th class="text-center">Data Atualização CPF</th>
                                        <?php } else { ?>
...
*/
                                                ...
                                                <td><?php echo $cpfcnpj; //str_replace("-", "", str_replace(".", "", $pgrow['ug_cpf'])); 
                                                    ?></td>
                                                <td><?php echo $pgrow['ug_nome']; ?></td>
                                                <td><?php echo $vetorPublishersAux[$dd_opr_codigo]['Razao']; //Nome 
                                                    ?></td>
 ...
 */
                                                ...
                                                <td class="text-right">
                                                    <nobr><strong>R$ <?php echo number_format(round($total_geral_liquido, 2), 2, ',', '.'); ?></strong></nobr>
                                                </td>
                                                <td colspan="3">&nbsp;</td>
                                            </tr>
                                        <?php
 ...
 */
                                    ...
                                    if ("CPF" == $dd_tipo) {
                                        ...
                                        ?>
                                            <tr class="trListagem">
                                                ...
                                                <td align="center"><?php echo $data_informado; ?></td>
                                            </tr>
                                        <?php
                                        }
                                    ...
                                    <tr class="bg-cinza-claro">
                                        <td colspan="20" class="fontsize-pp"><?php echo date('Y-m-d H:i:s'); //echo " - ".$total_geral_liquido. " - ".number_format(round(($total_geral_liquido_dolar),2), 2, ',', '.'); 
                                                                                ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <?php
                            ...
                            if ($dd_tipo != 'CPF' && empty($cotacao_dolar) && !is_array($cotacao_dolar)) {
