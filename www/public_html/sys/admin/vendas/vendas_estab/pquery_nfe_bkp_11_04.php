...
if($FrmPreencher && $_SESSION["tipo_acesso_pub"]=='AT') {
        ...
        $estat  = "select trn_code, trn_data, opr_nome, valor, qtde_itens, qtde_produtos, canal, trn_nome, trn_cpf, trn_cpf_indicador, trn_vgm_id, trn_vgm_nfe_rps_id
                from (
                        ...
                        'Site LH' as canal, '' as trn_nome, '' as trn_cpf, '3' as trn_cpf_indicador, vgm_id as trn_vgm_id, vgm_nfe_rps_id as trn_vgm_nfe_rps_id 
                        ...
                        sum(vgm.vgm_valor * vgm.vgm_qtde) as valor, sum(vgm.vgm_qtde) as qtde_itens, count(*) as qtde_produtos, 
                        'Site '||(case when (vg_ug_id=7909) then 'ExpressMoney' else 'Money' end) as canal, '-' as trn_nome, '' as trn_cpf, '3' as trn_cpf_indicador, vgm_id as trn_vgm_id, vgm_nfe_rps_id as trn_vgm_nfe_rps_id 
...
if($FrmEnviar == 1) {
        ...
        $estat  = "select trn_code, trn_data, opr_nome, trn_valor, qtde_itens, qtde_produtos, canal, trn_nome, trn_cpf, trn_cpf_indicador, trn_vgm_id, trn_vgm_nfe_rps_id, trn_comissao 
                from (
                        ...
                        'Site LH' as canal, vgm.vgm_nome_cpf as trn_nome, '' as trn_cpf, '3' as trn_cpf_indicador, vgm_id as trn_vgm_id, vgm_nfe_rps_id as trn_vgm_nfe_rps_id, vgm_perc_desconto/100 as trn_comissao   
                        from tb_dist_venda_games vg inner join tb_dist_venda_games_modelo vgm on vgm.vgm_vg_id = vg.vg_id inner join dist_usuarios_games ug on ug.ug_id = vg.vg_ug_id , operadoras t2 
                        ...
                        group by ug.ug_id, vgm.vgm_nome_cpf, vgm.vgm_id, 
					   ...
					   $estat .= "ug.ug_nome as trn_nome, '' as trn_cpf, '3' as trn_cpf_indicador, vgm_id as trn_vgm_id, vgm_nfe_rps_id as trn_vgm_nfe_rps_id, 0 as trn_comissao 
...
//die("Stop");
              ...
              <tr bgcolor="#f5f5fb"> 
                ...
                <td bgcolor="<?php  echo $cor1 ?>"><div align="center"><?php  echo (($_SESSION["tipo_acesso_pub"]=='AT')?$pgrow['trn_nome']:"&nbsp;"); ?></div></td>
                <td bgcolor="<?php  echo $cor1 ?>"><div align="center"><?php  echo (($_SESSION["tipo_acesso_pub"]=='AT')?$pgrow['trn_cpf']:"&nbsp;"); ?></div></td>
