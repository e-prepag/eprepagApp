...
<?php
                                        if(b_is_Financeiro()) {
?>
                                            <td class="text-right"><a href="https://<?php echo $server_url_complete ?>/gamer/vendas/com_venda_detalhe.php?venda_id=<?php  echo "".$pgrow['vg_id']; ?>" target="_blank"><?php  echo $pgrow['vg_id']; ?></a></td>
<?php 
                                        }
