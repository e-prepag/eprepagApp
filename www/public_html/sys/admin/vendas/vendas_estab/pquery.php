...
$dd_valor = ($dd_valor !== null && $dd_valor !== '' && is_numeric($dd_valor)) ? (float)$dd_valor : 0;
...
$inicial = ($inicial !== null && $inicial !== '') ? max(0, (int)$inicial) : 0;
$range = ($range !== null && $range !== '') ? max(1, (int)$range) : 1;
$ordem = ($ordem !== null && $ordem !== '') ? max(1, (int)$ordem) : 1;
