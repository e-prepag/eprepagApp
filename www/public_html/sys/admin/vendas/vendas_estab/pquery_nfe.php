            ...
            <div class="row">
                            ...
                            <td valign="center" bgcolor="#FFFFFF" width="903">
                                <p>
                                    <font face="Arial, Helvetica, sans-serif" size="2" color="#000000">
                                        ...
                                        ?>
                                            <p>
                                                <font color="#FF0000">(Avido: O tamanho do arquivo gerado é maior do que 10Mb, tente diminuir o intervalo das datas)</font>
                                            </p>
                                        <?php
                                        }
                                        ?>
                    ...
                    <div class="row txt-cinza espacamento">
                        <div class="col-md-12 bg-cinza-claro">
                            <table id="table" class="table bg-branco txt-preto fontsize-p">
                                <tr>
                                    <td>
                                        <?php $_SESSION['sqldata'] = $sql_transform;
                                        if ($total_table > 0) { ?>
                ...
                <td bgcolor="<?php echo $cor1 ?>"><font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><?php echo $pgrow['municipio'] ?></td-->
                                        ...
                                        <td bgcolor="<?php echo $cor1 ?>">
                                            <div align="center"><?php echo $pgrow['canal'] ?></div>
                                        </td>
                                        <td bgcolor="<?php echo $cor1 ?>">
                                            <div align="center"><?php echo $pgrow['opr_nome'] ?></div>
                                        </td>
                                        <td bgcolor="<?php echo $cor1 ?>">
                                            <div align="center"><?php echo ($pgrow['trn_nome']); ?></div>
                                        </td>
                                        <td bgcolor="<?php echo $cor1 ?>">
                                            <div align="center"><?php echo ($pgrow['trn_cpf']); ?></div>
                                        </td>
                                        <td bgcolor="<?php echo $cor1 ?>">
                                            <div align="right"><?php echo $pgrow['qtde_itens'] ?></div>
                                        </td>
                                        <td bgcolor="<?php echo $cor1 ?>" title="<?php echo number_format($pgrow['trn_valor'], 2, ',', '.') ?>">
                                            <div align="right"><?php echo number_format($valor_da_venda, 2, ',', '.') ?></div>
                                        </td>
                                        <td bgcolor="<?php echo $cor1 ?>">
                                            <div align="center"><?php echo $pgrow['endereco'] ?></div>
                                        </td>
                                        <td bgcolor="<?php echo $cor1 ?>">
                                            <div align="center"><?php echo $pgrow['bairro'] ?></div>
                                        </td>
                                        <td bgcolor="<?php echo $cor1 ?>">
                                            <div align="center"><?php echo $pgrow['cidade'] ?></div>
                                        </td>
                                        <td bgcolor="<?php echo $cor1 ?>">
                                            <div align="center"><?php echo $pgrow['CEP'] ?></div>
                                        </td>
                                    </tr>
                                <?php
                                    if ($cor1 == $cor2)
                                ...
                                if (!$valor) { ?>
                                    <tr bgcolor="#f5f5fb">
                                        <td colspan="14" bgcolor="<?php echo $cor1 ?>">
                                            <div align="center">
                                ...
                                <?php  } else { ?>
                                    <tr bgcolor="#E4E4E4">
                                        <td colspan="8" align="right">
                                            <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><strong><?php echo LANG_PINS_SUBTOTAL; ?>&nbsp;</strong></font>
                                        </td>
                                        <td>
                                            <div align="right">
                                    ...
                                    <tr bgcolor="#E4E4E4">
                                        <td colspan="8" align="right">
                                            <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><strong><?php echo LANG_PINS_TOTAL; ?>&nbsp;</strong></font>
                                        </td>
                                        <td>
                                            <div align="right">
                                    ...
                                    <tr bgcolor="#E4E4E4">
                                        <td colspan="10" bgcolor="#FFFFFF"><strong>
                                                <?php echo LANG_PINS_LAST_MSG; ?>. </strong></font>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="52" colspan="10" bgcolor="#FFFFFF">
                                            <p>
                                                <font size="1" face="Arial, Helvetica, sans-serif" color="#666666"><?php echo LANG_POS_SEARCH_MSG . " " . number_format($time, 2, '.', '.') . " " . LANG_POS_SEARCH_MSG_UNIT ?>
                                                    <br>
                                                    <a href="#header">Top</a>
                                                </font>
                                            </p>
