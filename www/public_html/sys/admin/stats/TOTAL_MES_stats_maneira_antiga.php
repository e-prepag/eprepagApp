...
if($_REQUEST['btnSubmit']) {
	...
	*/
			...
			for($j=0;$j<count($aCanais);$j++) {
				...
				$perc_NVendas_nesteMes = ($aNVendas[$aCanais[$j]][1]) ? 100*($nvendasPrj_nestemes-$aNVendas[$aCanais[$j]][1])/$aNVendas[$aCanais[$j]][1] : 0;
				$perc_Vendas_nesteMes = ($aVendas[$aCanais[$j]][1]) ? 100*($vendasPrj_nestemes-$aVendas[$aCanais[$j]][1])/$aVendas[$aCanais[$j]][1] : 0;
			...
			$perc_NVendas_nesteMes = ($aNVendasMes[1]) ? 100*($nvendasPrj_nestemes-$aNVendasMes[1])/$aNVendasMes[1] : 0;
			$perc_Vendas_nesteMes = ($aVendasMes[1]) ? 100*($vendasPrj_nestemes-$aVendasMes[1])/$aVendasMes[1] : 0;
