...
$where		= "";
//echo "INICIO [$tf_data_inicial] - FIM [$tf_data_final]<br>";
...
if(empty($tf_data_final)) {
	$dtfaux = explode('/',$tf_data_inicial);
	$tf_data_final = date("d/m/Y", mktime(0, 0, 0, $dtfaux[1]-1, $dtfaux[0], $dtfaux[2]));
}
else {
...
<div class="container-fluid">
    <div class="container txt-azul-claro bg-branco txt-cinza">
        ...
        <div class="row txt-cinza top10">
            ...
            <div class="col-md-3">
                <input name="tf_data_final" type="text" class="form-control pull-left" id="tf_data_final" value="<?php echo $tf_data_final ?>" size="9" maxlength="10">
            </div>
            <div class="col-md-2">
                <span class="pull-right">Data Atual (<?php diasemana($data_inicial);?>)</span>
            </div>
            <div class="col-md-3">
                 <input name="tf_data_inicial" type="text" class="form-control pull-left" id="tf_data_inicial" value="<?php echo $tf_data_inicial ?>" size="9" maxlength="10">
            </div>
            <div class="col-md-2">
...
<br>
<?php
//echo $periodo1." ============================================ ".$data_inicial."<br>";
// resgato o total de vendas por operadoras
if(!$data_inicial){
    $dtfaux = explode('/',date("d/m/Y"));
    $data_inicial = date("Y-m-d", mktime(0, 0, 0, $dtfaux[1]-1, $dtfaux[0], $dtfaux[2]));
    $data_final = date("Y-m-d");
}

$rss = bcgGenerator_receita($statuspgto, $canais, $fpgto, $data_final, $data_inicial, $connid, $itensgeral, $groupgeral, $itensespec, $groupespec, $where, $itensespec2, $tipoconsulta);
...
//echo $periodo2." ============================================ ".$data_final."<br>";
// resgato o total de vendas por operadoras no periodo anterior 
$rss = bcgGenerator_receita($statuspgto, $canais, $fpgto, $data_final, $data_inicial, $connid, $itensgeral, $groupgeral, $itensespec, $groupespec, $where, $itensespec2, $tipoconsulta, $periodo);
$tot = ($rss) ? pg_num_rows($rss) : 0;
if($tot > 0) {
	while($vlr=pg_fetch_array($rss)) {
...
if($flagvazio != 1) {
	?>
 <table width="600px" border="0" align="center" cellpadding="0" cellspacing="1"  style="font:Arial, Helvetica, sans-serif; font-size:12px; border:thin; border-color:#CCCCCC; height:auto;">
  <tr>
  ...
  <form name="index2" id="index2">
    <table border="0" align="center" cellpadding="0" cellspacing="1"  style="font:Arial, Helvetica, sans-serif; font-size:12px; border:thin; border-color:#CCCCCC; width:100px; height:auto;"> 
        <tr style="background-color:#E3E6F0; font:Arial, Helvetica, sans-serif; font-size:12px;">
...
<td valign="top" align="center">
	<div id="dados" style="position:relative; top:60px; left: 380px; width:100px; height:1px;" align="left"></div>
    <div id="explicacao" style="position:relative; top:170px; left: 380px; width:170px; height:1px;" class="texto" align="justify">
