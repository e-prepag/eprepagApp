...
<html>
<head>
    <title> <?php echo LANG_STATISTICS_TITLE_3; ?> </title>
...
<div class="container-fluid">
    <div class="container txt-azul-claro bg-branco txt-cinza">
        <div class="row">
            <div class="col-md-12 ">
                <strong><h3><?php echo LANG_STATISTICS_PAGE_TITLE_4; ?> <?php if(strlen($dd_operadora_nome)>0) echo "<font color='#337ab7'>".$dd_operadora_nome."</font> ";?> - <?php echo LANG_STATISTICS_PAGE_TITLE_2; ?> (<?php echo get_current_date()?>)</h3></strong>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills">
                    ...
                    <li role="presentation"><a href="#Totalporcidade"><?php echo LANG_STATISTICS_FOR_CITY; ?></nobr></a>
<?php
		if($_SESSION["tipo_acesso_pub"]!='PU')
                {
?>
...
//echo "sql: $sql<br>";
	...
	echo "<a name='Totalpormes'></a><table class='txt-cinza' border='1' cellpadding='0' cellspacing='1' bordercolor='#cccccc' style='border-collapse:collapse;'>";
	...
	if($vendas_estado && $b_show_listings) {
		while ($vendas_estado_row = pg_fetch_array($vendas_estado)){
...
//echo "sql: $sql<br>";
	...
	echo "<tr bgcolor='#CCFFCC'><td align='right' colspan='2'><a name='Totais'></a><b>Total</b></td><td align='center'><b>".$n_vendas_total."</b></td><td align='center'><b>".number_format(($total_vendas), 2, ',', '.')."</b> <br><b>";
	if($_SESSION["tipo_acesso_pub"]=='PU') {
...
//echo "sql: ".$sql."<br>";
	...
	echo "<tr><th align='center' colspan='4'><b><font color='#337ab7'>".LANG_STATISTICS_TOTAL." ".$dd_operadora_nome." ".LANG_STATISTICS_FOR_GAME." (".(($vendas_estado) ? pg_num_rows($vendas_estado) : 0)." ".LANG_STATISTICS_GAME_1.") ".LANG_STATISTICS_THIS_MONTH."</font></b></th></tr>";
	echo "<tr bgcolor='#99CCFF'><td align='center'>".LANG_STATISTICS_GAME."</td><td align='center'>".LANG_STATISTICS_SALES_NUMBER."</td><td align='center'>".LANG_STATISTICS_SALES_VALUE." (".LANG_STATISTICS_IN." R\$)</td><td align='center'>% ".LANG_STATISTICS_IN_VALUE."</td></tr>";
	if($vendas_estado && $b_show_listings) {
		$valtmp = 0;
		$ntmp = 0;
		while ($vendas_estado_row = pg_fetch_array($vendas_estado)){
			$bg_col = ($bg_col==$bg_col_01)?$bg_col_02:$bg_col_01;
			$nome_jogo = $vendas_estado_row['ve_jogo'];
			echo "<tr bgcolor='".$bg_col."'><td align='center'>".$nome_jogo."</td><td align='center'>".$vendas_estado_row['n']."</td><td align='center'>".number_format(($vendas_estado_row['vendas']), 2, ',', '.')."</td><td align='center'>".number_format(100*($vendas_estado_row['vendas'])/(($total_vendas_neste_mes==0)?1:$total_vendas_neste_mes), 2, ',', '.')."</td></tr>";
			$previous_value = $vendas_estado_row['vendas'];
			$valtmp += $vendas_estado_row['vendas'];
			$ntmp += $vendas_estado_row['n'];
		}
		echo "<tr bgcolor='#FFFFCC'><td align='center'><b>Total</b></td><td align='center'><b>".$ntmp."</b></td><td align='center'><b>".number_format(($valtmp), 2, ',', '.')."</b></td><td>&nbsp;</td></tr>";
	} else {
		echo "<tr bgcolor='".$bg_col."'><td align='center' colspan='5'><font color='#FF0000'>".LANG_NOT_FOUND_2."&nbsp;</font></td></tr>";
	}
	echo "</table><br>";
...
//echo "pg_num_rows(vendas_estado): ".pg_num_rows($vendas_estado)."<br>";
		...
		echo "<a name='Totalporusuario'><table class='txt-cinza' border='1' cellpadding='0' cellspacing='1' bordercolor='#cccccc' style='border-collapse:collapse;'>";
		echo "<tr><th align='center' colspan='7'><b><font color='#337ab7'>".LANG_STATISTICS_TOTAL." ".$dd_operadora_nome." ".LANG_STATISTICS_FOR_USER." ($n_total_usuarios_compra usuários, ".number_format((100*(($vendas_estado)?pg_num_rows($vendas_estado):"0")/(($n_cadastros>0)?$n_cadastros:1)), 2, ',', '.')."% ".LANG_STATISTICS_OF_REGISTER.") [".date("d/M/Y",strtotime($data_min)).", ".date("d/M/Y",strtotime($data_max))."]</font></b></th></tr>";
		echo "<tr bgcolor='#99CCFF'><td align='center'>".LANG_STATISTICS_USER."</td><td align='center'>1<sup>a</sup>-".LANG_STATISTICS_LAST_SALES."</td><td align='center'>".LANG_STATISTICS_NUMBER_OF."<br>".LANG_STATISTICS_SALES_2."</td><td align='center'>". LANG_STATISTICS_SALES_2."<br>(".LANG_STATISTICS_IN." R\$)</td><td align='center'>%</td></tr>";
		...
		if($vendas_estado && $b_show_listings) {
			...
			while ($vendas_estado_row = pg_fetch_array($vendas_estado)){
				if($i<$imax_full) {
					...
					$bg_col = ($previous_value!=$vendas_estado_row['vendas'])?(($bg_col==$bg_col_01)?$bg_col_02:$bg_col_01):$bg_col;
					echo "<tr bgcolor='".$bg_col."'><td align='left'>".$i." - ".$vendas_estado_row['ve_nome']."</td><td align='center'> ".get_delay_alert_live($vendas_estado_row['primeira_venda'], $vendas_estado_row['ultima_venda'])." </td><td align='center'>".$vendas_estado_row['n']."</td><td align='center'>".number_format(($vendas_estado_row['vendas']), 2, ',', '.')."</td><td align='center'>".number_format(100*($vendas_estado_row['vendas'])/(($total_vendas==0)?1:$total_vendas), 2, ',', '.')."</td></tr>";
				}
				$i++;
				$previous_value = $vendas_estado_row['vendas'];
			}
		...
		if($i>=$imax_full) {
			echo "<tr bgcolor='".$bg_col."'><td align='center' colspan='5'><font color='#FF0000'>Total de registros não listados:&nbsp;".($i-$imax_full)."</font></td></tr>";
		}
		echo "</table><br>";
...
//echo "sql: $sql<br>";
		...
		echo "<tr><th align='center' colspan='7'><b><font color='#337ab7'>".LANG_STATISTICS_TOTAL." ".$dd_operadora_nome." ".$dd_operadora_nome." ".LANG_STATISTICS_FOR_USER." (".(($vendas_estado)?pg_num_rows($vendas_estado):"0")." ".LANG_STATISTICS_USERS.")  (<font color='#FF0000'>último mês desde ".date("d/M/Y",$previousmonth)."</font>)</font></b></th></tr>";
		...
		if($vendas_estado && $b_show_listings) {
			...
			while ($vendas_estado_row = pg_fetch_array($vendas_estado)){
				if($iorder<$imax_mes) {
					...
					$sarrow = "<img src='../imgs/".(($ipos>0)?"arrow_up_2.gif":(($ipos==0)?"equal.gif":"arrow_down_2.gif"))."' width='12' height='12' border='0' alt='$sarrow_alt'>";

//	<td align='center'> ".date("d/M/Y",strtotime($vendas_estado_row['primeira_venda']))." - ".date("d/M/Y",strtotime($vendas_estado_row['ultima_venda']))." </td>
					echo "<tr bgcolor='".$bg_col."'><td align='left'>".$iorder." - ".$vendas_estado_row['ve_nome']."</td><td align='center'>".$sarrow.(($ipos>0)?"+":(($ipos==0)?"&nbsp;":"")).$ipos."</td><td align='center'>".$vendas_estado_row['n']."</td><td align='center'>".number_format(($vendas_estado_row['vendas']), 2, ',', '.')."</td><td align='center'>".number_format(100*($vendas_estado_row['vendas'])/(($total_vendas==0)?1:$total_vendas), 2, ',', '.')."</td></tr>";
				}
				$iorder++;
				$previous_value = $vendas_estado_row['vendas'];
		...
		if($iorder>=$imax_mes) {
			echo "<tr bgcolor='#CCFFCC'><td align='right' colspan='2'><b>Total de registros não listados: </b>&nbsp;</td><td align='center'>".($iorder-$imax_mes)."</td><td align='center'>&nbsp;</td><td align='center'>&nbsp;</td></tr>";
		}
...
//echo "sql: $sql<br>";
		...
		echo "<tr><th align='center' colspan='7'><b><font color='#337ab7'>".LANG_STATISTICS_TOTAL." ".$dd_operadora_nome." ".$dd_operadora_nome." ".LANG_STATISTICS_FOR_USER." (".(($vendas_estado)?pg_num_rows($vendas_estado):"0")." ".LANG_STATISTICS_USERS.")  (<font color='#FF0000'>".LANG_STATISTICS_LAST_WEEK_SINCE." ".date("d/M/Y",$previousweek)."</font>)</font></b></th></tr>";
		echo "<tr bgcolor='#99CCFF'><td align='center'>".LANG_STATISTICS_USER."</td><td align='center'>&nbsp;Pos.&nbsp;</td><td align='center'>".LANG_STATISTICS_SALES_NUMBER."</td><td align='center'>".LANG_STATISTICS_SALES_VALUE."  (".LANG_STATISTICS_IN." R\$)</td><td align='center'>% ".LANG_STATISTICS_IN_VALUE."</td></tr>";
		if($vendas_estado && $b_show_listings) {
			$iorder = 0;
			while ($vendas_estado_row = pg_fetch_array($vendas_estado)){
				if($iorder<$imax_semana) {
					$bg_col = ($previous_value!=$vendas_estado_row['vendas'])?(($bg_col==$bg_col_01)?$bg_col_02:$bg_col_01):$bg_col;
					$ipos = getPositionInArray("M", $vendas_estado_row['ve_nome'], $iorder, $a_vendas_ultimo_mes);
					$sarrow_alt = (($ipos>0)?"Up":(($ipos==0)?"Equal":"Down"));
					$sarrow = "<img src='../imgs/".(($ipos>0)?"arrow_up_2.gif":(($ipos==0)?"equal.gif":"arrow_down_2.gif"))."' width='12' height='12' border='0' alt='$sarrow_alt'>";
...
//echo "<br>OK<br>";
		if($iorder>=$imax_semana) {
			echo "<tr bgcolor='#CCFFCC'><td align='right' colspan='2'><b>Total de registros não listados: </b>&nbsp;</td><td align='center'>".($iorder-$imax_semana)."</td><td align='center'>&nbsp;</td><td align='center'>&nbsp;</td></tr>";
		}
