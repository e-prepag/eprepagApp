...
$fpin = $_REQUEST['fpin'] ?? null;
$fserial = $_REQUEST['fserial'] ?? null;
...
$dd_pins_com_vendas = $_REQUEST['dd_pins_com_vendas'] ?? null;
$dd_pins_vendas = $_REQUEST['dd_pins_vendas'] ?? null;
$tf_pins = $_REQUEST['tf_pins'] ?? null;
$tf_loteopr = $_REQUEST['tf_loteopr'] ?? null;
$dd_status = $_REQUEST['dd_status'] ?? null;
$tf_valor_total = $_REQUEST['tf_valor_total'] ?? null;
										...
										?>
											<tr class="trListagem">
												<td class="text-center">
													<form method="POST" action="situacao_detalhe.php" target="_blank" style="margin: 0;">
														<input type="hidden" name="PinCod" value="<?php echo $pgrow['pin_codinterno']; ?>">
														<input type="hidden" name="PinStatus" value="<?php echo $pgrow['pin_status']; ?>">
														<button type="submit" class="btn btn-link" style="padding: 0; border: none; background: none;"><?php echo mascarar_pin_id($pgrow['pin_codinterno']); ?></button>
													</form>
												</td>
