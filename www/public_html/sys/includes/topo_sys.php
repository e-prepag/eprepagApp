...
<body>
            ...
            <div class="col-md-3">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <img src="<?php echo $webstring ?>/sys/imagens/flg/flag_brasil.gif" width="29" height="18" border="0" title="Portugu�s - Brasil" onClick="changeLang('pt');">&nbsp;
    ...
    <center>
        ...
        // mudan�a devido novo relatorio de chargeback
        ...
        function salvar_log_admin($pdo, $usuario_id, $tipo_usuario, $blacklist = null)
        {
            ...
            function utf8ize($mixed)
            {
                if (is_array($mixed)) {
                    ...
                    // remove caracteres inv�lidos e converte para UTF-8
                    return mb_convert_encoding($mixed, 'UTF-8', 'UTF-8');
                } else {
                    return $mixed;
                }
            }
            // --- Fun��o auxiliar para mascarar valores recursivamente ---
