...
@define('LANG_HOME_ITEM_SUPPLY_PINS', 'Supply');
@define('LANG_CHARGEBACK', 'Chargeback Report');
@define('LANG_HOME_ITEM_REPORT_PINS', 'Sales Report');
...
@define('LANG_HOME_ITEM_SUPPLY_CARTOES', 'Supply');
@define('LANG_HOME_ITEM_EDIT_CARTOES', 'Edit Card Registers');
@define('LANG_HOME_ITEM_ATIVACAO_CARTOES', 'Send Card Activation Report');
@define('LANG_HOME_ITEM_EDIT_BOLETO_CARTOES', 'Edit Billet Registers');
@define('LANG_HOME_ITEM_REPORT_CARTOES', 'Sales Report');
...
@define('LANG_HOME_SECTION_SALES_LOADS', 'Load Sale Data');
...
@define('LANG_HOME_ITEM_SALES_STATS_TOTAL', 'Show Total Sale Statistics');
@define('LANG_HOME_ITEM_SALES_STATS_TOTAL_POR_MES', 'Show Total Sale Statistics by Month');
...
@define('LANG_HOME_ITEM_SALES_STATS_TOTAL_POR_DIA', 'Show Total Sale Statistics by Day');

@define('LANG_HOME_ITEM_TAB_STATS', 'Tab stats (Homologation)');
@define('LANG_HOME_ITEM_SALES_STATS_POS', 'Show POS Sale Statistics');
@define('LANG_HOME_ITEM_SALES_STATS_MONEY', 'Show Money Sale Statistics');
@define('LANG_HOME_ITEM_SALES_STATS_MONEY_EXPRESS', 'Show Express Money Sale Statistics');
@define('LANG_HOME_ITEM_SALES_STATS_SITE', 'Show Site Sale Statistics');
@define('LANG_HOME_ITEM_SALES_STATS_LH_MONEY', 'Show LH Money Sale Statistics');
@define('LANG_HOME_ITEM_SALES_STATS_LH_MONEY_EXPRESS', 'Show LH Express Money Sale Statistics');
@define('LANG_HOME_ITEM_SALES_STATS_CARDS', 'Show Cards Sale Statistics');
...
@define('LANG_STOCK_PAGE_TITLE', 'Supply');
@define('LANG_STOCK_LINK_TITLE_1', 'Search Pin´s Supply');
@define('LANG_STOCK_LINK_TITLE_2', 'Search Pin´s Status');
...
@define('LANG_PINS_OPERATOR', 'Operator');
@define('LANG_PINS_USER', 'User');
@define('LANG_PINS_ALL_OPERATORS', 'All Operators');
@define('LANG_PINS_ALL_VALUES', 'All Values');
@define('LANG_PINS_QUANTITY', 'Amount');
@define('LANG_PINS_AVARAGE_DAILY_1', 'Mediun Day');
@define('LANG_PINS_AVARAGE_DAILY_2', 'Last Week');
@define('LANG_PINS_DURATION', 'Time');
@define('LANG_PINS_FACE_VALUE', 'Face Value');
@define('LANG_PINS_TOTAL_VALUE', 'Total Value');
@define('LANG_PINS_TOTAL_COMISSAO', 'Commission');
@define('LANG_PINS_NO_PINS', 'PINS');
@define('LANG_PINS_NO_PINS_FOUND', 'PIN Not Found');
@define('LANG_PINS_AVARAGE_OF', 'Mediun');
@define('LANG_PINS_DAYS', 'Days');
@define('LANG_PINS_TIME_1', 'Term');
@define('LANG_PINS_TIME_2', 'Terms');
@define('LANG_PINS_START_DATE', 'Start Date');
@define('LANG_PINS_END_DATE', 'Final Date');
...
@define('LANG_PINS_REPORT_TYPE', 'Type Report');
...
@define('LANG_PINS_PAGE_TITLE_2', 'Sales Report of Year (Site+POS)');
@define('LANG_PINS_PAGE_TITLE_3', 'Sales Report of Month (Site+POS)');
@define('LANG_PINS_PAGE_TITLE_4', 'Sales Report of Day (Site+POS)');
...
@define('LANG_CARDS_OPERATOR', 'Operator');
@define('LANG_CARDS_VALUE', 'Value');
@define('LANG_CARDS_TOTAL_VALUE', 'Total Value');
@define('LANG_CARDS_ALL_USERS', 'All Users');
@define('LANG_CARDS_ALL_CHANNELS', 'All Channels');
@define('LANG_CARDS_ALL_OPERATORS', 'All Operators');
...
@define('LANG_CARDS_END_DATE', 'Final Date');
...
@define('LANG_POS_OPERATOR', 'Operator');
@define('LANG_POS_ALL_OPERATOR', 'All Operators');
...
@define('LANG_REPORTS_OPERATOR', 'Operator');
@define('LANG_REPORTS_ALL_OPERATOR', 'All Operators');
...
@define('LANG_REPORTS_TOTAL_VALUE', 'Total Value');
...
@define('LANG_REPORTS_LAST_MSG_2', 'Note: The values of projections are calculated by adding the value achieved in the current month and the average of the last months, versus the days remaining to complete the current month.');
...
@define('LANG_STATISTICS_OPERATOR', 'Operator');
...
@define('LANG_STATISTICS_TOTALS', 'Totals');
@define('LANG_STATISTICS_THIS_MONTH', 'this month');
...
@define('LANG_STATISTICS_SALES', 'Sale');
...
@define('LANG_STATISTICS_PAGE_TITLE_8', 'Total Data Sales');
...
@define('LANG_STATISTICS_INFO_MSG_1', 'The column "Projection in 30 days" and "Projection EPP in 30 days" uses');
@define('LANG_STATISTICS_INFO_MSG_2', 'The column "Projection in 30 days" uses');
@define('LANG_STATISTICS_INFO_MSG_3', 'the value vendido in the month until today more the projection for the remaining days from the average of last the 2 months (or less, if it will not have given enough).');
@define('LANG_STATISTICS_INFO_MSG_4', 'Note');
@define('LANG_STATISTICS_INFO_MSG_5', 'The values of projections are calculated by adding the value achieved in the current month and the average of the last months, versus the days remaining to complete the current month');
@define('LANG_STATISTICS_SEARCH_MSG', 'Search done in');
...
@define('LANG_STATISTICS_PAGE_TITLE_8', 'for Month - Statistics');
...
@define('LANG_COMMISSIONS_INFO_MSG_2', 'The values of projections are calculated by adding the value achieved in the current month and the average of the last months, versus the days remaining to complete the current month');
...
@define('LANG_NO_DATA', 'Not Have Registers');
