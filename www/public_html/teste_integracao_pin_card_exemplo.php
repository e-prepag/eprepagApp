...
$data_nascimento= isset($_POST['data_nascimento'])	? (int) $_POST['data_nascimento']	: null;
        ...
        <table width="100%" border='0' cellpadding="2" cellspacing="1">
          <tr>
            ...
            <td width="70%" colspan="2" bgcolor="#f5f5fb"><font color="#666666" size="2" face="Arial, Helvetica, sans-serif">
		        <input name="ID" id="ID" type="text" value="<?php echo $id; ?>" size="2" maxlength="3" onKeypress="return verifica();">
              </font></td>
          </tr>
		  <tr bgcolor="#F5F5FB">
          ...
          <tr bgcolor="#F5F5FB">
            <td width="30%" bgcolor="#00008C"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><b> CPF: </b></font></td>
            <td width="70%" colspan="2" bgcolor="#f5f5fb"><font color="#666666" size="2" face="Arial, Helvetica, sans-serif">
                    <input name="CPF" id="CPF" type="text" value="<?php echo $action; ?>" size="15" maxlength="15">
            </font></td>
          </tr>
          <tr bgcolor="#F5F5FB">
            <td width="30%" bgcolor="#00008C"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><b> DATA NASCIMENTO: </b></font></td>
            <td width="70%" colspan="2" bgcolor="#f5f5fb"><font color="#666666" size="2" face="Arial, Helvetica, sans-serif">
                    <input name="data_nascimento" id="data_nascimento" type="text" value="<?php echo $data_nascimento; ?>" size="15" maxlength="15">
            </font></td>
          </tr>
          <tr bgcolor="#F5F5FB">
