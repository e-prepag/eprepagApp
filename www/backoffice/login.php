...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="document.formLog.user.focus()">
  ...
  <table width="779" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
                    ...
                    <tr>
                      <td align="center">
                        <font size="2" face="Arial, Helvetica, sans-serif" color="#FF0000">
                          ...
                          switch ($_GET['erro']) {
                            case 1:
                              echo "<b>Cadastro de autenticador necess�rio</b>";
                              break;
                            case 2:
                              echo "<b>Usu�rio inv�lido</b>";
                              break;
                            case 3:
                              echo "<b>Imposs�vel</b>";
                              break;
                            case 4:
                              echo "<b>Token inv�lido</b>";
                              break;
                          }
                          ?>
                        </font>
    ...
    <tr>
      ...
      <td width="300">
        <div align="right" class="text-info"><b>Vers�o <?php echo $major_version . "." . $minor_version . "." . $release . "." . $build ?></b></div>
      </td>
    </tr>
  </table>
  ...
  <script type="text/javascript">
    $(function() {
      $("#formLog").submit((e) => {
        ...
        // Envia os dados do formul�rio via AJAX para ajax_login_aut.php, exibe o resultado no body e chama o modal
        $.ajax({
