...
<html>
    <head>
		...
		<link href="<?php echo $url; ?>:<?php echo $server_port ;?>/css/dashboard.css" rel="stylesheet" type="text/css" />
		...
		<link rel="icon" href="<?php echo $server_url_ep ;?>/favicon.ico" type="image/x-icon">
		<link rel="shortcut icon" href="<?php echo $server_url_ep ;?>/favicon.ico" type="image/x-icon">
...
if ((strpos($urlVerifica, '/dashboard/pdv/index.php') !== false || strpos($urlVerifica, '/dashboard/pdv/index2.php') !== false) || strpos($urlVerifica, '/dashboard/usuario/index.php') !== false) {
    echo ' <div class="container-fluid2 bg-cinza-claro topo-h">
        ...
        <div class="container-fluid3 borda-top-verde bg-info h-navbar">
            <div class="containerDashboard">
    ...
    if(isset($allAbas)){
        foreach($allAbas as $aba){
            ...
            echo '<li class="'.$active.'"><a href="#" class="muda-aba" ordem="'.$aba->getOrdem().'">'.$aba->getDescricao().'</a></li>';
        }
    }
    ...
    echo '<div class="container-fluid bg-cinza-claro topo-h">
            <div class="container">
                <div class="row top20">
                    <div class="col-md-3">
                        <a href="/" class="">
