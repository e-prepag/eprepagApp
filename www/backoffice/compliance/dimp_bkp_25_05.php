            ...
            if ($response_epp_adm) {
                ...
                while ($response_epp_adm_row = pg_fetch_array($response_epp_adm)) {
                    ...
                    $vetorLines = array (
                                        ...
                                        5 => array('name' => $response_epp_adm_row['opr_endereco'].', '.$response_epp_adm_row['opr_numero'].((!empty($response_epp_adm_row['opr_complemento']))?' - '.$response_epp_adm_row['opr_complemento']:"").((!empty($response_epp_adm_row['opr_bairro']))?' - '.$response_epp_adm_row['opr_bairro']:"").' - '.$response_epp_adm_row['opr_cidade'],

                                                   'size' => 200

                                                   ),

                                        6 => array('name' => str_pad(str_replace(" ","",str_replace("-","",str_replace(".", "", $response_epp_adm_row['opr_cep']))),8,"0",STR_PAD_LEFT),
                                        ...
                                        8 => array('name' => ((!empty($response_epp_adm_row['opr_estado']))?$response_epp_adm_row['opr_estado']:$ufEPP),
