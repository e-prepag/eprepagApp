...
//Diret�rio destino do arquivo do OFAC
...
if(isset($BtnConcluir) && $BtnConcluir) {
        ...
        if($msg == ""){
                ...
                if (!move_uploaded_file($fileSource, $fileDest)) $msg = "N�o foi possivel copiar para o diret�rio destino: {$erroSistema['message']}".PHP_EOL; 
        ...
        //Verificando se o arquivo j� foi importado
        if($msg == ""){
            ...
            if(!file_exists($GLOBALS['DIR_OFAC_ARQ_RETORNO']."/".$data_arquivo_ofac)) {
                ...
                $msg = "Arquivo j� importado anteriormente".PHP_EOL;
                $success = true;
            }//end else 
        }//end 
        ...
        if($msg == ""){
		    ...
		    $msg_aux = "Data da gera��o dos Dados Considerados: ".$data_dados_considerados."<br> Total de Registros: ".$total_de_registros."<br>"; //."<pre>".print_r($xml,true)."</pre>";
                    $i = 1;
                    ...
                    if($total_de_registros != ($i-1)) {
                        $msg = "Quantidade de registros diferente do total informado no cabe�alho do arquivo".PHP_EOL;
                    }
        ...
        if($msg == ""){
                ...
                for($i = 0; $i < $numeroArquivos; $i++) {
                    ...
                    //echo "Arquivo carregado [".$fileSource."]<br>Arquivo destino [".$fileDest."]<br>";
                    if (!rename($fileSource, $fileDest)) $msg = "N�o foi possivel copiar para o diret�rio destino.".PHP_EOL; 
                    else if(!file_exists($fileDest)) $msg = "Arquivo no destino esta vazio ou inv�lido.".PHP_EOL;
                    if(file_exists($fileSource)) unlink($fileSource);
                }//end for
        ...
        if($msg == ""){
                $success = true;
                $msg = "Opera��o efetuada com sucesso!".PHP_EOL."Arquivos validados e registros salvos no Banco de Dados.".PHP_EOL; 
        }
    ...
    <script>
        function fcnOnSubmit(){
            if(form1.arquivo.value==''){
                ...
                return confirm('O arquivo demorar� a ser processado.\nPor favor, N�O FECHE a tela acreditando que o programa travou!');
            }
        }
    </script>
