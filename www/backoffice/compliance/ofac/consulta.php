...
if(isset($BtnSearch) && $BtnSearch) {
        ...
        $sql = "
                SELECT to_char(data,'DD/MM/YYYY') as data_formatada,* 
                FROM ofac 
                WHERE 
        ...
        if(!$rs) {
                $msg .= "ERRO: Problema na seleção de dados na tabela OFAC.<br>";
        }//end if(!$rs) 
    ...
    <form id="buscaNome" name="buscaNome" method="post" onsubmit="return fcnOnSubmit();">
        <div class="col-md-6">
            <div class="form-group">
                <label for="dd_nome">Nome ou Parte de Nome para Consulta OFAC:</label>
    ...
    <table id="table" class="table bg-branco txt-preto fontsize-p">
        ...
        ?>
                <tr class="trListagem"> 
                    ...
                    <td><?php echo $rsRow['tipo_dado']; ?></td>
