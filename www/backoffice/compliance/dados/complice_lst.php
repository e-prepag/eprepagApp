                        ...
                        <form id="form1" name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><div align="right">M�s dos Dados de Complice: </div></td>
                                    <td><select name="mes" id="mes" class="combo_normal">
                                                <option value="" >Todos os M�ses</option>
                                        <?php
...
$sql = "SELECT
		...
		'<nobr>'||(case when (c_custo_mkt_credenciado > 0 AND c_custo_risco_credenciador > 0
                            ...
                            then 'Todos os Dados Preenchidos' else 'Faltam Dados � Preencher' end)||'</nobr>' as dados
	FROM complice ";
if(!isset($sql_aux))
    $sql_aux = null;
