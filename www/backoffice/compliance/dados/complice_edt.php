...
function validaUsuario()
{
    ...
    {
        alert("Favor informar o M�s dos Dados de Complice.");
    ...
    {
        alert("Favor informar Custo de Inadimpl�ncia do Emissor.");
...
{
	var reTipo = '(^[0-9.,]+$)'; // � a express�o regular apropriada
	if (!reTipo.test(pVal)&&(pVal!=''))
	{
		alert(pVal + " N�O cont�m apenas d�gitos.");
		return false;
	}
	else return true;
}
...
{
	var reTipo = /^\d+$/; // � a express�o regular apropriada
	if (!reTipo.test(pVal)&&(pVal!=''))
	{
		alert(pVal + " N�O cont�m apenas d�gitos.");
		return false;
                ...
                <tr>
                    <td colspan="3">
                        <div id='info_c_receita_outras_credenciador' name='info_c_receita_outras_credenciador' onclick='javascript:$("#info_c_receita_outras_credenciador").hide("slow");'>
                            <fieldset>
                                <legend>Detalhes</legend>
                                - Receitas provenientes dos servi�os de gerenciamento de contas prestados aos estabelecimentos credenciados, tais como segunda via de extrato, etc.<br>
                    ...
                    <td colspan="3">
                        <div id='info_c_custo_mkt_credenciado' name='info_c_custo_mkt_credenciado' onclick='javascript:$("#info_c_custo_mkt_credenciado").hide("slow");'>
                            <fieldset>
                                ...
                                - Custo sobre as vendas (sal�rios dos vendedores, comiss�o paga aos emissores pela captura de novos clientes, etc.)<br>
                                - Custo de gerenciamento de vendas<br>
                                - Custo de promo��es para estimular uso dos cart�es de pagamento na rede
                            </fieldset>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        <div id='info_c_custo_risco_credenciador' name='info_c_custo_risco_credenciador' onclick='javascript:$("#info_c_custo_risco_credenciador").hide("slow");'>
                            <fieldset>
                                <legend>Detalhes</legend>
                                - Custo de gerenciamento dos riscos incorridos no processamento de afilia��o de estabelecimentos e nos processos de tomada de decis�o<br>
                                - Custo com chargebacks<br>
                                - Assun��o de falha de inadimpl�ncia de banco emissor, se for o caso
                            </fieldset>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        <div id='info_c_custo_outros_credenciador' name='info_c_custo_outros_credenciador' onclick='javascript:$("#info_c_custo_outros_credenciador").hide("slow");'>
                            <fieldset>
                                <legend>Detalhes</legend>
                                - Custo incorrido nas atividades e processos referentes ao credenciamentos de novos estabelecimentos, tais como custo de entrada de dados, treinamento de pessoal, instala��o de equipamentos, etc.<br>
                                - Despesas administrativas<br>
                                - Custo com pagamento de impostos diretos (ISS, PIS, Cofins, etc)<br>
                                - Custo de servi�os:<br>
                                &nbsp;&nbsp;- Custo de servi�os a dministrativos (pessoal, material, transporte , etc)<br>
                                &nbsp;&nbsp;- Custo pelos servi�os de concilia��o<br>
                                &nbsp;&nbsp;- Custo do servi�o de help desk de equipamentos, disponibilizado para os estabelecimentos<br>
                                &nbsp;&nbsp;- Custo dos servi�os prestados aos estabelecimentos<br>
                                - Outros custos n�o relacionados anteriormente
                            </fieldset>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        <div id='info_c_custo_processamento_front_end_back_end' name='info_c_custo_processamento_front_end_back_end' onclick='javascript:$("#info_c_custo_processamento_front_end_back_end").hide("slow");'>
                            <fieldset>
                                <legend>Detalhes</legend>
                                - De precia��o dos equipamentos instalados nos estabelecimentos, incluindo perdas e baixas<br>
                                - Custo dos equipamentos instalados nos estabeleciemtos credenciados<br>
                                - Custo de manuten��o dos equipamentos instalados nos estabelecimentos credenciados<br>
                                - Custo referente aos processos de compensa��o e de liquida��o das transa��es com cart�es de pagamentos<br>
                                - Custo como com Sistema de Gerenciamento de info rma��e s?MIS (Management Information System)
                            </fieldset>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        <div id='info_c_receita_mkt_emissor' name='info_c_receita_mkt_emissor' onclick='javascript:$("#info_c_receita_mkt_emissor").hide("slow");'>
                            <fieldset>
                                <legend>Detalhes</legend>
                                Recursos obtidos junto aos credenciadores ou bandeiras, provenientes de repasses para aplica��o em marketing e propaganda
                            </fieldset>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        <div id='info_c_receita_outras_emissor' name='info_c_receita_outras_emissor' onclick='javascript:$("#info_c_receita_outras_emissor").hide("slow");'>
                            <fieldset>
                                <legend>Detalhes</legend>
                                Outras receitas oriundas das atividades de emissor de cart�es de pagamentos, tais como:<br>
                                - Receita de float<br>
                                - Receita de seguros<br>
                                - Receita advinda da ades�o ao programa de pontua��o e da convers�o dos pontos em bens e servi�os<br>
                                - Receita de tarifa por inatividade<br>
                                - Receita com revers�o de chargeback<br>
                                - Outras receitas n�o relacionadas anteriormente( excluindo-se receitas de cr�dito)
                            </fieldset>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        <div id='info_c_custo_processamento_emissor' name='info_c_custo_processamento_emissor' onclick='javascript:$("#info_c_custo_processamento_emissor").hide("slow");'>
                            <fieldset>
                                <legend>Detalhes</legend>
                                Despesas incorridas no processamento de transa��es com cart�es de pagamentos, tais como:<br>
                                - Despesas incorridas no processo de autoriza��o<br>
                                - Despesas incorridas nos processos de confer�ncia de saldos e limites<br>
                                - Despesas com deprecia��o de equipamentos<br>
                ...
                <tr>
                    <td colspan="3">
                        <div id='info_c_custo_mkt_emissor' name='info_c_custo_mkt_emissor' onclick='javascript:$("#info_c_custo_mkt_emissor").hide("slow");'>
                            <fieldset>
                                <legend>Detalhes</legend>
                                Custo com marketing e propaganda relacionados � atividade de emissor de cart�es de pagamentos
                            </fieldset>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>* <a href="javascript:info_c_custo_inadimplencia_emissor();">Custo de Inadimpl�ncia do Emissor</a>: </td>
                    <td>
                ...
                <tr>
                    <td colspan="3">
                        <div id='info_c_custo_inadimplencia_emissor' name='info_c_custo_inadimplencia_emissor' onclick='javascript:$("#info_c_custo_inadimplencia_emissor").hide("slow");'>
                            <fieldset>
                                <legend>Detalhes</legend>
                                Custo com recupera��o de cr�dito por inadimpl�ncia, bem como com o provisionamento para fazer face aos cr�ditos de liquida��o duvidosa, conforme Resolu��o 2.682
                            </fieldset>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        <div id='info_c_custos_outros_emissor' name='info_c_custos_outros_emissor' onclick='javascript:$("#info_c_custos_outros_emissor").hide("slow");'>
                            <fieldset>
                                <legend>Detalhes</legend>
                                Outros custos, em reais, incorridos nas atividades de emissor de cart�es de pagamentos, tais como:<br>
                                - Custo com provis�es civis e trabalhistas<br> 
                                - Custo advindo das atividades de estabelecimento de relacionamento comercial com os portadores do cart�es de pagamentos, tais como centrais de help desk , sistema de gerenciamento de informa��es ? MIS, portal na Internet, etc.<br>
                                - Custo atribu�do � compra ou fabrica��o dos cart�es de pagamento, bem como ao processo de inser��o dos dados no cart�o<br>
                                - Custo referente aos servi�os de postagem ou de entrega dos cart�es de pagamento aos portadores<br>
                                - Custo referente ao processo de cobran�a das faturas encaminhadas aos portadores (postagem, tarifas interbanc�rias, etc.)<br>
                                - Custo com despesas administrativas, incluindo gasto de pessoal<br>
                                - Outros custos n�o relacionados anteriormente<br>
                            </fieldset>
                        </div>
                    </td>
                </tr>
