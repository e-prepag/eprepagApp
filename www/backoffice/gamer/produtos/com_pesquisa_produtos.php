...
$tf_ogp_id = $_POST['tf_ogp_id'] ?? null;
$tf_ogp_ativo = $_POST['tf_ogp_ativo'] ?? null;
$tf_ogp_nome = $_POST['tf_ogp_nome'] ?? null;
$tf_ogp_descricao = $_POST['tf_ogp_descricao'] ?? null;
$tf_ogp_data_inclusao_ini = $_POST['tf_ogp_data_inclusao_ini'] ?? null;
$tf_ogp_data_inclusao_fim = $_POST['tf_ogp_data_inclusao_fim'] ?? null;
$tf_ogp_mostra_integracao = $_POST['tf_ogp_mostra_integracao'] ?? null;
	...
	<tr>
		<td width="891" valign="top">
			<form name="form1" method="post" action="com_pesquisa_produtos.php">
				...
				<table class="table">
					<tr bgcolor="#FFFFFF">
						<td colspan="6" bgcolor="#ECE9D8" class="texto">Produto</font>
						</td>
					</tr>
					<tr bgcolor="#F5F5FB">
						<td width="100" class="texto">Código</font>
						</td>
						<td>
					...
					<tr bgcolor="#F5F5FB">
						<td class="texto">Data de Inclusão</font>
						</td>
						<td class="texto">
						...
						<td class="texto">Exibido (Prod. Integração)</font>
						</td>
						<td>
					...
					<tr bgcolor="#FFFFFF">
						<td colspan="4" bgcolor="#ECE9D8" class="texto">Operadora</font>
						</td>
					</tr>
					<tr bgcolor="#F5F5FB">
					...
					<tr bgcolor="#00008C">
						<td height="11" colspan="3" bgcolor="#FFFFFF">
							<table class="table">
								...
								<tr bgcolor="#ECE9D8">
									<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ogp_id&inicial=" . $inicial . $varsel ?>" class="link_branco">
												<font class="texto">C&oacute;d.
											</a>
											<?php if ($ncamp == 'ogp_id') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
										</strong></td>
									<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ogp_data_inclusao&inicial=" . $inicial . $varsel ?>" class="link_branco">
												<font class="texto">Data de Inclusão</font>
											</a>
											<?php if ($ncamp == 'ogp_data_inclusao') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
										</strong></td>
									<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ogp_ativo&inicial=" . $inicial . $varsel ?>" class="link_branco">
												<font class="texto">Status</font>
											</a>
											<?php if ($ncamp == 'ogp_ativo') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
										</strong></td>
									<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ogp_mostra_integracao&inicial=" . $inicial . $varsel ?>" class="link_branco">
												<font class="texto">Exibido na<br>Integração</font>
											</a>
											<?php if ($ncamp == 'ogp_mostra_integracao') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
										</strong></td>
									<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ogp_nome&inicial=" . $inicial . $varsel ?>" class="link_branco">
												<font class="texto">Nome</font>
											</a>
											<?php if ($ncamp == 'ogp_nome') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
										</strong></td>
									<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=opr_nome&inicial=" . $inicial . $varsel ?>" class="link_branco">
												<font class="texto">Operadora</font>
											</a>
											<?php if ($ncamp == 'opr_nome') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
										</strong></td>
									<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=opr_status&inicial=" . $inicial . $varsel ?>" class="link_branco">
												<font class="texto">Operadora<br>Status</font>
											</a>
