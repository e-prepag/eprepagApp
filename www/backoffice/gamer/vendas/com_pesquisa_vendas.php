...
$tf_v_so_depositos = $_POST['tf_v_so_depositos'] ?? null;
$tf_v_origem = $_POST['tf_v_origem'] ?? null;
...
$conciliacao_manual = $_POST['conciliacao_manual'] ?? null;
...
$tf_v_dep_codigo = $_POST['tf_v_dep_codigo'] ?? null;
$tf_v_bol_codigo = $_POST['tf_v_bol_codigo'] ?? null;
$tf_d_forma_pagto = $_POST['tf_d_forma_pagto'] ?? null;
$tf_d_banco = $_POST['tf_d_banco'] ?? null;
$tf_d_local = $_POST['tf_d_local'] ?? null;
$tf_numdoc = $_POST['tf_numdoc'] ?? null;
$tf_d_num_docto = $_POST['tf_d_num_docto'] ?? null;
$tf_d_data_ini = $_POST['tf_d_data_ini'] ?? null;
$tf_d_data_fim = $_POST['tf_d_data_fim'] ?? null;
$tf_d_valor_pago = $_POST['tf_d_valor_pago'] ?? null;
$tf_d_data_inclusao_ini = $_POST['tf_d_data_inclusao_ini'] ?? null;
$tf_d_data_inclusao_fim = $_POST['tf_d_data_inclusao_fim'] ?? null;
...
$conciliacao_manual = $_GET['conciliacao_manual'] ?? null;
...
$tf_v_dep_codigo = $_GET['tf_v_dep_codigo'] ?? null;
$tf_v_bol_codigo = $_GET['tf_v_bol_codigo'] ?? null;
$tf_d_forma_pagto = $_GET['tf_d_forma_pagto'] ?? null;
$tf_d_banco = $_GET['tf_d_banco'] ?? null;
$tf_d_local = $_GET['tf_d_local'] ?? null;
$tf_numdoc = $_GET['tf_numdoc'] ?? null;
...
$tf_v_integracao = $_GET['tf_v_integracao'] ?? null;
