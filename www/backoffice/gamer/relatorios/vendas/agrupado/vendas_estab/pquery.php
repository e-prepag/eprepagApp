        ...
        <tr valign="top">
          <td height="100%">
            <form name="form1" method="post" action="">
              <table class="table">
                <tr bgcolor="#00008C">
                  <td colspan="11" bgcolor="#ECE9D8">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif">Pesquisa</font>
                  </td>
                </tr>
                <tr bgcolor="#F5F5FB">
                  <td colspan="6">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><strong>Data da venda</strong></font>
                  </td>
                  <td width="62">
                    <div align="center">
                ...
                <tr bgcolor="#F5F5FB">
                  <td width="96">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif">Datas
                      Inicial:</font>
                  </td>
                  <td width="196">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif">
                  ...
                  <td width="90">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif">Data
                      Final:</font>
                  </td>
                  <td colspan="3">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif">
                ...
                <tr bgcolor="#F5F5FB">
                  <td colspan="6">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><strong>Operadora</strong></font>
                  </td>
                  <td width="62">
                    <div align="center">
                      <font color="#666666" size="2" face="Arial, Helvetica, sans-serif">
                ...
                <tr bgcolor="#F5F5FB">
                  <td width="96">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif">Nome:</font>
                  </td>
                  <td width="196">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif">
                  ...
                  <td>
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif">Valor:</font>
                  </td>
                  <td colspan="3">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif">
            ...
            <table class="table">
              <tr>
                ...
                <td>
                  <div align="right"><a href="/frameset.php"><img src="/images/voltar_menu.gif" width="107" height="15" border="0"></a>
                    <?php
            ...
            <table class="table">
              <tr bgcolor="#00008C">
                ...
                ?>
                <td><strong>
                    <font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=trn_data&inicial=" . $inicial . $varsel ?>" class="link_br">Data</a></font>
                  </strong>
                ...
                <td><strong>
                    <font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=uf&inicial=" . $inicial . $varsel ?>" class="link_br">UF</a></font>
                  </strong>
                  <?php if ($ncamp == 'uf') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                </td>
                <td><strong>
                    <font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=opr_nome&inicial=" . $inicial . $varsel ?>" class="link_br">Operadora</a></font>
                  </strong>
                ...
                <td>
                  <div align="right">
                    ...
                    <strong>
                      <font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=quantidade&inicial=" . $inicial . $varsel ?>" class="link_br">Qtde</a></font>
                    </strong>
                  </div>
                </td>
                <td>
                  <div align="right">
                    ...
                    <strong>
                      <font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=pin_valor&inicial=" . $inicial . $varsel ?>" class="link_br">Valor
                          da Face</a></font>
                    </strong>
                  </div>
                </td>
                <td>
                  <div align="right">
                    ...
                    <strong>
                      <font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=total_face&inicial=" . $inicial . $varsel ?>" class="link_br">Valor
                          Total</a></font>
                    </strong>
                  </div>
                </td>
              ...
              ?>
                <tr bgcolor="#f5f5fb">
                  <td bgcolor="<?php echo $cor1 ?>">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><?php echo formata_data($pgrow['trn_data'], 0) ?></font>
                  </td>
                ...
                <td bgcolor="<?php echo $cor1 ?>"><font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><?php echo $pgrow['municipio'] ?></font></td-->
                  <td bgcolor="<?php echo $cor1 ?>">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><?php echo $pgrow['uf'] ?></font>
                  </td>
                  <td bgcolor="<?php echo $cor1 ?>">
                    <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><?php echo $pgrow['opr_nome'] ?></font>
                  </td>
                  <td bgcolor="<?php echo $cor1 ?>">
                    <div align="right">
                      <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><?php echo $pgrow['quantidade'] ?></font>
                    </div>
                  </td>
                  <td bgcolor="<?php echo $cor1 ?>">
                    <div align="right">
                      <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><?php echo number_format($pgrow['pin_valor'], 2, ',', '.') ?></font>
                    </div>
                  </td>
                  <td bgcolor="<?php echo $cor1 ?>">
                    <div align="right">
                      <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><?php echo number_format($pgrow['total_face'], 2, ',', '.') ?></font>
                    </div>
                  </td>
                </tr>
              <?php
              ...
              if (!$valor) { ?>
                <tr bgcolor="#f5f5fb">
                  <td colspan="10" bgcolor="<?php echo $cor1 ?>">
                    <div align="center">
              ...
              <?php } else { ?>
                <tr bgcolor="#E4E4E4">
                  ...
                  <td>
                    <div align="right">
                      <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><strong><?php echo number_format($qtde_total_tela, 0, ',', '.') ?></strong></font>
                    </div>
                  </td>
                  <td colspan="3">
                    <div align="right">
                      <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><strong><?php echo number_format($valor_total_tela, 2, ',', '.') ?></strong></font>
                    </div>
                  </td>
                </tr>
                <?php
                ...
                <tr bgcolor="#E4E4E4">
                  ...
                  <td>
                    <div align="right">
                      <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><strong><?php echo number_format($qtde_geral, 0, ',', '.') ?></strong></font>
                    </div>
                  </td>
                  <td colspan="2">
                    <div align="right">
                      <font color="#666666" size="2" face="Arial, Helvetica, sans-serif"><strong><?php echo number_format($valor_geral, 2, ',', '.') ?></strong></font>
                    </div>
                  </td>
                </tr>
                <tr bgcolor="#E4E4E4">
                ...
                <tr>
                  <td height="52" colspan="10" bgcolor="#FFFFFF">
                    <p>
