<?php
// Somente Pagamento com EPP CASH
    $dif_max = 180;
    $contents = "";
    try {
        $smonfilename = $raiz_do_projeto . "arquivos_gerados/logs/monitorprocessapagtoonline13.txt";
    ...
    echo "<div class='top10 lista bg-amarelo txt-azul'>Último processamento de Pagtos Online".
            str_replace("Incompleto", "<span class='txt-vermelho'>Incompleto</span>", str_replace("\n","<br>\n",$contents))."<span class='".(($dif>$dif_max)?"txt-vermelho":"txt-preto")."'>Desde o último processamento: ".number_format($dif, 2, '.', '.')."s"."</span></div>";