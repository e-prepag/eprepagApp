    ...
    <form id="buscaBanner" name="buscaBanner" method="post">
        ...
        <div class="col-md-2">
            <input type="text" value="<?php if (isset($_POST["data_inicial"]))  echo $_POST["data_inicial"];
                                        else echo date('d/m/Y'); ?>" id="data_inicial" name="data_inicial" char="10" class="form-control data w150">
        </div>
        <div class="col-md-2 text-right">Data final:</div>
        <div class="col-md-2">
            <input type="text" value="<?php if (isset($_POST["data_final"])) echo $_POST["data_final"];
                                        else echo date('d/m/Y'); ?>" id="data_final" name="data_final" char="10" class="form-control data w150">
        </div>
