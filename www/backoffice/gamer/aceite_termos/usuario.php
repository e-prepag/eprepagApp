...
$sql = "SELECT uat.versao_termo, uat.aceitou, uat.data_aceite, uat.ip, uat.dispositivo, uat.localizacao,
				ug.ug_nome_cpf, ug.ug_id, ug.ug_email, ug.ug_cpf, ug.ug_cidade, ug.ug_estado, ug_bairro from usuarios_games ug
				left join usuarios_aceito_termos uat on ug.ug_id = uat.ug_id 
...
<div class="col-md-12">
	<div>
		<fieldset>
			<h4 class="titulo-vencimento">Usuário GAMER</h4>
