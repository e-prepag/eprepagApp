...
$op = $_POST['op'] ?? null;
$consultou_rf = $_POST['consultou_rf'] ?? null;
$novo_ug_ativo = $_POST['novo_ug_ativo'] ?? null;
$novo_ug_news = $_POST['novo_ug_news'] ?? null;
$novo_ug_use_cielo = $_POST['novo_ug_use_cielo'] ?? null;
$novo_ug_login = $_POST['novo_ug_login'] ?? null;
$novo_ug_email = $_POST['novo_ug_email'] ?? null;
$novo_ug_nome = $_POST['novo_ug_nome'] ?? null;
$ug_nome_cpf = $_POST['ug_nome_cpf'] ?? null;
$novo_ug_cpf = $_POST['novo_ug_cpf'] ?? null;
$novo_ug_data_nascimento = $_POST['novo_ug_data_nascimento'] ?? null;
$novo_ug_rg = $_POST['novo_ug_rg'] ?? null;
$novo_ug_sexo = $_POST['novo_ug_sexo'] ?? null;
$novo_ug_nome_da_mae = $_POST['novo_ug_nome_da_mae'] ?? null;
$op_id = $_POST['op_id'] ?? null;
$op_nome = $_POST['op_nome'] ?? null;
...
$novo_ug_tel_ddi = $_POST['novo_ug_tel_ddi'] ?? null;
$novo_ug_tel_ddd = $_POST['novo_ug_tel_ddd'] ?? null;
$novo_ug_tel = $_POST['novo_ug_tel'] ?? null;
...
<script language="javascript">
    ...
    function pegaNomeRF() {
        ...
        if ($("#cpf").val().trim().length === 14 && $("#novo_ug_data_nascimento").val().trim().length === 10 && !searching) {
            $.ajax({
                ...
                data: {
                    cpf: $("#cpf").val(),
                    dataNascimento: $("#novo_ug_data_nascimento").val()
                },
                beforeSend: function() {
                    searching = true;
    ...
    function mudarSelect() {
        ...
        ativos[0] = 'Selecione o Substatus';
        ativos[1] = 'Ainda não fez 1º compra';
        var inativos = new Array(2);
        inativos[0] = 'Selecione o Substatus';
        inativos[1] = 'Pendente de Contato e Análise';
        inativos[2] = 'Retornar Contato';
        inativos[3] = 'Dados Insuficientes';
...
<form name="form1" method="post" action="com_usuario_detalhe_salva.php">
    ...
    <table class="table">
            ...
            <td valign="top">
                ...
                <?php } elseif ($msg == "" && $op == "sto") { ?>
                    <table>
                        <tr>
                            <td align="center" class="texto">
                                <font color="blue">Atualizado com sucesso!!!</font>
                            </td>
                        </tr>
                    </table>
                <?php } ?>
                ...
                <table class="table txt-preto fontsize-pp">
                    <tr bgcolor="#FFFFFF" class="texto">
                        <td align="left"><input type="button" value="Voltar" Onclick="fcnVoltar(<?php echo $usuario_id ?>)" class="btn btn-sm btn-info"></font>
                        </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td align="right"><input type="button" value="Salvar Cadastro" Onclick="fcnSalvarCadastro(<?php echo $usuario_id ?>)" class="btn btn-sm btn-info"></font>
                        </td>
                    </tr>
                    <tr bgcolor="#FFFFFF" class="texto">
                    ...
                    <tr bgcolor="#F5F5FB" class="texto">
                        <td><b>Email</b></td>
                        <td>
                            <input type="text" name="novo_ug_email" value="<?php echo $objUsuarioGames->getEmail() ?>">
                        </td>
                    ...
                    <tr bgcolor="#FFFFFF" class="texto">
                        <td colspan="2" bgcolor="#ECE9D8">Cadastro</font>
                        </td>
                    ...
                    <tr bgcolor="#F5F5FB" class="texto">
                        ...
                        <td><input type="text" name="ug_nome_cpf" id="ug_nome_cpf" readonly="readonly" value="<?php echo $objUsuarioGames->getNomeCPF(); ?>" title="Para editar o nome, consulte o CPF na Receita" maxlength="100" size="50" class="texto bloqueio"></td>
            </td>
        </tr>
        <tr bgcolor="#F5F5FB" class="texto">
            <td><b>CPF</b></td>
        ...
        <tr bgcolor="#F5F5FB" class="texto">
            <td><b>CEP</b></td>
            <td><input type="text" id="novo_ug_cep" name="novo_ug_cep" value="<?php echo $objUsuarioGames->getCEP() ?>" maxlength="8" size="8" class="texto">&nbsp;<div id="info_cep"></div>
            </td>
