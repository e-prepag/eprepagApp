...
$ug_data_desativacao_ini             = $_REQUEST['ug_data_desativacao_ini'] ?? null;
$ug_data_desativacao_fim             = $_REQUEST['ug_data_desativacao_fim'] ?? null;
...
$dd_opr_codigo                       = $_REQUEST['dd_opr_codigo'] ?? null;

$ug_flag_usando_saldo                = $_REQUEST['ug_flag_usando_saldo'] ?? null;
...
$varsel .= "&ug_data_desativacao_ini=$ug_data_desativacao_ini&ug_data_desativacao_fim=$ug_data_desativacao_fim";
...
if (isset($BtnSearch)) {
        ...
        if ($msg == "")
                if ($ug_data_desativacao_ini || $ug_data_desativacao_fim) {
                        if (verifica_data($ug_data_desativacao_ini) == 0)       $msg = "A Data de Desativacao inicial é inválida.\n";
                        if (verifica_data($ug_data_desativacao_fim) == 0)       $msg = "A Data de Desativacao final é inválida.\n";
                }
...
<script language="javascript">
        ...
        function gerarArquivo() {
                let url = "/gamer/usuarios/com_pesquisa_usuarios_arquivo.php?";
                url += "tf_u_com_totais_vendas=<?php echo $tf_u_com_totais_vendas ?>";
                url += "&dd_opr_codigo=<?php echo $dd_opr_codigo ?>";
                url += "&produtos_query=<?php echo urlencode($produtos_query) ?>";
                url += "&tf_u_codigo=<?php echo urlencode($tf_u_codigo) ?>";
                url += "&tf_u_status=<?php echo urlencode($tf_u_status) ?>";
                url += "&tf_u_qtde_acessos_ini=<?php echo $tf_u_qtde_acessos_ini ?>";
                url += "&tf_u_qtde_acessos_fim=<?php echo $tf_u_qtde_acessos_fim ?>";
                url += "&tf_u_data_ultimo_acesso_ini=<?php echo $tf_u_data_ultimo_acesso_ini ?>";
                url += "&tf_u_data_ultimo_acesso_fim=<?php echo $tf_u_data_ultimo_acesso_fim ?>";
                url += "&tf_u_data_inclusao_ini=<?php echo $tf_u_data_inclusao_ini ?>";
                url += "&tf_u_data_inclusao_fim=<?php echo $tf_u_data_inclusao_fim ?>";
                url += "&ug_data_desativacao_ini=<?php echo $ug_data_desativacao_ini ?>";
                url += "&ug_data_desativacao_fim=<?php echo $ug_data_desativacao_fim ?>";
                url += "&tf_u_nome=<?php echo urlencode($tf_u_nome) ?>";
                url += "&tf_u_email=<?php echo urlencode($tf_u_email) ?>";
                url += "&tf_u_cpf=<?php echo $tf_u_cpf ?>";
                url += "&ug_login=<?php echo urlencode($ug_login) ?>";
                url += "&tf_u_sexo=<?php echo $tf_u_sexo ?>";
                url += "&tf_u_data_nascimento_ini=<?php echo $tf_u_data_nascimento_ini ?>";
                url += "&tf_u_data_nascimento_fim=<?php echo $tf_u_data_nascimento_fim ?>";
                url += "&tf_u_tel_ddi=<?php echo $tf_u_tel_ddi ?>";
                url += "&tf_u_tel_ddd=<?php echo $tf_u_tel_ddd ?>";
                url += "&tf_u_tel=<?php echo $tf_u_tel ?>";
                url += "&tf_u_cel_ddi=<?php echo $tf_u_cel_ddi ?>";
                url += "&tf_u_cel_ddd=<?php echo $tf_u_cel_ddd ?>";
                url += "&tf_u_cel=<?php echo $tf_u_cel ?>";
                url += "&tf_u_endereco=<?php echo urlencode($tf_u_endereco) ?>";
                url += "&tf_u_bairro=<?php echo urlencode($tf_u_bairro) ?>";
                url += "&tf_u_cidade=<?php echo urlencode($tf_u_cidade) ?>";
                url += "&tf_u_cep=<?php echo $tf_u_cep ?>";
                url += "&tf_u_estado=<?php echo $tf_u_estado ?>";
                url += "&tf_u_news=<?php echo $tf_u_news ?>";
                url += "&tf_u_compet_aceito_regulamento=<?php echo $tf_u_compet_aceito_regulamento ?>";
                url += "&tf_u_compet_jogo=<?php echo $tf_u_compet_jogo ?>";
                url += "&tf_u_integracao_origem=<?php echo $tf_u_integracao_origem ?>";
                url += "&ug_flag_usando_saldo=<?php echo $ug_flag_usando_saldo ?>";
                url += "&tf_u_habilitado_cielo=<?php echo $tf_u_habilitado_cielo ?>";
                url += "&ug_cadastro_completo=<?php echo $ug_cadastro_completo ?>";

                // Redireciona para o script PHP que gera o arquivo
                window.location.href = url;
        }

        function gerarArquivo2() {
                ...
                var ug_data_desativacao_ini = '<?php echo $ug_data_desativacao_ini ?>';
                var ug_data_desativacao_fim = '<?php echo $ug_data_desativacao_fim ?>';
                ...
                $.ajax({
                        ...
                        data: {
                                ...
                                ug_data_desativacao_ini: ug_data_desativacao_ini,
                                ug_data_desativacao_fim: ug_data_desativacao_fim,
                                tf_u_nome: tf_u_nome,
                        ...
                        <form name="form1" method="post" action="com_pesquisa_usuarios.php">
                                ...
                                <table class="table top10 txt-preto fontsize-p">
                                        ...
                                        <tr bgcolor="#FFFFFF" class="texto">
                                                <td colspan="6" bgcolor="#ECE9D8">Dados Administrativos</font>
                                                </td>
                                        </tr>
                                        <tr bgcolor="#F5F5FB" class="texto">
                                                <td width="100">C&oacute;digo</font>
                                                </td>
                                                <td>
                                        ...
                                        <tr bgcolor="#F5F5FB" class="texto">
                                                <td>Data de Desativação</td>
                                                <td>
                                                        <input name="ug_data_desativacao_ini" type="text" class="form" id="ug_data_desativacao_ini" value="<?php echo $ug_data_desativacao_ini ?>" size="9" maxlength="10">
                                                        a
                                                        <input name="ug_data_desativacao_fim" type="text" class="form" id="ug_data_desativacao_fim" value="<?php echo $ug_data_desativacao_fim ?>" size="9" maxlength="10">
                                                </td>
                                                <td colspan="2"></td>
                                        </tr>
                                        <tr bgcolor="#F5F5FB" class="texto">
                                        ...
                                        <tr bgcolor="#FFFFFF" class="texto">
                                                <td colspan="4" bgcolor="#ECE9D8">Dados Pessoais</font>
                                                </td>
                                        </tr>
                                        <tr bgcolor="#F5F5FB" class="texto">
                                                <td>Email</font>
                                        ...
                                        <tr bgcolor="#FFFFFF" class="texto">
                                                <td colspan="4" bgcolor="#ECE9D8">Campeonato</font>
                                                </td>
                                        </tr>
                                        <tr bgcolor="#F5F5FB" class="texto">
                                                <td>Cadastrado no campeonato</font>
                                                </td>
                                                <td>
                                        ...
                                        <tr bgcolor="#FFFFFF" class="texto">
                                                <td colspan="4" bgcolor="#ECE9D8">Integração</font>
                                                </td>
                                        </tr>
                                        <?php
                                        ...
                                        <tr bgcolor="#FFFFFF" class="texto">
                                                <td colspan="4" bgcolor="#ECE9D8">Vendas</font>
                                                </td>
                                        </tr>
                                        <tr bgcolor="#F5F5FB" class="texto">
                                                <?php
                                        ...
                                        <tr bgcolor="#00008C">
                                                <td colspan="3" bgcolor="#FFFFFF">
                                                        <table class="table">
                                                                ...
                                                                <tr>
                                                                        <td colspan="20" bgcolor="#CCCCCC" id="area" class='texto' align="center">
                                                                ...
                                                                <tr bgcolor="#ECE9D8">
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_id&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">C&oacute;d.</font>
                                                                                        </a>
                                                                                        <?php if ($ncamp == 'ug_id') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                                                                                </strong></td>
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_ativo&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">Status</font>
                                                                                        </a>
                                                                                        <?php if ($ncamp == 'ug_ativo') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                                                                                </strong></td>
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_nome&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">Nome</font>
                                                                                        </a>
                                                                                        <?php if ($ncamp == 'ug_nome') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                                                                                </strong></td>
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_email&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">Email</font>
                                                                                        </a>
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_data_inclusao&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">Data de Cadastro</font>
                                                                                        </a>
                                                                        ...
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_data_encerramento_conta&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">Encerramento</font>
                                                                                        </a>
                                                                                        <?php if ($ncamp == 'ug_data_encerramento_conta') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                                                                                </strong></td>
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_cpf&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">CPF</font>
                                                                                        </a>
                                                                                        <?php if ($ncamp == 'ug_cpf') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                                                                                </strong></td>
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_login&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">Login</font>
                                                                                        </a><?php if ($ncamp == 'ug_login') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                                                                                </strong></td>
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_endereco&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">Endereço</font>
                                                                                        </a>
                                                                                        <?php if ($ncamp == 'ug_endereco') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                                                                                </strong></td>
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_bairro&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">Bairro</font>
                                                                                        </a>
                                                                                        <?php if ($ncamp == 'ug_bairro') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                                                                                </strong></td>
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_cidade&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">Cidade</font>
                                                                                        </a>
                                                                                        <?php if ($ncamp == 'ug_cidade') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                                                                                </strong></td>
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_estado&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                <font class="texto">Estado</font>
                                                                                        </a>
                                                                                        <?php if ($ncamp == 'ug_estado') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                                                                                </strong></td>
                                                                        <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_cep&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                        ...
                                                                        <?php if (strtolower($tf_u_compet_aceito_regulamento) != "") { ?>
                                                                                <td align="center"><strong>
                                                                                                <font class="texto">Jogo</font></a>
                                                                                        </strong></td>
                                                                        <?php } ?>
                                                                        <?php if (strtolower($tf_u_integracao_origem) != "" && $tf_u_integracao_origem != "-2") { ?>
                                                                                <td align="center"><strong>
                                                                                                <font class="texto">Store_ID</font></a>
                                                                                        </strong></td>
                                                                        <?php } ?>
                                                                        <?php
                                                                        if ($tf_u_com_totais_vendas) {        // && $dd_opr_codigo
                                                                        ?>
                                                                                <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=vg_valor&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                        <font class="texto">
                                                                                                                <nobr>Vendas R$</nobr>
                                                                                                        </font>
                                                                                                </a>
                                                                                ...
                                                                                <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=vg_qtde_itens&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                        <font class="texto">
                                                                                                                <nobr>n Vendas</nobr>
                                                                                                        </font>
                                                                                                </a>
                                                                                ...
                                                                                <td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=vg_data_ultima_venda&inicial=" . $inicial . $varsel ?>" class="link_branco">
                                                                                                        <font class="texto">
                                                                ...
                                                                ?>
                                                                        <tr bgcolor="<?php echo $cor1 ?>" class="texto" onmouseover="bgColor='#CFDAD7'" onmouseout="bgColor='<?php echo $cor1 ?>'">
                                                                                ...
                                                                                ?>
                                                                                        ...
                                                                                        <td align="right" title="Primeira venda: '<?php echo substr($rs_usuario_row['vg_data_primeira_venda'], 0, 19) ?>'">
                                                                                                <nobr><?php echo substr($rs_usuario_row['vg_data_ultima_venda'], 0, 19) ?></nobr>
                                                                                        </td>
                                                                                <?php
