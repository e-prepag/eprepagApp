...
if($msg == ""){
        ...
        if($acao && $acao == "a"){
                ...
                if($msgAcao == ""){
                        ...
                        if($v_campo == 'email') $cad_usuarioGames->setEmail($v_valor_new);
                        if($v_campo == 'ativo') $cad_usuarioGames->setAtivo($v_valor_new);
                        if($v_campo == 'news') $cad_usuarioGames->setNews($v_valor_new);
                        if($v_campo == 'cielo') {
                                if ($v_valor_new=='2'){
                                        $v_valor_new = '0';
                                }
	...
	<?php }?>
        ...
        <table class="table fontsize-pp txt-preto">
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <td width="307"><?php echo $ug_id ?></td>
			<?php
			...
			if(!$rs || pg_num_rows($rs) == 0 || empty($rs_row['ugc_data_cancelamento'])) {
				?>
				<td width="140"><a class="link_azul" href="#" Onclick="if(confirm('Deseja alterar o Status deste usuário ?')) window.open('com_usuario_detalhe_selecao.php?v_campo=ativo&ativo=<?php echo $ug_ativo ?><?php echo $varsel ?>','selecao', 'status=0,width=500,height=200,top=0,left=0');return false;"><b>Status</b></a></td>
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <td width="140"><a class="link_azul" href="#" Onclick="if(confirm('Deseja alterar o Opção de Pagamento Cielo deste usuário ?')) window.open('com_usuario_detalhe_selecao.php?v_campo=cielo&ug_use_cielo=<?php echo $ug_use_cielo ?><?php echo $varsel ?>','selecao', 'status=0,width=500,height=200,top=0,left=0');return false;"><b>Pagto. Cielo</b></a></td>
          ...
          <tr bgcolor="#ECE9D8" class="texto"> 
            <td align="left"><nobr>Dados Pessoais</nobr></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td align="right"><input type="button" value="Editar cadastro" Onclick="fcnEditarCadastro(<?php echo $ug_id; ?>)" class="btn btn-sm btn-info"> </td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Email</b>
                <?php 
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <td>
<a class="link_azul" href="#" Onclick="if(confirm('Deseja alterar o Newsletter deste usuário ?')) window.open('com_usuario_detalhe_selecao.php?v_campo=news&news=<?php echo $ug_news ?><?php echo $varsel ?>','selecao', 'status=0,width=500,height=200,top=0,left=0');return false;">			
			<a class="link_azul" href="#" Onclick="if(confirm('Deseja alterar o Newsletter deste usuário ?')) fcnAlterar('news','<?php echo $ug_news ?>','');return false;"><b>Newsletter</b></a></td>
            <td><?php 
				if($ug_news=='h') echo "Sim - HTML";
				elseif($ug_news=='t') echo "Sim - Texto";
				else echo "Não"; 
			?></td>
		  </tr>
          <tr bgcolor="#FFFFFF" class="texto"> 
		...
		<?php
			...
			$varsel = "&usuario_id=" . $usuario_id;
			if(!$ncamp_v) $ncamp_v = " vg_data_inclusao ";
			if(!$ordem_v) $ordem_v = 1;
			if(!$inicial_v)  $inicial_v = 0;
        ...
        <div id="Layer1" class="" style="position:static; width:100%; height:150px; z-index:1; overflow: auto;"> 
            <table class="table txt-preto fontsize-pp table-bordered">
                ...
                <tr bgcolor="#ECE9D8"> 
                  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem_v=".$ordem_v."&ncamp_v=vg_id&inicial_v=".$inicial_v.$varsel ?>" class="link_branco" >Pedido</a></td>
                  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem_v=".$ordem_v."&ncamp_v=vg_data_inclusao&inicial_v=".$inicial_v.$varsel ?>" class="link_branco" >Data</a></td>
                  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem_v=".$ordem_v."&ncamp_v=vg_pagto_tipo&inicial_v=".$inicial_v.$varsel ?>" class="link_branco" >Forma de Pagamento</a><br>(ord. pelo código)</td>
                  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem_v=".$ordem_v."&ncamp_v=vg_ultimo_status&inicial_v=".$inicial_v.$varsel ?>" class="link_branco" >Status</a><br>(ord. pelo código)</td>
                  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem_v=".$ordem_v."&ncamp_v=valor&inicial_v=".$inicial_v.$varsel ?>" class="link_branco" >Valor</a></td>
                  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem_v=".$ordem_v."&ncamp_v=qtde_itens&inicial_v=".$inicial_v.$varsel ?>" class="link_branco" >Qtde Itens</a></td>
                  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem_v=".$ordem_v."&ncamp_v=qtde_produtos&inicial_v=".$inicial_v.$varsel ?>" class="link_branco" >Qtde Produtos</a></td>
                  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem_v=".$ordem_v."&ncamp_v=vg_concilia&inicial_v=".$inicial_v.$varsel ?>" class="link_branco" >Conciliação</a></td>
                </tr>
        ...
        <?php } else {?>
            <?php	while ($rs_venda_row = pg_fetch_array($rs_venda)) {
                    ...
                    else $pagto_tipo = $GLOBALS['FORMAS_PAGAMENTO_DESCRICAO_NUMERICO'][$pagto_tipo];
            ?>
                    <tr bgcolor="<?php echo $cor1 ?>"> 
                        <td class="texto" align="center"><a style="text-decoration:none" href="/gamer/vendas/com_venda_detalhe.php?venda_id=<?php echo $rs_venda_row['vg_id'] ?>"><?php echo $rs_venda_row['vg_id'] ?></a></td>
                        <td class="texto" align="center"><?php echo formata_data_ts($rs_venda_row['vg_data_inclusao'], 0, true, true) ?></td>
                        <td class="texto"><?php echo $pagto_tipo ?></td>
                        <td class="texto"><?php echo substr($GLOBALS['STATUS_VENDA_DESCRICAO'][$status], 0, strpos($GLOBALS['STATUS_VENDA_DESCRICAO'][$status], '.')) ?></td>
                        ...
                        <td class="texto" align="center"><a style="text-decoration:none" href="/gamer/vendas/com_venda_detalhe.php?venda_id=<?php echo $rs_venda_row['vg_id'] ?>"><?php echo (($rs_venda_row['vg_concilia'] == 0)?"Conciliar":"Conciliado") ?></a></td>
                        <?php } else { ?>
                        <td>&nbsp;</td>
                        <?php } ?>
                    </tr>
		...
		<?php
			$varsel 		= "&usuario_id=" . $usuario_id;
			if(!$ncamp) 	$ncamp = "ugl_data_inclusao";
			if(!$ordem) 	$ordem = 1;
		...
		?>
				<div id="Layer1" class="" style="position:static; width:100%; height:150px; z-index:1; overflow: auto;"> 
                    <table class="table txt-preto fontsize-pp table-bordered">
						...
						<tr bgcolor="#ECE9D8"> 
						  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem=".$ordem."&ncamp=ugl_data_inclusao&inicial=".$inicial.$varsel ?>" class="link_branco" >Data</a></td>
						  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem=".$ordem."&ncamp=ugl_uglt_id&inicial=".$inicial.$varsel ?>" class="link_branco" >Tipo</a> (ord. pelo código)</td>
						  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem=".$ordem."&ncamp=ugl_vg_id&inicial=".$inicial.$varsel ?>" class="link_branco" >Pedido</a></td>
						  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem=".$ordem."&ncamp=ugl_ip&inicial=".$inicial.$varsel ?>" class="link_branco" >IP</a></td>
              <td align="center">Obs</td>
				...
				<?php } else {?>
					<?php	while ($rs_usuario_log_row = pg_fetch_array($rs_usuario_log)) {
							if ($cor1 == $cor2) {$cor1 = $cor3;} else {$cor1 = $cor2;} ?>
							<tr bgcolor="<?php echo $cor1 ?>"> 
							  <td align="center"><?php echo formata_data_ts($rs_usuario_log_row['ugl_data_inclusao'], 0, true, true) ?></td>
							  <?php $ugl_uglt_id = $rs_usuario_log_row['ugl_uglt_id'];?>
							  <td><?php echo $GLOBALS['USUARIO_GAMES_LOG_TIPOS_DESCRICAO'][$ugl_uglt_id] ?></td>
							  <td align="center"><a style="text-decoration:none" href="/gamer/vendas/com_venda_detalhe.php?venda_id=<?php echo $rs_usuario_log_row['ugl_vg_id'] ?>"><?php echo $rs_usuario_log_row['ugl_vg_id'] ?></a></td>
		...
		<?php
			...
			if(!$ncamp_bloqueio) 	$ncamp_bloqueio = "ughb_data";
			if(!$ordem_bloqueio) 	$ordem_bloqueio = 1;
			if(!$inicial_bloqueio) 	$inicial_bloqueio = 0;
		...
		?>
				<div id="Layer1" class="" style="position:static; width:100%; height:150px; z-index:1; overflow: auto;"> 
                    <table class="table">
						...
						<tr bgcolor="#ECE9D8"> 
						  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem_bloqueio=".$ordem_bloqueio."&ncamp_bloqueio=ughb_data&inicial_bloqueio=".$inicial_bloqueio.$varsel_bloqueio ?>" class="link_branco" >Data</a></td>
						  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem_bloqueio=".$ordem_bloqueio."&ncamp_bloqueio=ughb_autor&inicial_bloqueio=".$inicial_bloqueio.$varsel_bloqueio ?>" class="link_branco" >Usuário DB</a></td>
						  <td align="center"><a style="text-decoration:none" href="<?php echo $default_add."?ordem_bloqueio=".$ordem_bloqueio."&ncamp_bloqueio=ughb_ug_flag_usando_saldo&inicial_bloqueio=".$inicial_bloqueio.$varsel_bloqueio ?>" class="link_branco" >Status</a></td>
						</tr>
				...
				<?php } else {?>
					<?php	while ($rs_usuario_bloqueio_row = pg_fetch_array($rs_usuario_bloqueio)) {
							...
							<tr bgcolor="<?php echo $cor1 ?>"> 
							  ...
							  <td align="center"><?php if($rs_usuario_bloqueio_row['ughb_ug_flag_usando_saldo']==1) echo "Bloqueado"; elseif($rs_usuario_bloqueio_row['ughb_ug_flag_usando_saldo']==0) echo "Desbloqueado"; else echo "Status NÃO identificado"; ?></td>
							</tr>
					<?php	} ?>
