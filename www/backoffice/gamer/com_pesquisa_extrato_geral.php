...
//echo $sql . "<br>";
		...
		if(!$rs_UG || !$rs_UG || pg_num_rows($rs_UG) == 0) $msg = "Usu&aacute;rio $codigo_user nï¿½o encontrado.\n";
		else {				
...
//echo $sql . "<br>";
		...
		if(!$rs_Pendentes || !$rs_Pendentes || pg_num_rows($rs_Pendentes) == 0) $msg = "Vendas do usu&aacute; $codigo_user nï¿½o encontrada.\n";
		else {				
