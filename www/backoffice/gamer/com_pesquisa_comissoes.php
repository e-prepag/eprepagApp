...
if(!$rs) {
	echo "Erro ao listar Comiss�ess.\n";
	echo "sql: ".$sql."<br>\n<hr>\n";
//	die("Stop");
}
	...
	<tr valign="top" align="center">
			...
			<table class="txt-preto fontsize-pp table">
					...
					<tr bgcolor="F0F0F0">
					  ...
					  <td colspan="3" align="center" class="texto"><?php
						// Select canal
							$acanais= array('C' => 'Cart�es', 'E' => 'Express Money', 'L' => 'Lanhouse', 'M' => 'Money', 'P' => 'POS' );
					...
					<tr bgcolor="F0F0F0">
					  <td width="16%" align="center" class="texto">
						  <select name='dd_tipo'>
							<option value=''<?php echo (($dd_tipo!='F' && $dd_tipo!='V')?" selected":"") ?>>Todos os tipos de Comiss�o</option>
							<option value='F'<?php echo (($dd_tipo=='F')?" selected":"") ?>>Comiss�o Fixa</option>
							<option value='V'<?php echo (($dd_tipo=='V')?" selected":"") ?>>Comiss�o por Volume</option>
						</select>
					  </td>
					  <td width="17%" align="center" class="texto">&nbsp;</td>
					  <td colspan="3" align="center" class="texto">
						  <select name='dd_volume_tipo'>
							<option value=''<?php echo (($dd_volume_tipo!='D' && $dd_volume_tipo!='I')?" selected":"") ?>>Todos os tipos de Comiss�o por Volume</option>
							<option value='D'<?php echo (($dd_volume_tipo=='D')?" selected":"") ?>>Comiss�o por Volume - Direta</option>
							<option value='I'<?php echo (($dd_volume_tipo=='I')?" selected":"") ?>>Comiss�o por Volume - Indireta</option>
						</select>
						</td>
					  <td width="14%">&nbsp;</td>
     ...
     <tr>
		...
		if($rs && pg_num_rows($rs) != 0){
			...
			echo "Sem registros de comiss�o por volume<br>";
		}
		?>
