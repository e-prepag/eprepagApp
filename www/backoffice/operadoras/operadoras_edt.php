...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#salvaNacionalInternacional").click(function () {
            if ($("#data_int_nac").val() != "" && $("#nacionalInternacional").val() != "") {
                let opr_codigo = "<?php if (isset($opr_codigo))
                    echo $opr_codigo; ?>";
    ...
    function adicionarCampo() {
        ...
        <div class="campo-input">
            <input class="valor-campo" name="opr_valores[]" type="text" style="width: 100%;" value="0,00"/>
            <button type="button" class="btn btn-danger" onclick="removerCampo(this)">&#x1f5d1;</button>
        </div>
    `;
    ...
    function removerCampo(botao) {
        const campo = botao.parentNode.parentNode;
        campo.remove();
    }
</script>
<div class="col-md-12">
...
<div class="col-md-12">
    <a class="btn btn-sm btn-info" href="../operadoras_integracao_pin/index.php" class="menu">Consultar Operadoras
        com
        Integração de PINs clique aqui.</a>
</div>
<div class="col-md-12">
    <br>
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" name="frmPreCadastro" id="frmPreCadastro"
        onsubmit="return validaUsuario();">
        <input type="hidden" name="acao" id="acao" value="<?php if (isset($acao))
            echo $acao; ?>" />
        <input type="hidden" name="opr_codigo" id="opr_codigo" value="<?php if (isset($opr_codigo))
            echo $opr_codigo; ?>" />
        <fieldset>
            ...
            <table class="table txt-preto fontsize-pp p0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (empty($opr_nome)) {
                            ?>
                            <input name="opr_nome" type="text" id="opr_nome" size="20" maxlength="20" value="<?php if (isset($opr_nome))
                                echo $opr_nome; ?>" />
                            <?php
                            ...
                            echo $opr_nome;
                            ?>
                            <input name="opr_nome" type="hidden" id="opr_nome" value="<?php if (isset($opr_nome))
                                echo $opr_nome; ?>" />
                            <?php
                ...
                <tr>
                    ...
                    <td>
                        <input name="opr_nome_loja" type="text" id="opr_nome_loja" size="40" maxlength="40" value="<?php if (isset($opr_nome_loja))
                            echo $opr_nome_loja; ?>" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>* Contato: </td>
                    <td>
                        <input name="opr_contato" type="text" id="opr_contato" size="40" maxlength="40" value="<?php if (isset($opr_contato))
                            echo $opr_contato; ?>" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>* Site: </td>
                    <td><input name="opr_site" type="text" id="opr_site" size="35" maxlength="35" value="<?php if (isset($opr_site))
                        echo $opr_site; ?>" onBlur="isURL(this.value);" /></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>* Fone Contato: </td>
                    <td><input name="opr_cont_fone" type="text" id="opr_cont_fone" size="40" maxlength="40" value="<?php if (isset($opr_cont_fone))
                        echo $opr_cont_fone; ?>" onBlur="isTipo(this.value);" /> <span
                            style="color:red; font-size: 9px;">Colocar Números sem
                            espaços, hífen, etc.</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>* E-Mail DIMP:</td>
                    <td><input name="opr_email_dimp" type="email" id="opr_email_dimp" size="40" maxlength="256" value="<?php if (isset($opr_email_dimp))
                        echo $opr_email_dimp; ?>" /> <span style="color:red; font-size: 9px;">Informe apenas um
                            e-mail.</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>* E-Mail de Fechamento Financeiro:</td>
                    <td><input name="opr_cont_mail" type="text" id="opr_cont_mail" size="40" maxlength="256" value="<?php if (isset($opr_cont_mail))
                        echo $opr_cont_mail; ?>" onBlur="isEmail(this.value);" /> <span
                            style="color:red; font-size: 9px;">Sempre usar
                            vírgula(,) para separar e-mails</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>* Prazo Pedido Estoque:</td>
                    <td><input name="opr_pedido_estoque_prazo" type="text" id="opr_pedido_estoque_prazo" size="4"
                            maxlength="4" value="<?php if (isset($opr_pedido_estoque_prazo))
                                echo $opr_pedido_estoque_prazo; ?>" onBlur="isTipo(this.value);" /> Dias</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>* Status:</td>
                    <td>
                        <select id='opr_status' name='opr_status'>
                            <option value='' <?php echo ((isset($opr_status) && $opr_status == "") ? " selected" : "") ?>>
                                Selecione</option>
                ...
                <tr>
                    ...
                    <td>
                        <input name="opr_contato_epp" type="text" id="opr_contato_epp" size="40" maxlength="40" value="<?php if (isset($opr_contato_epp))
                            echo $opr_contato_epp; ?>" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input name="opr_min_repasse" type="text" id="opr_min_repasse" size="40" maxlength="40" value="<?php if (isset($opr_min_repasse))
                            echo number_format($opr_min_repasse, 2, ',', '.'); ?>" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <span style="color:red; font-size: 9px;"><b>ATENÇÃO!</b> Campo novo, atualize-o por
                            favor!</span>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select id='opr_internacional_alicota' name='opr_internacional_alicota'>
                            ...
                            <option value='0.38' <?php echo ((isset($opr_internacional_alicota) && $opr_internacional_alicota == "0.38") ? " selected" : "") ?>>Internacional pela
                                Facilitadora com Alíquota de 0,38%</option>
                            <option value='6.38' <?php echo ((isset($opr_internacional_alicota) && $opr_internacional_alicota == "6.38") ? " selected" : "") ?>>Internacional com Alíquota de
                                6,38%</option>
                            <option value='10' <?php echo ((isset($opr_internacional_alicota) && $opr_internacional_alicota == "10") ? " selected" : "") ?>>Internacional com Alíquota de
                                10%</option>
                            <option value='15' <?php echo ((isset($opr_internacional_alicota) && $opr_internacional_alicota == "15") ? " selected" : "") ?>>Internacional com Alíquota de
                                15%</option>
                            <option value='<?= IOF ?>' <?php echo ((isset($opr_internacional_alicota) && $opr_internacional_alicota == IOF) ? " selected" : "") ?>>Internacional com Alíquota de
                                <?= IOF ?>%
                            </option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td><input name="opr_pedido_estoque_prazo_comentario" type="text"
                            id="opr_pedido_estoque_prazo_comentario" size="80" maxlength="255" value="<?php if (isset($opr_pedido_estoque_prazo_comentario))
                                echo $opr_pedido_estoque_prazo_comentario; ?>" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <?php
                ...
                <tr class="ocultar" id="trTrocaNacInt">
                    ...
                    <td>
                        <select id='opr_troca_nacional_internacional' name='opr_troca_nacional_internacional'>
                            <option value='0' <?php if (!isset($opr_troca_nacional_internacional) || $opr_troca_nacional_internacional == "0")
                                echo "selected"; ?>>Não</option>
                            <option value='1' <?php if (isset($opr_troca_nacional_internacional) && $opr_troca_nacional_internacional == "1")
                                echo "selected"; ?>>Sim</option>
                        </select>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr class="ocultar <?php if (isset($_GET['acao']) && $_GET['acao'] == "novo")
                    echo "hidden"; ?>" id="trNacInt">
                    <td>&nbsp;</td>
                    <td>
                        <div class="bloco blockNtable row">
                            <div class="borda">
                                <span class="borda azul-claro p10 negrito pointer" id="novaTroca">Novo</span>
                            </div>
                        </div>
                        <div class="row bloco blockNtable ocultar" id="divNacInc">
                            <input type="hidden" name="otni_id" id="otni_id" value="">
                            <input type="text" id="data_int_nac" style="width: 75px;" name="data_int_nac"
                                placeholder="DATA">
                            ...
                            ->
                            <input type="text" id="internacionalNacional" placeholder="DESTINO" readonly="true"
                                name="internacionalNacional">
                                    ...
                                    <table class="row text-center bordaTabela">
                                        ...
                                        <tbody title="Clique para editar">
                                            ...
                                            while ($rs_row = pg_fetch_array($rs_TrocaNacionalInternacional)) {
                                                ...
                                                ?>
                                                <tr class='bannersOpt' onclick="callEditNacInc(this.id)"
                                                    id="<?php echo $rs_row['otni_id']; ?>">
                                                    <td class='style1'><?php echo $data; ?></td>
                                                    <td class='style1'>
                                                        <?php echo ($rs_row['otni_origem'] == 1) ? "Internacional" : "Nacional"; ?>
                                                    </td>
                                                    <td class='style1'>
                                                        <?php echo ($rs_row['otni_destino'] == 1) ? "Internacional" : "Nacional"; ?>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
                ...
                <tr>
                    ...
                    <td>
                        <input name="opr_data_inicio_operacoes" type="text" class="form" id="opr_data_inicio_operacoes"
                            size="11" maxlength="10" value="<?php if (isset($opr_data_inicio_operacoes))
                                echo $opr_data_inicio_operacoes; ?>">
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <?php
                ...
                <tr>
                    <td>
                        <nobr>* Desmembra Cartões - Prestação de Contas?</nobr>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="width: 80%;float: left;display:<?php echo ((isset($opr_distribui_ponto_certo) && $opr_distribui_ponto_certo == "1") ? " block" : "none") ?>;"
                            id="div_opr_prefixo_ponto_certo">
                            <span style="float:left">Prefixo na Rede Ponto Certo: </span>
                            <input name="opr_prefixo_ponto_certo" type="text" id="opr_prefixo_ponto_certo" size="32"
                                maxlength="32" value="<?php if (isset($opr_prefixo_ponto_certo))
                                    echo $opr_prefixo_ponto_certo; ?>" />
                        </div>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <nobr>* Contabiliza PINs por data de Utilização no Canal LAN?</nobr>
                    </td>
                    <td>
                        ...
                        <div style="width: 85%;float: left;display:<?php echo (($opr_contabiliza_utilizacao == "1") ? " block" : "none") ?>;"
                            id="div_opr_data_inicio_contabilizacao_utilizacao">
                            <span style="float:left">Data de Utilização Inicial: </span>
                            <input name="opr_data_inicio_contabilizacao_utilizacao" type="text" class="form"
                                id="opr_data_inicio_contabilizacao_utilizacao" size="11" maxlength="10" value="<?php if (isset($opr_data_inicio_contabilizacao_utilizacao))
                                    echo $opr_data_inicio_contabilizacao_utilizacao; ?>">
                        </div>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="opr_facilitadora" type="text" class="form" id="opr_facilitadora" size="11"
                            maxlength="11" value="<?php if (isset($opr_facilitadora))
                                echo $opr_facilitadora;
                            else
                                echo "0" ?>">
                            <span style="color:red; font-size: 10px;"> *Prencheer com 0 (zero) caso não utilize
                                facilitadora</span>;
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input name="merchant_id_bexs" type="text" class="form" id="merchant_id_bexs" size="11"
                                maxlength="11" value="<?php if (isset($merchant_id_bexs))
                                echo $merchant_id_bexs;
                            else
                                echo "0" ?>">
                            <span style="color:red; font-size: 10px;"> *Prencheer com 0 (zero) caso não tenha relação com o
                                BEXS</span>;
                        </td>
                        <td>&nbsp;</td>
                    </tr>
        ...
        <fieldset>
            ...
            <div id="valoresContainer" class="grid-container">
                <?php
                $opr_valores = isset($opr_valores) && is_array($opr_valores) ? $opr_valores : [];
                if (empty($opr_valores))
                    $opr_valores = ['']; // ao menos 1 campo
                ...
                foreach ($opr_valores as $valor) {
                    ...
                    <div class="campo">
                        <label>Valor:</label>
                        <div class="campo-input">
                            <input name="opr_valores[]" type="text" style="width: 100%;" class="valor-campo"
            ...
            <button type="button" class="btn btn-success" style="font-style: normal;"
                onclick="adicionarCampo()">Adicionar Valor</button>
            ...
            <div id='box-comisao' name='box-comisao'>
                <table class="table txt-preto fontsize-pp">
                    <tr>
                        ...
                        <td valign="top" colspan="7"><input name="opr_comissao_por_volume" type="hidden"
                                id="opr_comissao_por_volume" value="<?php if (isset($opr_comissao_por_volume))
                                    echo $opr_comissao_por_volume; ?>" />
                            <?php echo ((!empty($opr_comissao_por_volume)) ? "Sim" : "Não") ?>
                            <?php
                            if (!empty($opr_codigo)) {
                                /*
                    ...
                    <tr>
                        ...
                        if (!isset($opr_comissao_por_volume) || !$opr_comissao_por_volume) {
                            ...
                            <td><input name="comiss_m" type="text" id="comiss_m" size="10" maxlength="15" value="<?php if (isset($comiss_m))
                                echo $comiss_m; ?>" readonly /></td>
                            <td align="right">Express:</td>
                            <td><input name="comiss_e" type="text" id="comiss_e" size="10" maxlength="15" value="<?php if (isset($comiss_e))
                                echo $comiss_e; ?>" readonly /></td>
                            <td align="right">LAN:</td>
                            <td><input name="comiss_l" type="text" id="comiss_l" size="10" maxlength="15" value="<?php if (isset($comiss_l))
                                echo $comiss_l; ?>" readonly /></td>
                            <td align="right">POS:</td>
                            <td><input name="comiss_p" type="text" id="comiss_p" size="10" maxlength="15" value="<?php if (isset($comiss_p))
                                echo $comiss_p; ?>" readonly /></td>
                            <?php
                        } //end if($opr_comissao_por_volume)
                        ?>
                        <td align="right">Cartões:</td>
                        <td><input name="comiss_c" type="text" id="comiss_c" size="10" maxlength="15" value="<?php if (isset($comiss_c))
                            echo $comiss_c; ?>" readonly /></td>
                    </tr>
                    <tr>
                        <td colspan="10" align="right">
                            <input type="button" name="ajax_atualiza" id="ajax_atualiza" value="Editar"
                                onclick="javascript:edita_comissoes();" />
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <fieldset>
            ...
            <table class="table txt-preto fontsize-pp">
                <tr>
                    <td>Raz&atilde;o: </td>
                    <td>
                        <input name="opr_razao" type="text" id="opr_razao" size="80" maxlength="255" value="<?php if (isset($opr_razao))
                            echo $opr_razao; ?>" />
                    </td>
                    <td>Para Publishers internacional este campo tamb&eacute;m ser&aacute; usado para account owner.
                    </td>
                </tr>
                <tr>
                    <td>CNPJ: </td>
                    <td>
                        <input name="opr_cnpj" type="text" id="opr_cnpj" size="18" maxlength="14" value="<?php if (isset($opr_cnpj))
                            echo $opr_cnpj; ?>" onBlur="isTipo(this.value);" />&nbsp;ATEN&Ccedil;&Atilde;O: Colocar
                        N&uacute;meros sem
                        espa&ccedil;os, h&iacute;fen, etc.
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>IM: </td>
                    <td><input name="opr_im" type="text" id="opr_im" size="12" maxlength="10" value="<?php if (isset($opr_im))
                        echo $opr_im; ?>" onBlur="isTipo(this.value);" />&nbsp;Inscri&ccedil;&atilde;o
                        Municipal - Colocar
                        N&uacute;meros sem espa&ccedil;os, h&iacute;fen, etc.</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>Endere&ccedil;o: </td>
                    <td><input name="opr_endereco" type="text" id="opr_endereco" size="80" maxlength="255" value="<?php if (isset($opr_endereco))
                        echo $opr_endereco; ?>" /></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>N&uacute;mero:</td>
                    <td><input name="opr_numero" type="text" id="opr_numero" size="10" maxlength="8" value="<?php if (isset($opr_numero))
                        echo $opr_numero; ?>" onBlur="isTipo(this.value);" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>Complemento:</td>
                    <td><input name="opr_complemento" type="text" id="opr_complemento" size="10" maxlength="10" value="<?php if (isset($opr_complemento))
                        echo $opr_complemento; ?>" /></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>Bairro:</td>
                    <td><input name="opr_bairro" type="text" id="opr_bairro" size="40" maxlength="40" value="<?php if (isset($opr_bairro))
                        echo $opr_bairro; ?>" /> </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>CEP:</td>
                    <td><input name="opr_cep" type="text" id="opr_cep" size="10" maxlength="9" value="<?php if (isset($opr_cep))
                        echo $opr_cep; ?>" /> <span id="opr_cep_gif" class="p-left-3"></span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>Cidade:</td>
                    <td><input name="opr_cidade" type="text" id="opr_cidade" size="40" maxlength="40" value="<?php if (isset($opr_cidade))
                        echo $opr_cidade; ?>" /> </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>Estado:</td>
                    <td><input name="opr_estado" type="text" id="opr_estado" size="2" maxlength="2" value="<?php if (isset($opr_estado))
                        echo $opr_estado; ?>" /> </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>Pais:</td>
                    <td><input name="opr_pais" type="text" id="opr_pais" size="40" maxlength="40" value="<?php if (isset($opr_pais))
                        echo $opr_pais; ?>" /> </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
        ...
        <fieldset>
            ...
            <table class="table txt-preto fontsize-pp">
                <tr>
                    ...
                    <td width="80%">
                        <input name="opr_internacional" type="checkbox" id="opr_internacional" value="1" <?php if (!empty($opr_internacional))
                            echo "checked" ?> onclick="carga_dados();" /> Sim
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
        ...
        <fieldset>
            ...
            <table class="table txt-preto fontsize-pp">
                <tr>
                    <td>Possui BSLAN:</td>
                    <td width="80%">
                        <input name="opr_bslan" type="checkbox" id="opr_bslan" value="1" <?php if (!empty($opr_bslan))
                            echo "checked" ?> /> Sim
                        </td>
                    </tr>
                    <tr>
        ...
        <table class="table txt-preto fontsize-pp">
            ...
            if (!empty($opr_product_type)) {
                ?>
                <tr>
                    <td colspan="3" bgcolor="#CCCCCC" style="font-family:verdana,arial;font-weight:bold;">&nbsp;* Esta
                        Operadora Possui Integra&ccedil;&atilde;o de Utiliza&ccedil;&atilde;o de PINs</td>
                </tr>
                <?php
            }
            ?>
            <tr>
                <td colspan="3" align="center"><input type="submit" name="Submit" class="btn btn-info btn-sm" value="<?php if ($acao == 'atualizar')
                    echo "Atualizar";
                else
                    echo "Cadastrar"; ?>" /></td>
            </tr>
