	...
	function reload_gerar_arquivo() {
		if (algumCheckBoxSel()) {
			if (document.getElementById('pin_operacao').value != "") {
				...
				alert("Deve ser selecionado uma Distribuidora\n para gerar o arquivo!");
				return false;
			}
		} else {
	...
	if ($op == "ati" || $op == "can" || $op == "blo" || $op == "des") {
		...
		switch ($op) {
			case "ati":
				...
				$setAdicinal = ", pin_validade = (NOW() + interval '2 month')";
				break;
			case "can":
		...
		for ($i = 0; $i < (is_countable($ids_temp) ? count($ids_temp) : 0); $i++) {
			if ($msg == "") {
				...
				if ($rs_pins_save) {
					...
					$msg = "<span class='txt-vermelho'><b>Erro ao atualizar o Lote ($codlote) da Distribuidora ($codopr).\n</b></span><br>";
				}
			}
		}
...
if (!empty($BtnGerarArq) && $tf_v_tipo == 3) {
	include("pins_store_envio_email.php");
}
...
<div class="col-md-12">
	<ol class="breadcrumb top10">
		...
		<li class="active">Listar PINs E-PREPAG por LOTE</li>
	</ol>
</div>
<div class="col-md-12 txt-preto fontsize-pp">
	...
	?>
	<form name="form1" method="post" action="pins_store_lista.php">
		<table class="table txt-preto fontsize-pp bg-branco">
			<?php
			if (isset($msg_pin) && $msg_pin)
				...
				<td>
					...
					<table class="table txt-preto fontsize-pp">
						...
						<tr bgcolor="F5F5FB">
							...
							<td class="texto" align="center">&nbsp;Valor
								<input name="pin_valor" id="pin_valor" type="text" value="<?php echo $valor; ?>" size="10" maxlength="10" onKeypress="return verifica();">
							</td>
						</tr>
						<tr bgcolor="F5F5FB">
							<td class="texto" align="center">
							...
							<td class="texto" align="center"><input type="submit" name="btPesquisar" id="btPesquisar" value="Pesquisar" class="btn btn-sm btn-info">
								<?php
								if ($tf_v_tipo == 3 && !empty($distributor_codigo)) {
								?>
					...
					<table class="table txt-preto fontsize-pp">
						<tr bgcolor="F0F0F0">
							...
							<td class="texto" align="center" width="9%"><b>Distribuidora</b></td>
							...
							<td class="texto" align="center" width="9%"><b>Total PINs no Lote</b></td>
							<td class="texto" align="center" width="7%"><b>
									<font color="<?php echo $PINS_STORE_STATUS_COLORS[$PINS_STORE_STATUS_VALUES['D']] ?>"><?php echo " (" . $PINS_STORE_STATUS_VALUES['D'] . ")<br>" . $PINS_STORE_STATUS[$PINS_STORE_STATUS_VALUES['D']] ?></font>
								</b></td>
							<td class="texto" align="center" width="7%"><b>
									<font color="<?php echo $PINS_STORE_STATUS_COLORS[$PINS_STORE_STATUS_VALUES['P']] ?>"><?php echo " (" . $PINS_STORE_STATUS_VALUES['P'] . ")<br>" . $PINS_STORE_STATUS[$PINS_STORE_STATUS_VALUES['P']] ?></font>
								</b></td>
							<td class="texto" align="center" width="7%"><b>
									<font color="<?php echo $PINS_STORE_STATUS_COLORS[$PINS_STORE_STATUS_VALUES['A']] ?>"><?php echo " (" . $PINS_STORE_STATUS_VALUES['A'] . ")<br>" . $PINS_STORE_STATUS[$PINS_STORE_STATUS_VALUES['A']] ?></font>
								</b></td>
							<td class="texto" align="center" width="7%"><b>
									<font color="<?php echo $PINS_STORE_STATUS_COLORS[$PINS_STORE_STATUS_VALUES['U']] ?>"><?php echo " (" . $PINS_STORE_STATUS_VALUES['U'] . ")<br>" . $PINS_STORE_STATUS[$PINS_STORE_STATUS_VALUES['U']] ?></font>
								</b></td>
							<td class="texto" align="center" width="7%"><b>
									<font color="<?php echo $PINS_STORE_STATUS_COLORS[$PINS_STORE_STATUS_VALUES['B']] ?>"><?php echo " (" . $PINS_STORE_STATUS_VALUES['B'] . ")<br>" . $PINS_STORE_STATUS[$PINS_STORE_STATUS_VALUES['B']] ?></font>
								</b></td>
							<td class="texto" align="center" width="7%"><b>
									<font color="<?php echo $PINS_STORE_STATUS_COLORS[$PINS_STORE_STATUS_VALUES['C']] ?>"><?php echo " (" . $PINS_STORE_STATUS_VALUES['C'] . ")<br>" . $PINS_STORE_STATUS[$PINS_STORE_STATUS_VALUES['C']] ?></font>
								</b></td>
						...
						?>
								<tr<?php echo $bgcolor ?> valign="top">
									...
									<td class="texto" align="center">
										<nobr>&nbsp;<?php echo $operacao_array[$rs_pins_row['distributor_codigo']] . " (" . $rs_pins_row['distributor_codigo'] . ")" ?>&nbsp;</nobr>
									</td>
									<td class="texto" align="center">
										<nobr>&nbsp;<?php echo $rs_pins_row['pin_lote_codigo'] ?>&nbsp;</nobr>
									</td>
									...
									<td class="texto" align="center">
										<nobr>&nbsp;<?php echo $rs_pins_row['data'] ?>&nbsp;</nobr>
									</td>
									<td class="texto" align="center">
										<nobr>&nbsp;
											<?php
		...
		?>
			<tr>
				<td class="texto" align="center" colspan="16">&nbsp;<font color='#FF0000'>N&atilde;o foram encontrados pins para os valores escolhidos.</font>
				</td>
			</tr>
		<?php
							}
	...
	?>
		...
		<table class="table txt-preto fontsize-pp">
			<tr align="center">
				...
				<td bgcolor="#FFFFFF" class="texto">Processamento em <?php echo number_format(getmicrotime() - $time_start_stats, 2, '.', '.') ?> s.</font>
				</td>
				<td bgcolor="#FFFFFF" class="texto" width="10%">&nbsp;</td>
			</tr>
		</table>
