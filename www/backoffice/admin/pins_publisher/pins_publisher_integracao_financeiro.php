...
<br>                        
    	...
    	<?php	
			...
			?>
					<tr>
					  <td class="texto" align="center" colspan="13">&nbsp;<font color='#FF0000'>Não foram encontradas arquivos para os valores escolhidos</font></td>
					</tr>
			<?php
				}
				else {
			?>
					<tr>
                        <td class="texto" align="center" colspan="13"><span class="txt-verde"><strong>Valor Total Geral no Período: <?php echo number_format($valorTotalGeral,2,',','.')?></strong></span></td>
					</tr>
			<?php
				}
