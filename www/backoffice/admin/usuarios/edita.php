...
if (isset($login)) {
    ...
    <form method="POST" id="form">
        ...
        <div class="col-md-7 top20 txt-preto">
            ...
            <div class="form-group col-md-12 has-feedback">
                ...
                <div class="col-md-6">
                    <input type="checkbox" name="visualiza" value="S" class="" id="visualiza_dados" <?php echo (isset($visualiza_dados) && $visualiza_dados == "S") ? "checked " : "";
                                                                                                    echo (!in_array(1, $grupos_id)) ? "disabled " : ""; ?>>
                </div>
            </div>
    ...
    <div class="col-md-5 espacamento">
        ...
        <div class="panel panel-default">
            <!-- Default panel contents -->
            <div class="panel-heading">Autenticador</div>
            <!-- List group -->
            <ul class="list-group">
                <?php
                if (!empty($chave_autenticador)) {
                ?>
                    <div class="panel-body">
                ...
                ?>
                    <div class="panel-body">
                        <p>Usuário não possui autenticador</p>
                    </div>
                <?php
                }
                ?>
