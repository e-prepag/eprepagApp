    ...
    <tr>
        <td valign="top">
            <table class="table txt-preto fontsize-pp">
                ...
                <tr align="center">
					<span  style="font-family:verdana,arial;font-size:12px;">Obs.: O tempo de lat�ncia � medido utilizando o comando PING 4 vezes seguidas, o valor indicado � a m�dia desses valores.</span>
                <td>
<p align="center">
<?php
...
?>
	...
	<tr>
        ...
        <td bgcolor="#DDDDDD" align="center">Data Lat�ncia</td>
        <td bgcolor="#DDDDDD" align="center">Lat�ncia</td>
    </tr>
<?php
}
$contador=1;
