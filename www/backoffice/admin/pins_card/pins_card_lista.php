					...
					<table class="txt-preto fontsize-pp table">
						...
						?>
								<tr<?php echo $bgcolor ?> valign="top">
									<td class="texto" align="center">&nbsp;<input name="chkPIN[]" id="chkPIN" type="checkbox" value="<?php echo $rs_pins_row['pin_lote_codigo'] . "|" . $rs_pins_row['distributor_codigo'] . "|" . $rs_pins_row['opr_codigo']; ?>" />&nbsp;</nobr>
									</td>
									<td class="texto" align="center">
										<nobr>&nbsp;<?php echo $publisher_array[$rs_pins_row['opr_codigo']] . " (" . $rs_pins_row['opr_codigo'] . ")" ?>&nbsp;
									</td>
									<td class="texto" align="center">
