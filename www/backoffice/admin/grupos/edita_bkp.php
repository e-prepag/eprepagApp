...
?>
                    <div class="top10 lista bg-verde-claro txt-branco">
                        <a href="#aba<?=$aba->getId();?>" class="txt-branco" data-toggle="collapse">
                            <strong><span class="glyphicon glyphicon-menu-right t0"></span> <?=$aba->getDescricao();?></strong>
                        </a>
                        <span class="pull-right">expandir todas <input id="<?=$aba->getId();?>" class="checkall" type="checkbox"></span>
                    </div>
