...
<?php  //                <option value="1" <_? if($dd_tipodoc == 1) echo "selected" ?_>>Corte (1)</option> ?>
                ...
                <option value="6" <?php  if($dd_tipodoc == 6) echo "selected" ?>>Depï¿½sito Saldo Gamer (6)</option>
              </select>
              </font></td>
          ...
          <tr bgcolor="#F5F5FB"> 
            ...
            <td width="0" height="0"><font color="#666666" size="2" face="Arial, Helvetica, sans-serif"> 
              <select name="dd_situacao" id="dd_situacao" class="combo_normal">
                ...
                <option value="1" <?php  if($dd_situacao == 1) echo "selected" ?>>Disponï¿½vel</option>
...
//die("Stop");
        ...
        <tr> 
          ...
          <td bgcolor="<?php  echo $cor1 ?>"><div align="center"><a href="deleta.php?BolCod=<?php  echo $pgest['bol_codigo'] . $varsel ?>" onClick="GP_popupConfirmMsg('Deseja excluir esta informaï¿½ï¿½o de boleto?');return document.MM_returnValue"><img src="/images/deletar.gif" alt="Excluir Registro" width="12" height="14" border="0"></a></div></td>
        </tr>
        <?php 
