	...
	<div style="display: flex; align-items: center; justify-content: center">
		...
		<div class="container-title-icone" style="z-index: 2;">
			...
			<div class="calculo-merchant hidden">
				 <b>Legendas:</b><br> * <u>MMA</u>: M�dia M�vel Aritm�tica<br>* <u>FD</u>: Fechamento Total do dia<br>* <u>DA</u>: Total de Dias Anteriores<br><br>
	...
	<div style="display: flex; align-items: center; justify-content: center">
		...
		<div class="container-title-icone">
			...
			<div class="calculo-merchant hidden" style="z-index: 2">
				 ...
				 <b>Formula:</b><br>(Ticket M�dio da Empresa * M�dia do n�mero de mensalidades a cada ano) * m�dia de tempo de relacionamento
			</div>
		</div>
	</div>
	<div style="display: flex; flex-direction: row; align-items: center; justify-content: space-evenly">
...
<div class="mais-vendidos-periodo" style="text-align: center;">
	<h1>Produtos mais vendidos por per�odo</h1>
...
?>
 ...
 <script>
	...
	function showLoadingSwal() {
	  Swal.fire({
		title: 'Carregando informa��es!',
	    html: '<p>Coletando as informa��es necessarias</p><img style="width: 80px;" src="../../images/loading.gif">',
	...
	function verifica_datas(datainicial, datafinal) {
		...
		if(dataFinal < dataInicial) {
			Swal.fire({
				icon: 'error',
				title: 'Oops...',
				text: 'A Data final n�o pode ser menor que a inicial.'
			 });
		  ...
		  success: function(response) {
			...
			error: function(xhr, textStatus, errorThrown) {
			  ...
			  Swal.fire({
				icon: 'error',
				title: 'Oops...',
				text: 'Ocorreu um erro na requisi��o'
			  });
			}
			 ...
			 if(!dataValues.length) {
				Swal.fire({
					icon: 'warning',
					title: 'Aviso',
					text: 'N�o foram encontrados dados na data especifica'
				}); 
		  ...
		  $.ajax({
			 ...
			 if(dataValues.length > 0){
			   ...
			   Swal.fire({
					icon: 'error',
					title: 'Erro',
					text: 'N�o foi possivel carregar o grafico',
					showConfirmButton: false,
		...
		$.ajax({
		  ...
		  success: function(response) {
			...
			new Chart(ctx, {
				type: 'pie',
				data: {
				  labels: ["N�o realizaram primeiro pedido", "Realizaram primeiro pedido"],
				  datasets: [{
		  ...
		  success: function(response) {
			...
			if(!dataValues.length) {
				Swal.fire({
					icon: 'warning',
					title: 'Aviso',
					text: 'N�o foram encontrados dados na data especificada'
				});
			...
			console.log(dataValues);
			let tipos = {
				"1": "Transfer�ncia Bancaria",
				"2": "Saldo em conta",  // Boleto
				"3": "Master Card",
				"4": "Diners",
				"5": "Transfer�ncia entre contas Bradesco",
				"6": "Pagamento F�cil Bradesco - D�bito",
				"7": "Pagamento F�cil Bradesco - Cr�dito",
				"8": "Pagamento BB - D�bito sua Empresa",
				"9": "Pagamento BB - D�bito sua Conta",
				"10": "Pagamento It�u online",	
				"11": "Pagamento Hipay online",
				"12": "Pagamento Paypal online",
				"13": "Pagamento EPP Cash",
				"14": "Pagamento Visa Net",
				"15": "Pagamento Visa Cr�dito",
				"16": "Pagamento Maestro",
				"17": "Pagamento Mastercard Cr�dito",
				"18": "Pagamento Elo D�bito",
				"19": "Pagamento Elo Cr�dito",
				"20": "Pagamento Diners Cr�dito",
				"21": "Pagamento Discover Cr�dito",
				"22": "Ofertas",
		  ...
		  success: function(response) {
			...
			if(parseFloat(dataValues[0]) == 0) {
				...
				Swal.fire({
					icon: 'warning',
					title: 'Aviso',
					text: 'N�o foram encontrados dados na data especificada ou o LTV � 0'
				});
			...
			let table = new DataTable('#myTable', {
				...
				language: {
					...
					zeroRecords: "N�o foram encontrados CNAES",
