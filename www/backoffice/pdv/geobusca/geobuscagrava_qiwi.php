...
$sql = "UPDATE dist_usuarios_stores_qiwi SET us_coord_lat = ".$us_coord_lat.", us_coord_lng = ".$us_coord_lng.", us_google_maps_string = '".str_replace("'", "''", $us_google_maps_string)."', us_google_maps_status = Null WHERE us_id = ".$us_id;
