...
<?php
	...
	if(!$fila_ncamp){
		...
		$rs_tb_venda_games = pg_exec($connid, "select column_name from information_schema.columns where table_name = 'tb_dist_venda_games'");
...
/*
	...
	$sql  = "select vg.vg_id from tb_dist_venda_games vg 
...
<html>
<head>
<title>REDE E-PREPAG - &Aacute;rea do Parceiro</title>
				...
				<table width="894" border="0" cellpadding="0" cellspacing="0" dwcopytype="CopyTableCell">
					<tr> 
					    <td width="894" height="21" bgcolor="00008C">
							<font face="Arial, Helvetica, sans-serif" size="2" color="#FFFFFF"><b>Money Distribuidor - Venda</b></font></td>
					  </tr>
				</table>
