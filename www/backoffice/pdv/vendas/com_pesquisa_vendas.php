		...
		<td>
			<form name="form1" method="post" action="com_pesquisa_vendas.php">
				...
				<table class="table top20" cellpadding="0" cellspacing="2">
					<tr bgcolor="#FFFFFF">
						<td colspan="5" bgcolor="#ECE9D8" class="texto">Venda</font>
						</td>
					</tr>
					<tr bgcolor="#F5F5FB">
					...
					<tr bgcolor="#F5F5FB">
						...
						<td class="texto">Qtde Itens</font>
						</td>
						<td>
...
<?php if ($total_table > 0) { ?>
	...
	<div style="overflow: auto;">
		<table class="table txt-preto bg-branco fontsize-pp table-bordered">
			...
			<tr bgcolor="#ECE9D8">
				<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=vg_id&inicial=" . $inicial . $varsel ?>" class="link_branco">
							<font class="texto">C&oacute;d.
						</a>
						<?php if ($ncamp == 'vg_id') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
					</strong></td>
				<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=vg_data_inclusao&inicial=" . $inicial . $varsel ?>" class="link_branco">
              ...
              <?php if ($ncamp == 'vg_pagto_tipo') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
				...
				<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=valor&inicial=" . $inicial . $varsel ?>" class="link_branco">
				...
				?>
				<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=qtde_itens&inicial=" . $inicial . $varsel ?>" class="link_branco">
							<font class="texto">Qtde<br>Itens</font>
						</a>
						<?php if ($ncamp == 'qtde_itens') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
					</strong></td>
				<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=qtde_produtos&inicial=" . $inicial . $varsel ?>" class="link_branco">
							<font class="texto">Qtde<br>Produtos</font>
						</a>
				...
				<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_risco_classif&inicial=" . $inicial . $varsel ?>" class="link_branco">
							<font class="texto">Tipo<br>Usuário</font>
						</a>
						<?php if ($ncamp == 'ug_risco_classif') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
					</strong></td>
				<td align="center"><strong>
						<font class="texto">Nome Fantasia</font>
					</strong></td>
				<td align="center"><strong>
						<font class="texto">Categoria</font>
					</strong></td>
				<?php
				if ($tf_u_so_depositos != "1") {
				?>
				...
				?>
				<td align="center"><strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=vg_concilia&inicial=" . $inicial . $varsel ?>" class="link_branco">
			...
			?>
                ...
                <span style='color:#006600'><?php echo $pagto_tipo_descricao ?></span>
					...
					if ($status == $GLOBALS['STATUS_VENDA']['VENDA_CANCELADA']) { ?>
						<td nowrap valign="top" class="texto">
							<font color="FF0000"><?php echo substr($GLOBALS['STATUS_VENDA_DESCRICAO'][$status], 0, strpos($GLOBALS['STATUS_VENDA_DESCRICAO'][$status], '.')) ?></font>
						</td>
					<?php } else { ?>
