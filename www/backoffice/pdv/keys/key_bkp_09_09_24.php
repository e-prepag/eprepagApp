...
<div class="container-titulo">
    ...
    <form class="dados" action="https://www.e-prepag.com.br:8080/pdv/keys/key.php" method="POST">
...
<div class="container-titulo">
    ...
    <form action="https://www.e-prepag.com.br:8080/pdv/keys/key.php" class="dados" method="POST">
			...
			<tbody>
				...
				?>  
					<tr>
						...
						<td class="colt"><?php echo (!is_numeric($situacao))? $situacao:(($situacao == 1)? '<a href="https://www.e-prepag.com.br:8080/pdv/keys/key.php?cod='.$value["user_id"].'&action=1">&#10060;</a>'
						: '<a href="https://www.e-prepag.com.br:8080/pdv/keys/key.php?cod='.$value["user_id"].'&action=2">&#9989;</a>'); ?></td>
					</tr>
                <?php 
				        }
				    }else{ 
		...
		<div class="container-rodape">
			...
			<div class="container-botoes-paginacao">
				<?php if($resultadoTotal["numtotal"] > $limiteporpagina){ ?>
					<span class="rodape btn-rodape"><a href="https://www.e-prepag.com.br:8080/pdv/keys/key.php?action=ante&ini=<?php echo ($inicial <= 0)? 0: $inicial - $limiteporpagina; ?>">anterior</a></span>
					<span class="rodape btn-rodape"><a href="https://www.e-prepag.com.br:8080/pdv/keys/key.php?action=pro&ini=<?php echo ($inicial >= $resultadoTotal["numtotal"])? $inicial: $inicial + $limiteporpagina; ?>">proxima</a></span>		
				<?php } ?>
			</div>
		</div>
    <?php } ?>
