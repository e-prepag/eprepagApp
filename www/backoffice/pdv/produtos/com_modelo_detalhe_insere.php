...
if ($msg == "") {
  ...
  if ($BtnInserir) {
    ...
    $msgAcao = $instProdutoModelo->inserir($modelo);
    if ($msgAcao == "") {
...
?><html>
  ...
  <div class="col-md-12">
    <ol class="breadcrumb top10">
      ...
      <li><a href="com_produto_detalhe.php?produto_id=<?php echo $produto_id ?>">Voltar</a></li>
      <li class="active">Money Distribuidor - Inserir novo modelo</li>
    </ol>
  </div>
