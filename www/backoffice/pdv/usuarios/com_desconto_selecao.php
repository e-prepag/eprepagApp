...
$novo_perc_desconto = $_POST['novo_perc_desconto'] ?? null;
$BtnSearch = $_POST['BtnSearch'] ?? null;
$opr_nome = $_GET['opr_nome'] ?? null;
$perc_desconto = $_GET['perc_desconto'] ?? null;
$des_opr_codigo = $_GET['des_opr_codigo'] ?? null;
$des_vg_pagto_tipo = $_GET['des_vg_pagto_tipo'] ?? null;
$des_id = $_GET['des_id'] ?? null;
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="2">
					<tr>
						<td colspan="5" height="21" bgcolor="00008C">
							<font face="Arial, Helvetica, sans-serif" size="1" color="#FFFFFF">&nbsp;<b>Desconto Default</b></font>
						</td>
			</td>
		</tr>
	</table>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="2">
			...
			<?php if ($opr_nome && trim($opr_nome) != "") { ?>
				<tr bgcolor="#F5F5FB" height="25">
					...
					<td>
						<font color="#666666" size="1" face="Arial, Helvetica, sans-serif">&nbsp;<?php echo $opr_nome ?></font>
					</td>
				</tr>
			<?php } ?>
			<tr bgcolor="#F5F5FB">
			...
			<?php if ($msg != "") { ?>
				...
				<tr>
					<td colspan="2" align="center">
						<font color="#FF0000" size="1" face="Arial, Helvetica, sans-serif"><?php echo $msg ?></font>
					</td>
				</tr>
			<?php } ?>
		</table>
