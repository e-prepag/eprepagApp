...
$tf_u_login                        = $_POST['tf_u_login'] ?? null;
$tf_u_tipo_cadastro                = $_POST['tf_u_tipo_cadastro'] ?? null;

$tf_u_data_aprovacao_ini            = $_POST['tf_u_data_aprovacao_ini'] ?? null;
$tf_u_data_aprovacao_fim            = $_POST['tf_u_data_aprovacao_fim'] ?? null;

$ug_data_expiracao_senha_ini        = $_POST['ug_data_expiracao_senha_ini'] ?? null;
$ug_data_expiracao_senha_fim        = $_POST['ug_data_expiracao_senha_fim'] ?? null;
...
$tf_u_status_busca                 = $_POST['tf_u_status_busca'] ?? null;
$tf_u_substatus                    = $_POST['tf_u_substatus'] ?? null;
$tf_u_vip                          = $_POST['tf_u_vip'] ?? null;

$tf_ug_possui_restricao_produtos    = $_POST['tf_ug_possui_restricao_produtos'] ?? null;
...
$tf_u_site                         = $_POST['tf_u_site'] ?? null;

$tf_u_fatura_media_mensal           = $_POST['tf_u_fatura_media_mensal'] ?? null;
$tf_u_razao_social                 = $_POST['tf_u_razao_social'] ?? null;

$tf_ug_te_id                       = $_POST['tf_ug_te_id'] ?? null;
$tf_ug_te_id_ativo                 = $_POST['tf_ug_te_id_ativo'] ?? null;

$tf_u_email                        = $_POST['tf_u_email'] ?? null;
$tf_u_computadores_qtde            = $_POST['tf_u_computadores_qtde'] ?? null;
...
$tf_gmaps                          = $_POST['tf_gmaps'] ?? null;
$tf_u_compet_participa             = $_POST['tf_u_compet_participa'] ?? null;
