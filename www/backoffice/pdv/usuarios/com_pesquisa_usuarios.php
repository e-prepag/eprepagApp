...
$tf_u_login                        = $_REQUEST['tf_u_login'] ?? null;
$tf_u_tipo_cadastro                = $_REQUEST['tf_u_tipo_cadastro'] ?? null;

$tf_u_data_aprovacao_ini            = $_REQUEST['tf_u_data_aprovacao_ini'] ?? null;
$tf_u_data_aprovacao_fim            = $_REQUEST['tf_u_data_aprovacao_fim'] ?? null;

$ug_data_expiracao_senha_ini        = $_REQUEST['ug_data_expiracao_senha_ini'] ?? null;
$ug_data_expiracao_senha_fim        = $_REQUEST['ug_data_expiracao_senha_fim'] ?? null;
...
$tf_u_status_busca                 = $_REQUEST['tf_u_status_busca'] ?? null;
$tf_u_substatus                    = $_REQUEST['tf_u_substatus'] ?? null;
$tf_u_vip                          = $_REQUEST['tf_u_vip'] ?? null;

$tf_ug_possui_restricao_produtos    = $_REQUEST['tf_ug_possui_restricao_produtos'] ?? null;
$tf_u_risco_classif                = $_REQUEST['tf_u_risco_classif'] ?? null;

$tf_u_nome_fantasia                = $_REQUEST['tf_u_nome_fantasia'] ?? null;
$tf_u_cnpj                         = $_REQUEST['tf_u_cnpj'] ?? null;
$tf_u_responsavel                  = $_REQUEST['tf_u_responsavel'] ?? null;
$tf_u_site                         = $_REQUEST['tf_u_site'] ?? null;

$tf_u_fatura_media_mensal           = $_REQUEST['tf_u_fatura_media_mensal'] ?? null;
$tf_u_razao_social                 = $_REQUEST['tf_u_razao_social'] ?? null;

$tf_ug_te_id                       = $_REQUEST['tf_ug_te_id'] ?? null;
$tf_ug_te_id_ativo                 = $_REQUEST['tf_ug_te_id_ativo'] ?? null;

$tf_u_email                        = $_REQUEST['tf_u_email'] ?? null;
$tf_u_computadores_qtde            = $_REQUEST['tf_u_computadores_qtde'] ?? null;
$tf_u_tipo_venda                   = $_REQUEST['tf_u_tipo_venda'] ?? null;
...
$tf_gmaps                          = $_REQUEST['tf_gmaps'] ?? null;
$tf_u_compet_participa             = $_REQUEST['tf_u_compet_participa'] ?? null;
$ug_ongame                         = $_REQUEST['ug_ongame'] ?? null;
...
$tf_u_saldo_positivo               = $_REQUEST['tf_u_saldo_positivo'] ?? null;
$como_conheceu                     = $_REQUEST['como_conheceu'] ?? null;
...
$tf_u_endereco = str_replace("_", " ", $tf_u_endereco); //$tf_u_endereco_ip
...
$varsel .= "&tf_u_endereco_ip=$tf_u_endereco_ip";
$varsel .= "&tf_u_observacoes=$tf_u_observacoes";
...
<script language="javascript">
    ...
    function mudarSelect() {
        ...
        ativos[0] = 'Selecione';
        ativos[1] = 'Ainda não fez 1º compra';
        var inativos = new Array(2);
        inativos[0] = 'Selecione';
        inativos[1] = 'Pendente de Contato e Análise';
        inativos[2] = 'Loja não Localizada';
        inativos[3] = 'Representante Divergente';
        inativos[4] = 'Cadastro não Aprovado';
        inativos[5] = 'Sem Interesse';
        inativos[6] = 'Não quer mais vender';
        inativos[7] = 'Bloqueado por fraude';
        inativos[8] = 'Pré-Cadastro/Prospecção';
    ...
    function gerarArquivo() {
        ...
        var tf_u_endereco = '<?php echo $tf_u_endereco ?>'; //$tf_u_endereco_ip
        ...
        $.ajax({
            ...
            data: {
                ...
                ug_data_expiracao_senha_ini: ug_data_expiracao_senha_ini,
                ug_data_expiracao_senha_fim: ug_data_expiracao_senha_fim,
    ...
    function gerarArquivoConheceu() {
        ...
        $.ajax({
            ...
            data: {
                resposta_como_conheceu: resposta_como_conheceu
            },
            beforeSend: () => {
        ...
        <div class="top10 panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="ug_data_desativacao_ini" class="w100">Periodo de desativação da conta</label>
                        <input name="ug_data_desativacao_ini" type="text" class="input-sm form-control w150  dislineblock" id="ug_data_desativacao_ini" value="<?php echo $ug_data_desativacao_ini ?>" size="9" maxlength="10">
                        <span class="text-info p-3  dislineblock">a</span>
                        <input name="ug_data_desativacao_fim" type="text" class="input-sm form-control w150  dislineblock left5" id="ug_data_desativacao_fim" value="<?php echo $ug_data_desativacao_fim; ?>" size="9" maxlength="10">
                        <span class="text-info p-3  dislineblock">(99/99/9999)</span>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tf_u_substatus" id="tf_u_substatus" class="input-sm form-control w-auto">
                            ...
                            foreach ($SUBSTATUS_LH as $indice => $dado) {
                                ...
                                if (strcmp($tf_u_substatus, $indice) == 0) echo "selected";
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tf_ug_te_id" id="tf_ug_te_id" class="input-sm form-control w150 dislineblock">
                            ...
                            ?>
                                <option value='<?php echo $te_codigo ?>' <?php echo $select ?>><?php echo pdv_utf8_to_iso($res_te_row['te_descricao']); ?> (<?php if ($res_te_row['te_ativo']) echo "Ativo";
                                                                                                                                                        else echo "Inativo"; ?>)</option>
                            <?php
                            } //end while
                            ?>
                        </select>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="tf_u_endereco_ip" class="w100">Endereço IP</label>
                        <input name="tf_u_endereco_ip" id="tf_u_endereco_ip" type="text" class="input-sm form-control" value="<?php echo trim((string)($tf_u_endereco_ip ?? "")) ?>" size="50" maxlength="100">
                    </div>
                    <?php
                    //                if($tf_u_com_totais_vendas) 
                    //                {
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="tf_u_observacoes" class="w100">Observações</label>
                        <input name="tf_u_observacoes" id="tf_u_observacoes" type="text" class="input-sm form-control" value="<?php echo trim((string)($tf_u_observacoes ?? "")) ?>" size="50" maxlength="100">
                    </div>
                    <?php
                    if ($tf_u_com_totais_vendas) {
                    ?>
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="checkbox" name="tf_u_login_automatico_nexcafe" id="tf_u_login_automatico_nexcafe" value="1" <?php if ($tf_u_login_automatico_nexcafe) {
            ...
            <thead>
                ...
                <td align="center">
                    ...
                    <?php if ($ncamp == 'ug_responsavel') echo "<img src=" . $img_seta . " width='10' height='7' align='absmiddle'>"; ?>
                        ...
                        <td align="center">
                            <strong><a href="<?php echo $default_add . "?ordem=" . $ordem . "&ncamp=ug_data_encerramento_conta&inicial=" . $inicial . $varsel ?>">Dt. Últ Desativação</a>
