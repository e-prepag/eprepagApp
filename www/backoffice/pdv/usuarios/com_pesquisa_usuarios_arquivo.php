...
$tf_u_compet_jogo              = $_POST['tf_u_compet_jogo'] ?? null;
...
$tf_u_fax_ddi                  = $_POST['tf_u_fax_ddi'] ?? null;
$tf_u_fax_ddd                  = $_POST['tf_u_fax_ddd'] ?? null;
$tf_u_fax                      = $_POST['tf_u_fax'] ?? null;
$tf_u_ra_codigo                = $_POST['tf_u_ra_codigo'] ?? null;
$tf_u_ra_outros                = $_POST['tf_u_ra_outros'] ?? null;
$tf_u_contato01_nome           = $_POST['tf_u_contato01_nome'] ?? null;
$tf_u_contato01_cargo          = $_POST['tf_u_contato01_cargo'] ?? null;
$tf_u_contato01_tel_ddi        = $_POST['tf_u_contato01_tel_ddi'] ?? null;
$tf_u_contato01_tel_ddd        = $_POST['tf_u_contato01_tel_ddd'] ?? null;
$tf_u_contato01_tel            = $_POST['tf_u_contato01_tel'] ?? null;
$tf_u_risco_classif            = $_POST['tf_u_risco_classif'] ?? null;
$tf_u_saldo_positivo           = $_POST['tf_u_saldo_positivo'] ?? null;
$tf_u_usuarios_cartao          = $_POST['tf_u_usuarios_cartao'] ?? null;
$tf_u_usuarios_novos           = $_POST['tf_u_usuarios_novos'] ?? null;
$tf_u_origem_cadastro          = $_POST['tf_u_origem_cadastro'] ?? null;
$ug_ficou_sabendo              = $_POST['ug_ficou_sabendo'] ?? null;
