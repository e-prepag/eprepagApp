...
//                $cad_usuarioGames->setSenha($novo_ug_senha);
                ...
                if(is_array($cad_ComunicacaoVisual)) $cad_usuarioGames->setComunicacaoVisual(implode(",", $cad_ComunicacaoVisual));
...
//echo "ret: ".str_replace("\n", "<br>", $msgAcao)."<br>";
    ...
    if($msg == ""){
        if($acao && $acao == 'exclui_socio'){
            ...
            if(!$ret) $msgAcao = "Erro ao excluir sócio.\n";
        }
    }
    ...
    if($msg == ""){
        ...
        if($objUsuarioGames == null) $msg = "Nenhum usuário encontrado.\n";
            ...
            if(is_null($objUsuarioGames->getRACodigo()) || trim($objUsuarioGames->getRACodigo()) == ""){
                ...
                if($resatv) $pgatv = pg_fetch_array($resatv);
...
<form name="form1" method="post" action="com_usuario_detalhe_salva.php">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 pull-left">
        <input type="button" value="Voltar" class="btn pull-left btn-info" Onclick="fcnVoltar(<?php echo $usuario_id ?>)"></button>
    </div>
    <?php if($msg != ""){?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 pull-right">
        <input type="button" value="Salvar Cadastro" Onclick="fcnSalvarCadastro(<?php echo $usuario_id ?>)" class="btn btn-info pull-right">
    </div>
    ...
    <td>
        <table class="table">
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <td>
                <input type="hidden" name="novo_ug_perfil_forma_pagto" value="<?php echo $objUsuarioGames->getPerfilFormaPagto(); ?>">
                <select name="just_diplay_novo_ug_perfil_forma_pagto" class="texto" readonly disabled="disabled">
                    ...
                    <option value="<?php echo $formaPagtoId; ?>" <?php if ($objUsuarioGames->getPerfilFormaPagto() == $formaPagtoId) echo "selected";?>><?php echo $formaPagtoDesc; ?></option>
                    <?php } ?>
                </select>

            </td>
            <td width="140"><b>Senha de Reimpressão</b></td>
            <td width="307"><input type="text" name="novo_ug_perfil_senha_reimpressao" value="<?php echo $objUsuarioGames->getPerfilSenhaReimpressao() ?>" maxlength="50" size="10" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Limite</b></td>
            <td><input type="text" name="novo_ug_perfil_limite" value="<?php echo number_format($objUsuarioGames->getPerfilLimite(), 2, ',','.') ?>" maxlength="10" size="10" class="texto"></td>
            <td><b>Saldo atual</b></td>
            <td><?php echo number_format($objUsuarioGames->getPerfilSaldo(), 2, ',','.') ?> <?php if($objUsuarioGames->getCreditoPendente()>0 && false) {?><font color="#FF0000">(<b>Crédito Pendente: <?php echo number_format($objUsuarioGames->getCreditoPendente(), 2, ',','.') ?></b>)</font><?php }?></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Limite Sugerido</b></td>
            <td><input type="text" name="novo_ug_perfil_limite_sugerido" value="<?php echo number_format($objUsuarioGames->getPerfilLimiteSugerido(), 2, ',','.') ?>" maxlength="10" size="10" class="texto"></td>
            ...
            <td>
                <select name="novo_ug_perfil_corte_dia_semana" class="texto">
                    ...
                    <option value="<?php echo $formaPagtoId; ?>" <?php if ($objUsuarioGames->getPerfilCorteDiaSemana() == $formaPagtoId) echo "selected";?>><?php echo $formaPagtoDesc; ?></option>
                    <?php } ?>
                </select>
            </td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Limite de Referência</b></td>
             <td><input type="text" name="novo_ug_perfil_limite_referencia" value="<?php echo number_format($objUsuarioGames->getPerfilLimiteRef(), 2, ',','.') ?>" maxlength="10" size="10" class="texto"></td>
           <td><b>Usuário VIP, Master, Black, etc?</b></td>
            <td>
                <select name="novo_ug_vip" class="texto">
                    <option value="" <?php if($objUsuarioGames->getVIP() == "") echo "selected" ?>>Selecione</option>
                    <option value="0" <?php if (is_numeric($objUsuarioGames->getVIP()) && $objUsuarioGames->getVIP() == 0) echo "selected";?>>Não</option>
                    <option value="1" <?php if ($objUsuarioGames->getVIP() == 1) echo "selected";?>>VIP</option>
                    <option value="2" <?php if ($objUsuarioGames->getVIP() == 2) echo "selected";?>>MASTER</option>
                    <option value="3" <?php if ($objUsuarioGames->getVIP() == 3) echo "selected";?>>BLACK</option>
                    <option value="4" <?php if ($objUsuarioGames->getVIP() == 4) echo "selected";?>>GOLD</option>
					<option value="5" <?php if ($objUsuarioGames->getVIP() == 5) echo "selected";?>>PLATINUM</option>
                </select>
            </td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
           ...
           <td><b>Possui Restrição de Vendas de Produtos?</b></td>
                <td>
                    <select name="novo_ug_possui_restricao_produtos" class="texto">
                        <option value="" <?php if($objUsuarioGames->getPossuiRestricaoProdutos() == "") echo "selected" ?>>Selecione</option>
                        <option value="0" <?php if (is_numeric($objUsuarioGames->getPossuiRestricaoProdutos()) && $objUsuarioGames->getPossuiRestricaoProdutos() == 0) echo "selected";?>>Não</option>
                        <option value="1" <?php if ($objUsuarioGames->getPossuiRestricaoProdutos() == 1) echo "selected";?>>SIM</option>
                    </select>
                </td>
          </tr>
          <tr bgcolor="#FFFFFF" class="texto"> 
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <td>
                <select name="novo_ug_ativo" class="texto"> <?php // onChange="javascript:mudarSelect();"> ?>
                    ...
                    <option value="0" <?php if ($objUsuarioGames->getAtivo() != 1) echo "selected";?>>Inativo</option>
                    <option value="1" <?php if ($objUsuarioGames->getAtivo() == 1) echo "selected";?>>Ativo</option>
                </select>
            </td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <?php if(in_array(44, $grupos)){ ?>
				<td><b>Email</b></td>
				<td><input type="text" name="novo_ug_email" value="<?php echo $objUsuarioGames->getEmail() ?>" maxlength="100" size="40" class="texto"></td>
            <?php }else{ ?>
                <td></td>
                <td></td>
            <?php } ?>
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <td>
                <select name="novo_ug_status_busca" class="texto">
                    ...
                    <option value="2" <?php  if ($objUsuarioGames->getStatusBusca() != 1) echo "selected";?>>Inativo</option>
                    <option value="1" <?php  if ($objUsuarioGames->getStatusBusca() == 1) echo "selected";?>>Ativo</option>
                </select>
            </td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <td colspan="3">
                <input name="ug_data_expiracao_senha" type="text" value="<?php if($objUsuarioGames->getDataExpiraSenha() != "") echo $objUsuarioGames->getDataExpiraSenha(); ?>" class="form" id="ug_data_expiracao_senha" value="" size="9" maxlength="10">
            </td>
          </tr>
        <tr bgcolor="#FFFFFF" class="texto"> 
                    ...
                    <tr>
                        ...
                        <td align="left" class="texto">&nbsp;&nbsp;&nbsp;&nbsp;<br>
                            <select name="ug_ongame" class="field_dados">
                                <option value="s"<?php if(strtolower($objUsuarioGames->getUgOngame()) == "s") echo " selected" ?>>Sim - Habilitado</option>
                                <option value="n"<?php if(strtolower($objUsuarioGames->getUgOngame()) != "s") echo " selected" ?>>Não - Desabilitado</option>
                            </select>
                        </td>
                    </tr>
                    </table>            
          ...
          <tr bgcolor="#FFFFFF" class="texto"> 
            <td colspan="4" bgcolor="#ECE9D8">Cadastro</font></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Tipo Estab.</b></td>
            <td>
                <select name="ug_te_id" class="" >
                    <option value="" <?php  if(is_null($objUsuarioGames->getTipoEstabelecimento())) { echo "selected"; } ?>>N&atilde;o Informado</option>
                    <?php
...
<?php if($objUsuarioGames->getTipoCadastro() == "PJ" ) { ?>
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <td><input type="text" name="novo_ug_nome_fantasia" value="<?php echo $objUsuarioGames->getNomeFantasia() ?>" maxlength="100" size="50" class="texto"></td>
            <td><b>Razão Social</b></td>
            <td><input type="text" name="novo_ug_razao_social" value="<?php echo $objUsuarioGames->getRazaoSocial() ?>" maxlength="100" size="50" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>CNPJ</b></td>
            <td><input type="text" name="novo_ug_cnpj" value="<?php echo $objUsuarioGames->getCNPJ() ?>" maxlength="20" size="20" class="texto"></td>
            <td><b>Inscrição Estadual</b></td>
            <td><input type="text" name="novo_ug_inscr_estadual" value="<?php echo $objUsuarioGames->getInscrEstadual() ?>" maxlength="20" size="20" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Responsável</b></td>
            <td><input type="text" name="novo_ug_responsavel" value="<?php echo $objUsuarioGames->getResponsavel() ?>" maxlength="20" size="20" class="texto"></td>
            <td><b>Abertura da Empresa</b></td>
            <td><input type="text" name="novo_ug_abertura_mes" value="<?php echo $objUsuarioGames->getAberturaMes() ?>" maxlength="2" size="2" class="texto">/<input type="text" name="novo_ug_abertura_ano" value="<?php echo $objUsuarioGames->getAberturaAno() ?>" maxlength="4" size="4" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Site</b></td>
            <td><input type="text" name="novo_ug_site" value="<?php echo $objUsuarioGames->getSite() ?>" maxlength="250" class="texto"></td>
            <td><b>Substatus</b></td>
            <td>
                ...
                ?>
                <input type="hidden" name="novo_ug_data_aprovacao" id="novo_ug_data_aprovacao" value="<?php echo $objUsuarioGames->getDataAprovacao(); ?>">
            </td>
          </tr>
          <!--tr bgcolor="#F5F5FB" class="texto"> 
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <nobr><input type="radio" name="cad_FaturaMediaMensal" value="<?php echo $FaturamentoId; ?>" <?php if($objUsuarioGames->getFaturaMediaMensal() == $FaturamentoId) echo "checked";?>><?php echo $FaturamentoDesc; ?>&nbsp;&nbsp;&nbsp;&nbsp;</nobr>
            <?php if(is_null($i)) $i=0; $i++; if($i%2==1) echo "<br>"; ?>
            <?php } ?>
            </td>
            <td><b>Qtde Computadores</b></td>
            <td>
            <?php foreach ($CADASTRO_COMPUTADORES as $ComputadoresId => $ComputadoresDesc){ ?>
            <nobr><input type="radio" name="cad_ComputadoresQtde" value="<?php echo $ComputadoresId; ?>" <?php if($objUsuarioGames->getComputadoresQtde() == $ComputadoresId) echo "checked";?>><?php echo $ComputadoresDesc; ?></nobr>
            <?php } ?>
            </td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <td>
                ...
                <nobr><input type="checkbox" name="cad_ComunicacaoVisual[]" value="<?php echo $ComunicacaoId; ?>" <?php if(in_array($ComunicacaoId, $cad_ComunicacaoVisual)) echo "checked";?>><?php echo $ComunicacaoDesc; ?>&nbsp;&nbsp;&nbsp;&nbsp;</nobr>
                <?php } ?>
    ...
    <tr bgcolor="#F5F5FB" class="texto">
        ...
        <td><textarea name="novo_ug_canais_venda" rows="3" cols="100" class="texto"><?php echo $objUsuarioGames->getCanaisVenda(); ?></textarea></td>
        ...
        <td><select name="novo_ug_tipo_venda" id="novo_ug_tipo_venda" class="form2">
          ...
          <tr bgcolor="#FFFFFF" class="texto"> 
            <td colspan="4" bgcolor="#ECE9D8">Representante Legal da Empresa</font></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Nome</b></td>
            <td><input type="text" name="novo_ug_repr_legal_nome" value="<?php echo $objUsuarioGames->getReprLegalNome() ?>" maxlength="50" size="50" class="texto"></td>
            <td><b>Data Nascimento</b></td>
            <td><input type="text" name="novo_ug_repr_legal_data_nascimento" value="<?php $data_nasc = ($objUsuarioGames->getReprLegalDataNascimento() != "") ? formata_data($objUsuarioGames->getReprLegalDataNascimento(), 0) : $objUsuarioGames->getReprLegalDataNascimento(); echo $data_nasc; ?>" maxlength="10" size="10" class="texto data-nasc"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>CPF</b></td>
            <td><input type="text" name="novo_ug_repr_legal_cpf" value="<?php echo $objUsuarioGames->getReprLegalCPF() ?>" maxlength="20" size="20" class="texto"></td>
            <td><b>RG</b></td>
            <td><input type="text" name="novo_ug_repr_legal_rg" value="<?php echo $objUsuarioGames->getReprLegalRG() ?>" maxlength="20" size="20" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Telefone</b></td>
            <td>(<input type="text" name="novo_ug_repr_legal_tel_ddi" value="<?php echo $objUsuarioGames->getReprLegalTelDDI() ?>" maxlength="2" size="2" class="texto">) (<input type="text" name="novo_ug_repr_legal_tel_ddd" value="<?php echo $objUsuarioGames->getReprLegalTelDDD() ?>" maxlength="2" size="2" class="texto">) <input type="text" name="novo_ug_repr_legal_tel" value="<?php echo $objUsuarioGames->getReprLegalTel() ?>" maxlength="9" size="9" class="texto"></td>
            <td><b>Celular</b></td>
            <td>(<input type="text" name="novo_ug_repr_legal_cel_ddi" value="<?php echo $objUsuarioGames->getReprLegalCelDDI() ?>" maxlength="2" size="2" class="texto">) (<input type="text" name="novo_ug_repr_legal_del_ddd" value="<?php echo $objUsuarioGames->getReprLegalCelDDD() ?>" maxlength="2" size="2" class="texto">) <input type="text" name="novo_ug_repr_legal_cel" value="<?php echo $objUsuarioGames->getReprLegalCel() ?>" maxlength="9" size="9" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Email</b></td>
            <td><input type="text" name="novo_ug_repr_legal_email" value="<?php echo $objUsuarioGames->getReprLegalEmail() ?>" maxlength="100" size="50" class="texto"></td>
            <td><b>Skype</b></td>
            <td><input type="text" name="novo_ug_repr_legal_msn" value="<?php echo $objUsuarioGames->getReprLegalMSN() ?>" maxlength="100" size="50" class="texto"></td>
          </tr>
          
          <tr bgcolor="#FFFFFF" class="texto"> 
            <td colspan="4" bgcolor="#ECE9D8">Sócios</font></td>
          </tr>
<?php
...
?>
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <td colspan="3"><button type="button" remove-socio="<?php echo $i_socios ?>" class="rmSocio btn btn-danger btn-xs">Excluir</button></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Nome</b></td>
            <td><input type="text" name="novo_ug_nome_socios<?php echo "[".$i_socios."]"?>" readonly="readonly" value="<?php echo $novo_ug_nome_socios ?>" maxlength="100" size="50" class="texto"></td>
            <td><b>Porcentagem na Empresa</b></td>
            <td><input type="text" name="novo_ug_porcentagem_socios<?php echo "[".$i_socios."]"?>" value="<?php echo $novo_ug_porcentagem_socios ?>" maxlength="20" size="20" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>CPF</b></td>
            <td><input type="text" class="class_cpf_socios" name="novo_ug_cpf_socios<?php echo "[".$i_socios."]"?>" readonly="readonly" value="<?php echo $novo_ug_cpf_socios ?>" maxlength="20" size="20" class="texto"></td>
            <td><b>Data de Nascimento</b></td>
            <td><input type="text" name="novo_ug_data_nascimento_socios<?php echo "[".$i_socios."]"?>" readonly="readonly" value="<?php echo formata_data($novo_ug_data_nascimento_socios,0) ?>" maxlength="20" size="20" class="texto data data-nasc"></td>
          </tr>
<?php
                $i_socios++;
            }
...
?>        
          <tr bgcolor="#F5F5FB" class="texto">
              <td colspan="1"><input type="hidden" name="num_registros_bd" id="num_registros_bd" value="<?php echo $i_socios ?>" ></td>
              <td colspan="3"><button type="button" data-socios="<?php echo $i_socios ?>" class="addSocio btn btn-success btn-xs pull-right">Adicionar sócio</button></td>
          </tr>
          
          <tr bgcolor="#FFFFFF" class="texto"> 
            <td colspan="4" bgcolor="#ECE9D8">Principal Contato para assuntos relacionados à venda de crédito digitáis e cartões pré-pagos para games online</font></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Representante de Vendas</b></td>
            <td colspan="3">
                <select name="novo_ug_repr_venda_igual_repr_legal" class="texto">
                    <option value="0" <?php if ($objUsuarioGames->getReprVendaIgualReprLegal() != "1") echo "selected";?>>Outra pessoa</option>
                    <option value="1" <?php if ($objUsuarioGames->getReprVendaIgualReprLegal() == "1") echo "selected";?>>Representante legal</option>
                </select>
    ...
    <?php if($objUsuarioGames->getReprVendaIgualReprLegal() == "1"){ ?>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td colspan="4"><font color="#FF0000">Representante Legal da Empresa também é o Principal Contato</font>
            </td>
          </tr>
    <?php } else {?>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Nome</b></td>
            <td colspan="3"><input type="text" name="novo_ug_repr_venda_nome" value="<?php echo $objUsuarioGames->getReprVendaNome() ?>" maxlength="50" size="50" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>CPF</b></td>
            <td><input type="text" name="novo_ug_repr_venda_cpf" value="<?php echo $objUsuarioGames->getReprVendaCPF() ?>" maxlength="20" size="20" class="texto"></td>
            <td><b>RG</b></td>
            <td><input type="text" name="novo_ug_repr_venda_rg" value="<?php echo $objUsuarioGames->getReprVendaRG() ?>" maxlength="20" size="20" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Telefone</b></td>
            <td>(<input type="text" name="novo_ug_repr_venda_tel_ddi" value="<?php echo $objUsuarioGames->getReprVendaTelDDI() ?>" maxlength="2" size="2" class="texto">) (<input type="text" name="novo_ug_repr_venda_tel_ddd" value="<?php echo $objUsuarioGames->getReprVendaTelDDD() ?>" maxlength="2" size="2" class="texto">) <input type="text" name="novo_ug_repr_venda_tel" value="<?php echo $objUsuarioGames->getReprVendaTel() ?>" maxlength="9" size="9" class="texto"></td>
            <td><b>Celular</b></td>
            <td>(<input type="text" name="novo_ug_repr_venda_cel_ddi" value="<?php echo $objUsuarioGames->getReprVendaCelDDI() ?>" maxlength="2" size="2" class="texto">) (<input type="text" name="novo_ug_repr_venda_cel_ddd" value="<?php echo $objUsuarioGames->getReprVendaCelDDD() ?>" maxlength="2" size="2" class="texto">) <input type="text" name="novo_ug_repr_venda_cel" value="<?php echo $objUsuarioGames->getReprVendaCel() ?>" maxlength="9" size="9" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Email</b></td>
            <td><input type="text" name="novo_ug_repr_venda_email" value="<?php echo $objUsuarioGames->getReprVendaEmail() ?>" maxlength="100" size="50" class="texto"></td>
            <td><b>MSN</b></td>
            <td><input type="text" name="novo_ug_repr_venda_msn" value="<?php echo $objUsuarioGames->getReprVendaMSN() ?>" maxlength="100" size="50" class="texto"></td>
          </tr>
    <?php } ?>

          <tr bgcolor="#FFFFFF" class="texto"> 
            <td colspan="4" bgcolor="#ECE9D8">Dados Bancários</font></td>
          </tr>
        <tr>
            <td colspan="4" width="100%">
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr bgcolor="#F5F5FB" class="texto">
                        ...
                        <td align="center"><input type="text" name="novo_ug_dados_bancarios_01_banco" value="<?php echo $objUsuarioGames->getDadosBancarios01Banco()?>" maxlength="4" size="4" class="texto"></td>
                        <td align="center"><input type="text" name="novo_ug_dados_bancarios_01_agencia" value="<?php echo $objUsuarioGames->getDadosBancarios01Agencia()?>" maxlength="10" size="10" class="texto"></td>
                        <td align="center"><input type="text" name="novo_ug_dados_bancarios_01_conta" value="<?php echo $objUsuarioGames->getDadosBancarios01Conta()?>" maxlength="11" size="11" class="texto"></td>
                        <td align="center"><input type="text" name="novo_ug_dados_bancarios_01_abertura" value="<?php echo $objUsuarioGames->getDadosBancarios01Abertura()?>" maxlength="7" size="7" class="texto"></td>
                    </tr>
                    <tr bgcolor="#F5F5FB" class="texto">
                        <td align="center">&nbsp;&nbsp;2&nbsp;</td>
                        <td align="center"><input type="text" name="novo_ug_dados_bancarios_02_banco" value="<?php echo $objUsuarioGames->getDadosBancarios02Banco()?>" maxlength="4" size="4" class="texto"></td>
                        <td align="center"><input type="text" name="novo_ug_dados_bancarios_02_agencia" value="<?php echo $objUsuarioGames->getDadosBancarios02Agencia()?>" maxlength="10" size="10" class="texto"></td>
                        <td align="center"><input type="text" name="novo_ug_dados_bancarios_02_conta" value="<?php echo $objUsuarioGames->getDadosBancarios02Conta()?>" maxlength="11" size="11" class="texto"></td>
                        <td align="center"><input type="text" name="novo_ug_dados_bancarios_02_abertura" value="<?php echo $objUsuarioGames->getDadosBancarios02Abertura()?>" maxlength="7" size="7" class="texto"></td>
                    </tr>
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Nome</b></td>
            <td><input type="text" name="novo_ug_contato01_nome" value="<?php echo $objUsuarioGames->getContato01Nome() ?>" maxlength="20" size="20" class="texto"></td>
            <td><b>Cargo</b></td>
            <td><input type="text" name="novo_ug_contato01_cargo" value="<?php echo $objUsuarioGames->getContato01Cargo() ?>" maxlength="20" size="20" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Telefone</b></td>
            <td>(<input type="text" name="novo_ug_contato01_tel_ddi" value="<?php echo $objUsuarioGames->getContato01TelDDI() ?>" maxlength="2" size="2" class="texto">) (<input type="text" name="novo_ug_contato01_tel_ddd" value="<?php echo $objUsuarioGames->getContato01TelDDD() ?>" maxlength="2" size="2" class="texto">) <input type="text" name="novo_ug_contato01_tel" value="<?php echo $objUsuarioGames->getContato01Tel() ?>" maxlength="9" size="9" class="texto"></td>
            <td colspan="2"></td>
          </tr>
<?php } ?>
...
<?php if($objUsuarioGames->getTipoCadastro() == "PF" ) { ?>
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>CPF</b></td>
            <td><input type="text" name="novo_ug_cpf" value="<?php echo $objUsuarioGames->getCPF() ?>" maxlength="250" size="20" class="texto"></td>
            <td><b>RG</b></td>
            <td><input type="text" name="novo_ug_rg" value="<?php echo $objUsuarioGames->getRG() ?>" maxlength="20" size="20" class="texto"></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Data de Nascimento</b></td>
            <td><input name="novo_ug_data_nascimento" type="text" class="form data-nasc" id="novo_ug_data_nascimento" value="<?php echo substr($objUsuarioGames->getDataNascimento(), 0, 10) ?>" size="9" maxlength="10">
            </td>
            <td><b>Sexo</b></td>
            <td>
          ...
          <tr bgcolor="#F5F5FB" class="texto">
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            <td><b><nobr>Tipo de Venda</nobr></b></td>
            <td>
...
<?php } ?>
         <tr bgcolor="#FFFFFF" class="texto"> 
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Fax</b></td>
            <td>(<input type="text" name="novo_ug_fax_ddi" value="<?php echo $objUsuarioGames->getFaxDDI() ?>" maxlength="2" size="2" class="texto">) (<input type="text" name="novo_ug_fax_ddd" value="<?php echo $objUsuarioGames->getFaxDDD() ?>" maxlength="2" size="2" class="texto">) <input type="text" name="novo_ug_fax" value="<?php echo $objUsuarioGames->getFax() ?>" maxlength="9" size="9" class="texto"></td>
            <td colspan="2"></td>
          </tr>

              <!-- [NEXCAFE] -->
        <tr bgcolor="#FFFFFF" class="texto"> 
            <td colspan="4" bgcolor="#ECE9D8">NexCafé</font></td>
        </tr>
        <tr bgcolor="#F5F5FB" class="texto"> 
            <td><b>Login NexCafé Plus+</b></td>
            <td>
                <input type="text" name="tf_u_login_nexcafe" value="<?php echo $objUsuarioGames->getUgIdNexCafe(); ?>" maxlength="100" size="40" class="texto">
            </td>
            <td colspan="2">
                <input type="checkbox" name="tf_u_login_automatico_nexcafe" id="tf_u_login_automatico_nexcafe" value="1" <?php if ($objUsuarioGames->getUgLoginNexCafeAuto()) { echo 'checked="checked"'; } ?>  style="float: left; display: block; text-align: left; width: auto; margin-top:0px;" />
                <label style="float: left; display: block; text-align: left; width: auto; margin-left:4px;">Habilitar login autom&aacute;tico para venda de PINs via NexCaf&eacute;?</label>
            </td>
        </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
            <td colspan="4"><b>Data Adesão ao NexCafé</b>&nbsp;&nbsp;&nbsp;<?php echo (($objUsuarioGames->getUgDataInclusaoNexCafe())  ? formata_data_ts($objUsuarioGames->getUgDataInclusaoNexCafe() . "", 0, true, true):"-"); ?></td>
          </tr>          
          <tr bgcolor="#F5F5FB" class="texto"><td colspan="4">&nbsp;</td></tr>    
          <!-- [/NEXCAFE] -->

          <tr bgcolor="#FFFFFF" class="texto"> 
            <td colspan="4" bgcolor="#ECE9D8">Observaçôes</font></td>
          </tr>
          <tr bgcolor="#F5F5FB" class="texto"> 
          ...
          <tr bgcolor="#F5F5FB" class="texto"> 
            ...
            <td colspan="3">
                <select name="novo_ug_risco_classif" class="texto">
                    ...
                    <option value="<?php echo $formaPagtoId; ?>" <?php if ($objUsuarioGames->getRiscoClassif() == $formaPagtoId) echo "selected";?>><?php echo $formaPagtoDesc; ?></option>
                    <?php } ?>
                </select>
            </td>
          </tr>
