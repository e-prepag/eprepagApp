...
<script>
	$(document).ready(function () {
		...
		$(".btn-busca").on("click", function () {
			...
			if (id_pedido.val() == "" && idPDV.val() == "") {

				msgError += "Você deve escolher um PDV ou o número de um pedido<br>";
			...
			if (msgError != "") {
				...
				let table = $('#table').DataTable({
					ajax: './ajax_cancela_pins.php?acao=listar&dt_inicial=' + dt_inicial.val() + '&dt_final=' + dt_final.val() + '&id_pdv=' + idPDV.val() + '&id_pedido=' + id_pedido.val() + '&reload=' + new Date().getTime(),
					cache: false,
					dataSrc: '',
					columns: [
						{ data: 'acoes' },
