...
//echo "<pre>".print_r($obj_usuarioGames, true)."</pre>";
					...
					?>
                      <tr bgcolor="<?php echo $cor1 ?>" class="texto"> 
                        ...
                        <td align="center"><?php echo $obj_usuarioGames->getLogin() ?></td>
                        <td align="center"><?php echo (($obj_usuarioGames->getNomeFantasia())?$obj_usuarioGames->getNomeFantasia():"-") ?></td>
							...
							while ($pgrs = pg_fetch_array ($rs)) {
								...
								?>
								  <tr bgcolor="<?php echo $cor1 ?>" class="texto" title="Taxa de aproveitamento: <?php echo number_format($taxa_aproveitamento, 2, '.', '.') ?>%"> 
									...
									<td align="center" style="max-width: 350px;font-size: 10px;"><nobr><?php echo trim((($pgrs['ug_login'])?$pgrs['ug_login']:"-")) ?></nobr></td>
...
Média de dias por venda: <?php echo number_format($pgrs['ndays_per_venda'], 2, '.', '.') ?>"><nobr><?php echo substr($pgrs['vg_data_ultima_venda'], 0, 19) ?></nobr></td>
									...
									<td align=""><strong><font class="texto">&nbsp;</font></strong></td>
