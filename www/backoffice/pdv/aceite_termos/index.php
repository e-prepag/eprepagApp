...
<div>
	...
	<h2 class="titulo-vencimento">Usuários que aceitaram termos</h2>
	<form id="form1" class="form-solicitacoes">
		<div class="container-cancel-pins">

			<div class="col-cancel-pins">
				<label for="opr_codigo">ID ou nome<span class="help-icon">?
			...
			<div class="col-cancel-pins">
				<label for="dt_inicial">Data inicial
					<span class="help-icon">?
						<span class="tooltiptext">
							Ao preencher, usuários que não aceitaram serão ocultados, pois não possuem data.
		...
		<div class="d-flex top10 custom-justify">
			<button class="btn btn-success btn-busca" type="submit">Buscar</button>
		</div>
	</form>
