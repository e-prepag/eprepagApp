...
echo "<h2>Lista LOG de modificação de Saldo (".date("Y-m-d H:i:s").")</h2>\n";
...
if(!isset($ug_risco_classif)) $ug_risco_classif = "";
if(!(($ug_risco_classif=="1") || ($ug_risco_classif=="2") )) $ug_risco_classif = "";
        ...
        <tr>
            ...
            <td>
                <select name="ug_risco_classif">
                    <option value=""<?php if($ug_risco_classif=="") echo " selected"?>>Todos os Tipos</option>
                    <option value="1"<?php if($ug_risco_classif=="1") echo " selected"?>>Lans Pós-pagas</option>
                    <option value="2"<?php if($ug_risco_classif && $ug_risco_classif!="1") echo " selected"?>>Lans Pré-pagas</option>
                </select>
            </td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;</td>
            <td><input type="submit" class="btn btn-info" name="btnSubmit" value="Atualiza"></td>
        </tr>
    </table>
