...
$pagina_titulo = "Boletos";
$_PaginaOperador2Permitido = 54;

class BoletosController extends HeaderController{
    ...
    public function __construct(){
        ...
        if($this->operadorTipo === $GLOBALS['USUARIO_GAMES_OPERADOR_TIPOS'][FUNCIONARIO_2] || $this->usuarios->getRiscoClassif() == 2)
            $this->accessDenied ();
    }
}
