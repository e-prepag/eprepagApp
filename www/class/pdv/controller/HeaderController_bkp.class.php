...
class HeaderController{
    ...
    public function __construct(){
        if(validaSessao())
        {
                ...
                !is_null($_SESSION['dist_usuarioGamesOperador_ser']))
            {
                ...
                if (isset($_SESSION['dist_usuarioGamesOperadorTipo_ser'])  && 
                ...
                else if (isset($_SESSION['dist_usuarioGamesOperadorTipo_ser']) && 
            ...
            elseif (isset($_SESSION['dist_usuarioGames_ser']) && 
    ...
    public function setError($fileError, Exception $ex){
        $geraLog = new Log($fileError,array("ERROR: ".$ex->getMessage(),
