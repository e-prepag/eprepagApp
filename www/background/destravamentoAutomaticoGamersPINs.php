...
// Função que verifica bloqueio de Gamers
function verificaBloqueiosGamers($minutos,&$rs_dados_bloqueios) {
        ...
        if(pg_num_rows($rs_dados_bloqueios) == 0) {
            //echo "Vai retorna Falso. Ou seja, NÃO possui Gamers Bloqueados.<br>";
            return false;
...
// Função que verifica bloqueio de PINs
function verificaBloqueiosPINs($minutos,&$rs_dados_bloqueios) {
        ...
        if(pg_num_rows($rs_dados_bloqueios) == 0) {
            //echo "Vai retorna Falso. Ou seja, NÃO possui PINs Bloqueados.<br>";
            return false;
        }//end if(!$rs_dados_bloqueios || pg_num_rows($rs_dados_bloqueios) == 0)
        else {
...
// Função que verifica bloqueio de PINs Cards
