...
class LoggingPDOStatement extends PDOStatement
{
    ...
    public function execute($bound_input_params = null)
    {
        ...
        echo strpos($callerDir, 'public_html') === false;
        echo strpos($_SERVER['HTTP_HOST'], 'www.e-prepag.com.br') == false ;
        echo stripos($this->queryString, "usuarios") == false;
        ...
        if (preg_match('/^\s*(INSERT|UPDATE|DELETE)/i', $this->queryString)) {
            ...
            $result = file_put_contents($logFile, PHP_EOL . $separator . PHP_EOL . $log . PHP_EOL . PHP_EOL, FILE_APPEND);
            echo $result . PHP_EOL;
